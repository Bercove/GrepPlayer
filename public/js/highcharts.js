...
(function (S, M) {
	...
	M(J, 'parts/Utilities.js', [J['parts/Globals.js']], function (c) {
		...
		function B(d, a, b) {
			...
			F(a)
				? C(b)
					...
					: d &&
					  d.getAttribute &&
					  ((h = d.getAttribute(a)) || 'class' !== a || (h = d.getAttribute(a + 'Name')))
				: A(a, function (a, h) {
						d.setAttribute(h, a);
				  });
			return h;
		...
		function D(d, a, b, l) {
			...
			if (-1 === a) a = Math.min(k, 20);
				...
				var t = a + +g[1];
				0 <= t
					? ((g[0] = (+g[0]).toExponential(t).split('e')[0]), (a = t))
					: ((g[0] = g[0].split('.')[0] || 0),
					  (d = 20 > a ? (g[0] * Math.pow(10, g[1])).toFixed(a) : 0),
					  (g[1] = 0));
			}
		...
		function A(d, a, b) {
			for (var h in d) Object.hasOwnProperty.call(d, h) && a.call(b || d[h], d[h], h, d);
		}
		c.timers = [];
		var f = c.charts,
			b = c.doc,
			...
			dSetter: function () {
				...
				if (1 === l) b = this.toD;
					...
					for (; f--; ) {
						...
						b[f] =
							isNaN(p) || 'A' === a[f - 4] || 'A' === a[f - 5]
								? a[f]
								: l * parseFloat('' + (a[f] - p)) + p;
					}
				else b = a;
			...
			run: function (d, b, k) {
				...
				d !== b || this.elem['forceAnimate:' + this.prop]
					? ((this.startTime = +new Date()),
					  ...
					  (p.elem = this.elem),
					  (p.prop = this.prop),
					  p() && 1 === c.timers.push(p) && g(t))
					: (delete f.curAnim[this.prop],
					  f.complete && 0 === Object.keys(f.curAnim).length && f.complete.call(this.elem));
			},
			step: function (d) {
				var a = +new Date(),
					b = this.options,
				...
				if (l.attr && !l.element) d = !1;
					...
					(this.pos = b.easing((a - this.startTime) / p)),
			...
			initPath: function (d, a, b) {
				...
				function k(d, a) {
					for (var b = (r - d.length) / c; 0 < b && b--; )
						(E = d.slice().splice(d.length / N - c, c * N)),
							(E[0] = a[r - c - b * c]),
							x && ((E[c - 6] = E[c - 2]), (E[c - 5] = E[c - 1])),
							[].splice.apply(d, [d.length / N, 0].concat(E)),
							z && b--;
				}
				a = a || '';
				var g = d.startX,
		...
		c.datePropsToTimestamps = function (d) {
			A(d, function (a, b) {
				G(a) && 'function' === typeof a.getTime
					? (d[b] = a.getTime())
					: (G(a) || I(a)) && c.datePropsToTimestamps(a);
			});
		};
		c.formatSingle = function (d, a, b) {
			...
			/f$/.test(d)
				? ((h = (h = d.match(h)) ? h[1] : -1),
				  null !== a && (a = b(a, h, f.decimalPoint, -1 < d.indexOf(',') ? f.thousandsSep : '')))
				: (a = k.dateFormat(d, a));
			return a;
		};
		...
		c.normalizeTickInterval = function (d, a, b, l, f) {
			...
			var g = d / b;
			a ||
				((a = f ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
				!1 === l &&
					(1 === b
			...
			for (
				l = 0;
				l < a.length && !((h = a[l]), (f && h * b >= d) || (!f && g <= (a[l] + (a[l + 1] || a[l])) / 2));
				l++
			);
			return (h = r(h * b, -Math.round(Math.log(0.001) / Math.LN10)));
		};
		...
		c.getStyle = function (d, b, f) {
			if ('width' === b)
				return (
					...
					Math.max(0, b - c.getStyle(d, 'padding-left') - c.getStyle(d, 'padding-right'))
				);
			if ('height' === b)
				return Math.max(
					0,
					Math.min(d.offsetHeight, d.scrollHeight) -
						c.getStyle(d, 'padding-top') -
						c.getStyle(d, 'padding-bottom')
				);
		...
		c.find = Array.prototype.find
			...
			: function (d, a) {
					var b,
						h = d.length;
					for (b = 0; b < h; b++) if (a(d[b], b)) return d[b];
			  };
		c.keys = Object.keys;
		c.stop = function (d, a) {
		...
		A({ map: 'map', each: 'forEach', grep: 'filter', reduce: 'reduce', some: 'some' }, function (d, a) {
			c[a] = function (a) {
		...
		c.addEvent = function (d, a, b, f) {
			...
			var l =
				'function' === typeof d && d.prototype
					? (d.prototype.protoEvents = d.prototype.protoEvents || {})
					: (d.hcEvents = d.hcEvents || {});
		...
		c.removeEvent = function (d, a, b) {
			...
			function f(b) {
				...
				if (d.nodeName) {
					...
					A(f, function (d, a) {
						if (b[a]) for (g = b[a].length; g--; ) h(a, b[a][g].fn);
					});
				}
			}
			var k;
		...
		c.animate = function (a, b, f) {
			...
			A(b, function (t, l) {
				...
				k = null;
				'd' === l
					? ((g.paths = g.initPath(a, a.d, b.d)), (g.toD = b.d), (d = 0), (k = 1))
					: a.attr
					? (d = a.attr(l))
					: ((d = parseFloat(c.getStyle(a, l)) || 0), 'opacity' !== l && (h = 'px'));
				k || (k = t);
		...
		a.jQuery &&
			(a.jQuery.fn.highcharts = function () {
				...
				if (this[0])
					return a[0]
						? (new c[F(a[0]) ? a.shift() : 'Chart'](this[0], a[0], a[1]), this)
						: f[B(this[0], 'data-highcharts-chart')];
			});
		return {
			animObject: function (a) {
				return G(a) ? c.merge(a) : { duration: a ? 500 : 0 };
			},
			arrayMax: function (a) {
			...
			init: function (e) {
				...
				if ((this.input = e = this.names[e && e.toLowerCase ? e.toLowerCase() : ''] || e) && e.stops)
					...
					if (e && e.charAt && '#' === e.charAt()) {
						...
						7 === C
							? (v = [(e & 16711680) >> 16, (e & 65280) >> 8, e & 255, 1])
							: 4 === C &&
							  (v = [
									((e & 3840) >> 4) | ((e & 3840) >> 8),
									((e & 240) >> 4) | (e & 240),
			...
			tweenTo: function (c, e) {
				...
				v.length && q && q.length
					? ((c = 1 !== v[3] || 1 !== q[3]),
					  (e =
							(c ? 'rgba(' : 'rgb(') +
							Math.round(v[0] + (q[0] - v[0]) * (1 - e)) +
							',' +
							Math.round(v[1] + (q[1] - v[1]) * (1 - e)) +
							',' +
							Math.round(v[2] + (q[2] - v[2]) * (1 - e)) +
							(c ? ',' + (v[3] + (q[3] - v[3]) * (1 - e)) : '') +
							')'))
					: (e = c.input || 'none');
				return e;
	...
	M(J, 'parts/SvgRenderer.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		q(P.prototype, {
			...
			animate: function (a, d, n) {
				...
				0 !== K.duration
					? (n && (K.complete = n), b(this, a, K))
					: (this.attr(a, void 0, n),
					  m(
							a,
							function (a, b) {
								K.step && K.step.call(this, a, { prop: b, pos: 1 });
							},
							this
					  ));
				return this;
			...
			complexColor: function (a, b, d) {
				...
				c.fireEvent(this.renderer, 'complexColor', { args: arguments }, function () {
					...
					Q &&
						...
						(x = d.radialReference),
						C(g) &&
							(a[Q] = g = { x1: g[0], y1: g[1], x2: g[2], y2: g[3], gradientUnits: 'userSpaceOnUse' }),
						'radialGradient' === Q &&
							x &&
							!G(g.gradientUnits) &&
							((z = g), (g = L(g, n.getRadialAttr(x, z), { gradientUnits: 'userSpaceOnUse' }))),
						m(g, function (a, b) {
							'id' !== b && N.push(b, a);
						}),
						m(t, function (a) {
						...
						f[N]
							? (k = f[N].attr('id'))
							: ((g.id = k = c.uniqueKey()),
							  (f[N] = h = n.createElement(Q).attr(g).add(n.defs)),
							  (h.radAttr = z),
							  (h.stops = []),
							  t.forEach(function (a) {
									0 === a[1].indexOf('rgba')
										? ((K = c.color(a[1])), (l = K.get('rgb')), (R = K.get('a')))
										: ((l = a[1]), (R = 1));
									a = n
										.createElement('stop')
										.attr({ offset: a[0], 'stop-color': l, 'stop-opacity': R })
										.add(h);
									h.stops.push(a);
							  })),
						(p = 'url(' + n.url + '#' + k + ')'),
				...
				if ((d = a[0]) && 'none' !== d && c.svg) {
					...
					a.forEach(function (a, K) {
						0 === K &&
							...
							(K = b.getAttribute('y')),
							a.setAttribute('y', K || 0),
							null === K && b.setAttribute('y', 0));
						a = a.cloneNode(1);
						I(a, {
			...
			removeTextOutline: function (a) {
				for (var b = a.length, d; b--; )
					(d = a[b]),
						'highcharts-text-outline' === d.getAttribute('class') && v(a, this.element.removeChild(d));
			},
			...
			attr: function (a, b, d, n) {
				...
				'string' === typeof a
					? (Q = (this[a + 'Getter'] || this._defaultGetter).call(this, a, g))
					: (m(
							a,
							function (b, d) {
								f = !1;
								...
								this.symbolName &&
									-1 !== c.inArray(d, t) &&
									(K || (this.symbolAttr(a), (K = !0)), (f = !0));
								!this.rotation || ('x' !== d && 'y' !== d) || (this.doTransform = !0);
								f ||
									((h = this[d + 'Setter'] || this._defaultSetter),
									h.call(this, b, d, g),
									!this.styledMode &&
										this.shadows &&
			...
			updateShadows: function (a, b, d) {
				for (var n = this.shadows, g = n.length; g--; )
					d.call(
						n[g],
						'height' === a ? Math.max(b - (n[g].cutHeight || 0), 0) : 'd' === a ? this.d : b,
						a,
						n[g]
					);
			},
			...
			removeClass: function (a) {
				return this.attr(
					'class',
					(this.attr('class') || '').replace(w(a) ? new RegExp(' ?' + a + ' ?') : a, '')
				);
			},
					...
					? ((n.ontouchstart = function (a) {
					  ...
					  (n.onclick = function (a) {
							(-1 === T.navigator.userAgent.indexOf('Android') ||
								1100 < Date.now() - (d.touchEventFired || 0)) &&
								b.call(n, a);
					  }))
					: (n['on' + a] = b);
				return this;
					...
					: z &&
					  a.push(
							'rotate(' +
								z +
								' ' +
								r(this.rotationOriginX, h.getAttribute('x'), 0) +
								' ' +
								r(this.rotationOriginY, h.getAttribute('y') || 0) +
								')'
					  );
			...
			align: function (a, b, d) {
				...
				var K, h;
				if (a) {
					if (((this.alignOptions = a), (this.alignByTranslate = b), !d || w(d)))
						(this.alignTo = n = d || 'renderer'), v(f, this), f.push(this), (d = null);
			...
			getBBox: function (a, b) {
				...
				if (!d) {
					if (Q || n.forExport) {
						try {
							(K =
								...
								(d = g.getBBox ? q({}, g.getBBox()) : { width: g.offsetWidth, height: g.offsetHeight }),
								K && K('');
						} catch (ca) {
							('');
						}
					...
					n.isSVG &&
						...
						Q &&
							(d.height = n =
								{ '11px,17': 14, '13px,20': 16 }[z && z.fontSize + ',' + Math.round(n)] || n),
						b &&
							((z = b * l),
							(d.width = Math.abs(n * Math.sin(z)) + Math.abs(a * Math.cos(z))),
			...
			setTextPath: function (a, b) {
				...
				var h = b.attributes;
				if (a && b && b.enabled) {
					z && null === z.element.parentNode
						? ((f = !0), (z = z.destroy()))
						: z &&
						  this.removeTextOutline.call(z.parentGroup, [].slice.call(d.getElementsByTagName('tspan')));
					...
					if (f)
						for (a = d.getElementsByTagName('tspan'); a.length; )
			...
			destroyTextPath: function (a, b) {
				...
				if (d) {
					if (
						(d.removeAttribute('dx'),
						d.removeAttribute('dy'),
						b.element.setAttribute('id', ''),
						d.getElementsByTagName('textPath').length)
					) {
			...
			zIndexSetter: function (a, b) {
				...
				G(a)
					...
					: G(this[b]) && z.removeAttribute('data-z-index');
				this[b] = a;
				if (h) {
					...
					for (t = b.length - 1; 0 <= t && !f; t--) {
						...
						if (n !== z)
							...
							else if (D(h) <= a || (l && (!G(a) || 0 <= a)))
								g.insertBefore(z, b[t + 1] || null), (f = !0);
					}
		...
		P.prototype.translateXSetter =
			...
			P.prototype.rotationOriginYSetter =
			P.prototype.scaleXSetter =
			P.prototype.scaleYSetter =
			P.prototype.matrixSetter =
				function (a, b) {
					this[b] = a;
					this.doTransform = !0;
				};
		P.prototype['stroke-widthSetter'] = P.prototype.strokeSetter = function (a, b, d) {
			...
			this.stroke && this['stroke-width']
				? (P.prototype.fillSetter.call(this, this.stroke, 'stroke', d),
				...
				: this.renderer.styledMode &&
				  this['stroke-width'] &&
				  (d.setAttribute('stroke-width', this['stroke-width']), (this.hasStroke = !0));
		};
		...
		q(e.prototype, {
			...
			init: function (a, b, d, n, z, t, l) {
				...
				this.alignedObjects = [];
				this.url =
					(g || x) && y.getElementsByTagName('base').length
						? T.location.href
								.split('#')[0]
								.replace(/<[^>]*>/g, '')
								.replace(/([\('\)])/g, '\\$1')
				...
				g &&
					...
					b(),
					(this.unSubPixelFix = f(T, 'resize', b)));
			},
			...
			buildText: function (a) {
				...
				var V = function (a) {
						var n;
						d.styledMode ||
							(n = /(px|em)$/.test(a && a.style.fontSize)
								? a.style.fontSize
								: A || d.style.fontSize || 12);
					...
					P = function (a, b) {
						...
						d = a.indexOf(b + '=');
						if (-1 !== d && ((d = d + b.length + 1), (b = a.charAt(d)), '"' === b || "'" === b))
							return (a = a.substring(d + 1)), a.substring(0, a.indexOf(b));
					},
					T = /<br.*?>/g;
				var u = [g, L, E, k, p, A, c].join();
				if (u !== a.textCache) {
					for (a.textCache = u; e--; ) b.removeChild(f[e]);
					z || p || L || c || (-1 !== g.indexOf(' ') && (!E || T.test(g)))
						? (x && x.appendChild(b),
						  z
								? ((g = d.styledMode
										? g
						  ...
						  g.forEach(function (g, z) {
								...
								K.forEach(function (g) {
									if ('' !== g || 1 === K.length) {
										...
										if ((R = P(g, 'style')))
											(R = R.replace(/(;| |^)color([ :])/, '$1fill$2')), I(p, 'style', R);
										(r = P(g, 'href')) &&
											!n &&
											(I(p, 'onclick', 'location.href="' + r + '"'),
											I(p, 'class', 'highcharts-anchor'),
											d.styledMode || h(p, { cursor: 'pointer' }));
												...
												if (L)
													...
													for (; m.length; )
														m.length &&
															!E &&
															0 < r &&
															((p = y.createElementNS(O, 'tspan')),
															I(p, { dy: e, x: l }),
															R && I(p, 'style', R),
															p.appendChild(
																y.createTextNode(m.join(' ').replace(/- /g, '-'))
															),
															b.appendChild(p)),
															d.truncate(
																a,
						  ...
						  L && t && a.attr('title', q(a.textStr, ['&lt;', '&gt;'])),
						  x && x.removeChild(b),
						  p && a.applyTextOutline && a.applyTextOutline(p))
			...
			button: function (a, b, d, n, g, z, h, l, x, c) {
				...
				K.setState = function (a) {
					1 !== a && (K.state = k = a);
					K.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass(
			...
			rect: function (a, b, d, n, g, z) {
				...
				a = u(a)
					...
					: 'undefined' === typeof a
					? {}
					: { x: a, y: b, width: Math.max(d, 0), height: Math.max(n, 0) };
				this.styledMode ||
					('undefined' !== typeof z && ((a.strokeWidth = z), (a = f.crisp(a))), (a.fill = 'none'));
				g && (a.r = g);
			...
			image: function (a, b, d, n, g, z) {
				var h = { preserveAspectRatio: 'none' },
					t = function (a, b) {
						a.setAttributeNS
							? a.setAttributeNS('http://www.w3.org/1999/xlink', 'href', b)
							: a.setAttribute('hc-svg-href', b);
					},
					l = function (b) {
						t(x.element, a);
						z.call(x, b);
				...
				z
					? (t(x.element, 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='),
					  (h = new T.Image()),
					  f(h, 'load', l),
					  (h.src = a),
					  h.complete && l({}))
					...
					['width', 'height'].forEach(function (a) {
						p[a + 'Setter'] = function (a, b) {
							...
							G(n) &&
								...
								this.element && this.element.setAttribute(b, n),
								this.alignByTranslate || ((d[g] = ((this[b] || 0) - n) / 2), this.attr(d)));
						};
					});
					G(d) && p.attr({ x: d, y: n });
					p.isImg = !0;
					G(p.imgwidth) && G(p.imgheight)
						? R()
						: (p.attr({ width: 0, height: 0 }),
						  k('img', {
								onload: function () {
									...
									0 === this.width &&
										(h(this, { position: 'absolute', top: '-999em' }), y.body.appendChild(this));
			...
			symbols: {
				...
				arc: function (a, b, d, n, g) {
					var z = g.start,
						...
						t = g.end - 0.001;
					d = g.innerR;
					n = r(g.open, 0.001 > Math.abs(g.end - g.start - 2 * Math.PI));
					var l = Math.cos(z),
						x = Math.sin(z),
						c = Math.cos(t);
					t = Math.sin(t);
					z = r(g.longArc, 0.001 > g.end - z - Math.PI ? 0 : 1);
				...
				callout: function (a, b, d, n, g) {
					...
					h && h > d
						? g > b + f && g < b + n - f
							...
							: t.splice(13, 3, 'L', a + d, n / 2, h, g, a + d, n / 2, a + d, b + n - z)
						: h && 0 > h
						? g > b + f && g < b + n - f
							? t.splice(33, 3, 'L', a, g + 6, a - 6, g, a, g - 6, a, b + z)
							: t.splice(33, 3, 'L', a, n / 2, h, g, a, n / 2, a, b + z)
						: g && g > n && h > a + f && h < a + d - f
						? t.splice(23, 3, 'L', h + 6, b + n, h, b + n + 6, h - 6, b + n, a + z, b + n)
						: g &&
						  0 > g &&
						  h > a + f &&
						  h < a + d - f &&
						  t.splice(3, 3, 'L', h - 6, b, h, b - 6, h + 6, b, d - z, b);
					return t;
				}
			},
			...
			fontMetrics: function (a, b) {
				a =
					(!this.styledMode && /px/.test(a)) || !T.getComputedStyle
			...
			label: function (a, b, d, g, z, f, h, t, l) {
				...
				var w = function () {
					...
					u &&
						(N ||
							((k.box = N = x.symbols[g] || da ? x.symbol(g) : x.rect()),
							N.addClass(
								('button' === l ? '' : 'highcharts-label-box') + (l ? ' highcharts-' + l + '-box' : '')
							),
							N.add(k),
							(a = v()),
							(b.x = a),
				...
				var Q = function () {
					...
					G(A) &&
						K &&
						('center' === e || 'right' === e) &&
						(a += { center: 0.5, right: 1 }[e] * (A - K.width));
					if (a !== p.x || b !== p.y)
						p.attr('x', a),
							p.hasBoxWidthChanged && ((K = p.getBBox(!0)), w()),
							'undefined' !== typeof b && p.attr('y', b);
					p.x = a;
					p.y = b;
				};
				var U = function (a, b) {
				...
				h = {
					...
					getBBox: function () {
						return { width: K.width + 2 * E, height: K.height + 2 * E, x: K.x - E, y: K.y - E };
					},
					destroy: function () {
	...
	M(J, 'parts/Html.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		G(m.prototype, {
			...
			htmlUpdateTransform: function () {
				if (this.added) {
					...
					!c.styledMode &&
						this.shadows &&
						this.shadows.forEach(function (a) {
							C(a, { marginLeft: f + 1, marginTop: b + 1 });
						});
					this.inverted &&
						[].forEach.call(r.childNodes, function (a) {
							c.invertChild(a, r);
						});
					if ('SPAN' === r.tagName) {
						l = this.rotation;
						var p = this.textWidth && v(this.textWidth),
							...
							t;
						(t = p !== this.oldTextWidth) &&
							!(t = p > this.oldTextWidth) &&
							((t = this.textPxLength) ||
								(C(r, { width: '', whiteSpace: y || 'nowrap' }), (t = r.offsetWidth)),
							(t = t > p));
						t && (/[ \-]/.test(r.textContent || r.innerText) || 'ellipsis' === r.style.textOverflow)
							? (C(r, { width: p + 'px', display: 'block', whiteSpace: y || 'normal' }),
							  (this.oldTextWidth = p),
							  (this.hasBoxWidthChanged = !0))
							: (this.hasBoxWidthChanged = !1);
						g !== this.cTT &&
							((y = c.fontMetrics(r.style.fontSize, r).b),
							!I(l) ||
								(l === (this.oldRotation || 0) && h === this.oldAlign) ||
								this.setSpanRotation(l, k, y),
							this.getSpanCorrection((!I(l) && this.textPxLength) || r.offsetWidth, y, k, l, h));
			...
			getSpanCorrection: function (c, r, f) {
				this.xCorr = -c * f;
				this.yCorr = -r;
			}
		});
		G(e.prototype, {
			getTransformKey: function () {
				return u && !/Edge/.test(r.navigator.userAgent)
					? '-ms-transform'
					: w
					? '-webkit-transform'
					: B
							...
							if (!g) {
								...
								l.reverse().forEach(function (a) {
									...
									G(a, {
										...
										on: function () {
											l[0].div && b.on.apply({ element: l[0].div }, arguments);
											return a;
										},
										translateXSetter: d,
										translateYSetter: d
	...
	M(J, 'parts/Time.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		c.Time.prototype = {
			...
			update: function (c) {
				...
				(this.variableTimezone = !(r && !c.getTimezoneOffset && !c.timezone)) || this.timezoneOffset
					? ((this.get = function (c, f) {
					  ...
					  (this.set = function (c, f, b) {
							if (
								'Milliseconds' === c ||
								'Seconds' === c ||
								('Minutes' === c && 0 === f.getTimezoneOffset() % 60)
							)
								f['set' + c](b);
							else {
			...
			timezoneOffsetFunction: function () {
				...
				return this.useUTC && r.getTimezoneOffset
					? function (c) {
			...
			resolveDTLFormat: function (c) {
				return G(c, !0) ? c : ((c = C(c)), { main: c[0], from: c[1], to: c[2] });
			},
			getTimeTicks: function (c, r, e, A) {
				...
				if (F(r)) {
					...
					h >= u.day &&
						f.set('Date', d, h >= u.month ? 1 : Math.max(1, k * Math.floor(f.get('Date', d) / k)));
					if (h >= u.month) {
					...
					h === u.week &&
						((y = f.get('Day', d)), f.set('Date', d, f.get('Date', d) - y + A + (y < A ? -7 : 0)));
					y = f.get('FullYear', d);
					A = f.get('Month', d);
					var p = f.get('Date', d),
						g = f.get('Hours', d);
					r = d.getTime();
					f.variableTimezone &&
						(l = e - r > 4 * u.month || f.getTimezoneOffset(r) !== f.getTimezoneOffset(e));
					r = d.getTime();
					for (d = 1; r < e; )
						b.push(r),
							(r =
								h === u.year
									...
									: !l || (h !== u.day && h !== u.week)
									? l && h === u.hour && 1 < k
										? f.makeTime(y, A, p, g + d * k)
										: r + h * k
									: f.makeTime(y, A, p + d * k * (h === u.day ? 1 : 7))),
							d++;
					b.push(r);
					h <= u.hour &&
						1e4 > b.length &&
		...
		c.Tick.prototype = {
			addLabel: function () {
				...
				if (e.isDatetimeAxis && k) {
					var x = f.time.resolveDTLFormat(
						m.dateTimeLabelFormats[(!m.grid && k.higherRanks[d]) || k.unitName]
					);
					var L = x.main;
				}
				c.isFirst = l;
				...
				if ((t = x && x.list))
					c.shortenLabel = function () {
						for (g = 0; g < t.length; g++)
							if (
								(p.attr({ text: e.labelFormatter.call(v(c.formatCtx, { dateTimeLabelFormat: t[g] })) }),
								p.getBBox().width < e.getSlotWidth(c) - 2 * B(h.padding, 5))
							)
								return;
						p.attr({ text: '' });
					};
				...
				G(p) || c.movedLabel
					? p &&
					  p.textStr !== m &&
					  !b &&
					  (!p.textWidth || (h.style && h.style.width) || p.styles.width || p.css({ width: null }),
					  p.attr({ text: m }),
			...
			moveLabel: function (c, e) {
				var r = this,
					...
					h = a.chart.inverted;
				f && f.textStr === c
					? ((r.movedLabel = f), (b = !0), delete r.label)
					: C(a.ticks, function (a) {
							b ||
								...
								!a.label ||
								a.label.textStr !== c ||
								((r.movedLabel = a.label), (b = !0), (a.labelPos = r.movedLabel.xy), delete a.label);
					  });
				if (!b && (r.labelPos || f)) {
					var k = r.labelPos || f.xy;
					f = h ? k.x : d ? 0 : a.width + a.left;
					a = h ? (d ? a.width + a.left : 0) : k.y;
					r.movedLabel = r.createLabel({ x: f, y: a }, c, e);
			...
			createLabel: function (c, e, m) {
				var f = this.axis,
					b = f.chart;
				if ((c = G(e) && m.enabled ? b.renderer.text(e, c.x, c.y, m.useHTML).add(f.labelGroup) : null))
					b.styledMode || c.css(w(m.style)), (c.textPxLength = c.getBBox().width);
				return c;
			},
			...
			handleOverflow: function (c) {
				...
				var h = this.label,
					k = this.rotation,
					l = { left: 0, center: 0.5, right: 1 }[e.labelAlign || h.attr('align')],
					y = h.getBBox().width,
					...
					x,
					L = {};
				if (k || 'justify' !== B(r.overflow, 'justify'))
					0 > k && f - l * y < d
						? (x = Math.round(f / Math.cos(k * m) - d))
						: 0 < k && f + l * y > a && (x = Math.round((b - f) / Math.cos(k * m)));
				else if (
					((b = f + (1 - l) * y),
					f - l * y < d ? (g = c.x + g * (1 - l) - d) : b > a && ((g = a - c.x + g * l), (t = -1)),
					(g = Math.min(p, g)),
					g < p && 'center' === e.labelAlign && (c.x += t * (p - g - l * (p - Math.min(y, g)))),
					y > g || (e.autoRotation && (h.styles || {}).width))
				)
					x = g;
				x &&
					(this.shortenLabel
						? this.shortenLabel()
						: ((L.width = Math.floor(x)),
						  (r.style || {}).textOverflow || (L.textOverflow = 'ellipsis'),
						  h.css(L)));
			},
			getPosition: function (c, e, m, f) {
				var b = this.axis,
					a = b.chart,
					d = (f && a.oldChartHeight) || a.chartHeight;
				c = {
					x: c
						? I(b.translate(e + m, null, null, f) + b.transB)
						: b.left +
						  b.offset +
						  (b.opposite ? ((f && a.oldChartWidth) || a.chartWidth) - b.right - b.left : 0),
					y: c
						? d - b.bottom + b.offset - (b.opposite ? b.height : 0)
						: I(d - b.translate(e + m, null, null, f) - b.transB)
				};
				c.y = F(c.y, -1e5, 1e5);
			...
			getLabelPosition: function (c, e, A, f, b, a, d, h) {
				var k = this.axis,
					...
					t = b.y,
					x = f || k.reserveSpaceDefault ? 0 : -k.labelOffset * ('center' === k.labelAlign ? 0.5 : 1),
					L = {};
				G(t) ||
					(t =
						0 === k.side
							...
							: 2 === k.side
							? g.y + 8
							: Math.cos(A.rotation * m) * (g.y - A.getBBox(!1, 0).height / 2));
			...
			renderGridLine: function (c, e, m) {
				...
				b = b[p + 'LineDashStyle'];
				a ||
					(f.chart.styledMode || ((d.stroke = t), (d['stroke-width'] = g), b && (d.dashstyle = b)),
					k || (d.zIndex = 1),
					c && (e = 0),
					(this.gridLine = a =
						r
				...
				if (
					a &&
					(m = f.getPlotLinePath({ value: h + l, lineWidth: a.strokeWidth() * m, force: 'pass', old: c }))
				)
					...
					r &&
						((this.mark = l =
							a
								...
								.add(f.axisGroup)),
						f.chart.styledMode || l.attr({ stroke: b, 'stroke-width': g })),
					l[r ? 'attr' : 'animate']({
			...
			renderLabel: function (c, e, m, f) {
				...
				h &&
					q(p) &&
					((h.xy = c = this.getLabelPosition(p, c, h, a, k, b, f, l)),
					(this.isFirst && !this.isLast && !B(d.showFirstLabel, 1)) ||
					(this.isLast && !this.isFirst && !B(d.showLastLabel, 1))
						? (y = !1)
						: !a || k.step || k.rotation || e || 0 === m || this.handleOverflow(c),
					l && f % l && (y = !1),
					y && q(c.y)
						? ((c.opacity = m), h[this.isNewLabel ? 'attr' : 'animate'](c), (this.isNewLabel = !1))
	...
	M(J, 'parts/Axis.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		B(e.prototype, {
			...
			init: function (b, d) {
				...
				d = g.options.events;
				-1 === b.axes.indexOf(g) &&
					(n ? b.axes.splice(b.xAxis.length, 0, g) : b.axes.push(g), b[g.coll].push(g));
				g.series = g.series || [];
			...
			defaultLabelFormatter: function () {
				...
				if (x) var e = y(x, this, k);
					...
					for (; l-- && 'undefined' === typeof e; )
						(d = Math.pow(c, l + 1)),
							a >= d && 0 === (10 * b) % d && null !== t[l] && 0 !== b && (e = p(b / d, -1) + t[l]);
						...
						if (g.visible || !b.options.chart.ignoreHiddenSeries) {
							...
							if (a.isXAxis) {
								if (((n = g.xData), n.length)) {
									...
									w(f) ||
										f instanceof Date ||
										((n = n.filter(w)), (d = g.getXExtremes(n)), (f = d.min), (h = d.max));
									n.length &&
										((a.dataMin = Math.min(D(a.dataMin, f), f)),
										(a.dataMax = Math.max(D(a.dataMax, h), h)));
								}
							} else if (
								(g.getExtremes(),
								(h = g.dataMax),
								...
								q(f) &&
									...
									(a.dataMax = Math.max(D(a.dataMax, h), h))),
								q(z) && (a.threshold = z),
								!n.softThreshold || a.positiveValuesOnly)
							)
								a.softThreshold = !1;
						}
					});
			...
			translate: function (a, b, d, g, f, h) {
				...
				b
					? ((a = (a * z + c - l) / t + g), f && (a = n.lin2val(a)))
					: (f && (a = n.val2lin(a)), (a = w(g) ? z * (a - g) * t + c + z * l + (w(h) ? t * h : 0) : void 0));
				return a;
			},
			...
			getPlotLinePath: function (a) {
				...
				l(this, 'getPlotLinePath', a, function (a) {
					...
					w(c)
						? b.horiz
							? ((p = n), (E = m - b.bottom), (k = e = q(k, g, g + b.width)))
							: ((k = g), (e = L - b.right), (p = E = q(p, n, n + b.height)))
						: ((y = !0), (x = !1));
			...
			getMinorTickPositions: function () {
				...
				if (t && t / g < a.len / 3)
					if (a.isLog)
						...
						f = f.concat(a.getTimeTicks(a.normalizeTimeTickInterval(g), c, h, b.startOfWeek));
				...
				0 < b.length &&
					...
					(this.series || []).forEach(function (b) {
						...
						if (!b.points || b.isDirtyData)
							(a.max = Math.max(a.max, b.xData.length - 1)), b.processData(), b.generatePoints();
			...
			setAxisTranslation: function (a) {
				...
				if (x || c || g) {
					var k = b.getClosest();
					h
						? ((n = h.minPointOffset), (f = h.pointRangePadding))
						: b.series.forEach(function (a) {
								var d = c ? 1 : x ? D(a.options.pointRange, k, 0) : b.axisPointRange || 0,
									h = a.options.pointPlacement;
								g = Math.max(g, d);
								if (!b.single || c)
									(a = L.xrange && a instanceof L.xrange ? !x : x),
										(n = Math.max(n, a && m(h) ? 0 : d / 2)),
										(f = Math.max(f, a && 'on' === h ? 0 : d));
						  });
			...
			setTickInterval: function (a) {
				...
				n &&
					(b.positiveValuesOnly && !a && 0 >= Math.min(b.min, D(b.dataMin, b.min)) && c.error(10, 1, d),
					(b.min = v(b.log2lin(b.min), 16)),
					(b.max = v(b.log2lin(b.max), 16)));
				b.range &&
					q(b.max) &&
					((b.userMin = b.min = A = Math.max(b.dataMin, b.minFromRange())),
					(b.userMax = u = b.max),
					(b.range = null));
				l(b, 'foundExtremes');
				b.beforePadding && b.beforePadding();
				b.adjustForMinRange();
				!(L || b.axisPointRange || b.usePercentage || x) &&
					q(b.min) &&
					q(b.max) &&
					(d = b.max - b.min) &&
					(!q(A) && e && (b.min -= d * e), !q(u) && k && (b.max += d * k));
				w(b.userMin) ||
					(w(g.softMin) && g.softMin < b.min && (b.min = A = g.softMin),
					w(g.floor) && (b.min = Math.max(b.min, g.floor)));
				w(b.userMax) ||
					(w(g.softMax) && g.softMax > b.max && (b.max = u = g.softMax),
					w(g.ceiling) && (b.max = Math.min(b.max, g.ceiling)));
				r &&
					q(b.dataMin) &&
					((y = y || 0),
					!q(A) && b.min < y && b.dataMin >= y
						? (b.min = b.options.minRange ? Math.min(y, b.max - b.minRange) : y)
						: !q(u) &&
						  b.max > y &&
						  b.dataMax <= y &&
						  (b.max = b.options.minRange ? Math.max(y, b.min + b.minRange) : y));
				b.tickInterval =
					b.min === b.max || 'undefined' === typeof b.min || 'undefined' === typeof b.max
						? 1
						: x && !E && m === b.linkedParent.options.tickPixelInterval
						? (E = b.linkedParent.tickInterval)
						: D(
								E,
								this.tickAmount ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1) : void 0,
								L ? 1 : ((b.max - b.min) * m) / Math.max(b.len, m)
						  );
				h &&
					!a &&
					b.series.forEach(function (a) {
				...
				f ||
					...
					(b.tickInterval = t(
						...
						D(
							g.allowDecimals,
							!(0.5 < b.tickInterval && 5 > b.tickInterval && 1e3 < b.max && 9999 > b.max)
						),
						!!this.tickAmount
					));
			...
			setTickPositions: function () {
				...
				var g = a.tickPositioner,
					...
					h = a.endOnTick;
				this.tickmarkOffset =
					this.categories && 'between' === a.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0;
				...
				this.isLinked ||
					(this.single && 2 > d.length && !this.categories && ((this.min -= 0.5), (this.max += 0.5)),
					b || g || this.adjustTickAmount());
			...
			zoom: function (a, b) {
				...
				l(this, 'zoom', a, function (a) {
					var b = a.newMin,
						n = a.newMax;
					if (b !== this.min || n !== this.max)
						this.allowZoomOutside ||
							(q(d) && (b < f && (b = f), b > h && (b = h)),
							q(g) && (n < f && (n = f), n > h && (n = h))),
							(this.displayBtn = 'undefined' !== typeof b || 'undefined' !== typeof n),
							this.setExtremes(b, n, !1, void 0, { trigger: 'zoom' });
					a.zoomed = !0;
				});
				return a.zoomed;
			},
			...
			unsquish: function () {
				...
				b
					? (p =
							!a.staggerLines &&
							!a.step &&
							(q(c) ? [c] : f < D(a.autoRotationLimit, 80) && a.autoRotation)) &&
			...
			getSlotWidth: function (a) {
				...
				return (
					(a && a.slotWidth) ||
					(d && 2 > (g.step || 0) && !g.rotation && ((this.staggerLines || 1) * this.len) / f) ||
					(!d && ((g.style && parseInt(g.style.width, 10)) || (n && n - b.spacing[3]) || 0.33 * b.chartWidth))
				);
			},
						...
						for (l = d.length; !c && l--; ) {
							...
							if ((y = g[y].label))
								y.styles && 'ellipsis' === y.styles.textOverflow
									...
									: y.textPxLength > t && y.css({ width: t + 'px' }),
									y.getBBox().height > this.len / d.length - (k.h - k.f) &&
										(y.specificTextOverflow = 'ellipsis');
						}
					}
				}
				x.rotation && ((E = e > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : e), p || (L = 'ellipsis'));
					...
					b &&
						...
						a.shortenLabel
							...
							: E &&
							  !d &&
							  'nowrap' !== h.whiteSpace &&
							  (E < b.textPxLength || 'SPAN' === b.element.tagName)
							? ((f.width = E), p || (f.textOverflow = b.specificTextOverflow || L), b.css(f))
							: b.styles && b.styles.width && !f.width && !d && b.css({ width: null }),
					...
					((n = h.textAlign) ||
						(n = (
							d
								...
								: { low: f ? 'right' : 'left', middle: 'center', high: f ? 'left' : 'right' }
						)[h.align]),
					(this.axisTitle = b
						.text(h.text, 0, 0, h.useHTML)
						.attr({ zIndex: 7, rotation: h.rotation || 0, align: n })
						.addClass('highcharts-axis-title')),
					c || this.axisTitle.css(g(h.style)),
			...
			getOffset: function () {
				...
				a.axisGroup ||
					((a.gridGroup = d
						.g('grid')
						.attr({ zIndex: g.gridZIndex || 1 })
						.addClass('highcharts-' + this.coll.toLowerCase() + '-grid ' + (u || ''))
						.add(v)),
					(a.axisGroup = d
						.g('axis')
						.attr({ zIndex: g.zIndex || 2 })
				...
				w || a.isLinked
					? (f.forEach(function (b, d) {
					  ...
					  a.renderUnsquish(),
					  (a.reserveSpaceDefault = 0 === t || 2 === t || { 1: 'left', 3: 'right' }[t] === a.labelAlign),
					  D(m.reserveSpace, 'center' === a.labelAlign ? !0 : null, a.reserveSpaceDefault) &&
				...
				y[t] = Math.max(
					y[t],
					a.axisTitleMargin + p + A * a.offset,
					e,
					f && f.length && c ? c[0] + A * a.offset : 0
				);
			...
			getLinePath: function (a) {
				...
				return b.renderer.crispLine(
					[
						...
						f ? g : this.top,
						'L',
						f ? b.chartWidth - this.right : h,
						f ? g : b.chartHeight - this.bottom
					],
					a
				);
			},
			...
			getTitlePosition: function () {
				...
				b =
					(a ? d + this.height : b) +
					(a ? 1 : -1) * (c ? -1 : 1) * this.axisTitleMargin +
					[-p, p, e.f, -p][this.side];
				a = {
			...
			renderTick: function (a, b) {
				...
				if (!d || (a >= this.min && a <= this.max))
					g[a] || (g[a] = new E(this, a)), f && g[a].isNew && g[a].render(b, !0, -1), g[a].render(b);
			},
			render: function () {
				var a = this,
					d = a.chart,
				...
				if (a.hasData() || h)
					a.minorTickInterval &&
						...
						t.length &&
							...
							y &&
								(0 === a.min || a.single) &&
								(k[-1] || (k[-1] = new E(a, -1, null, !0)), k[-1].render(-1))),
						L &&
							t.forEach(function (b, g) {
								...
								0 === g % 2 &&
									b < a.max &&
									v <= a.max + (d.polar ? -y : y) &&
									(e[b] || (e[b] = new c.PlotLineOrBand(a)),
									(D = b + y),
									(e[b].options = { from: f ? a.lin2log(D) : D, to: f ? a.lin2log(v) : v, color: L }),
									e[b].render(),
									(e[b].isActive = !0));
							}),
						a._addedPlotLB ||
							((g.plotLines || []).concat(g.plotBands || []).forEach(function (b) {
				...
				x &&
					...
					w(g.y)
						? (x[x.isNew ? 'attr' : 'animate'](g), (x.isNew = !1))
			...
			drawCrosshair: function (a, b) {
				...
				if (this.crosshair && !1 !== (q(b) || !f)) {
					f
						...
						: (h = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos));
					if (q(h)) {
						var t = { value: b && (this.isXAxis ? b.x : D(b.stackY, b.y)), translatedValue: h };
						this.chart.polar &&
							B(t, { isCrosshair: !0, chartX: a && a.chartX, chartY: a && a.chartY, point: b });
					...
					c ||
						((this.cross = c =
							this.chart.renderer
								...
								.attr({ zIndex: D(g.zIndex, 2) })
								.add()),
						this.chart.styledMode ||
							(c
								.attr({
									stroke: g.color || (f ? d('#ccd6eb').setOpacity(0.25).get() : '#cccccc'),
	...
	M(J, 'parts/DateTimeAxis.js', [J['parts/Globals.js']], function (c) {
		...
		e.prototype.normalizeTimeTickInterval = function (c, e) {
			...
			for (
				u = 0;
				u < q.length &&
				!((e = q[u]), (v = G[e[0]]), (B = e[1]), q[u + 1] && c <= (v * B[B.length - 1] + G[q[u + 1][0]]) / 2);
				u++
			);
	...
	M(J, 'parts/LogarithmicAxis.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		e.prototype.getLogTickPositions = function (c, e, q, C) {
			...
			if (0.5 <= c) (c = Math.round(c)), (w = this.getLinearTickPositions(c, e, q));
			else if (0.08 <= c) {
				u = Math.floor(e);
				var m, r;
				for (
					v = 0.3 < c ? [1, 2, 4] : 0.15 < c ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9];
					u < q + 1 && !r;
					u++
				) {
					var D = v.length;
				...
				(e = this.lin2log(e)),
					(q = this.lin2log(q)),
					(c = C ? this.getMinorTickInterval() : v.tickInterval),
					(c = F(
						'auto' === c ? null : c,
						this._minorAutoInterval,
						((v.tickPixelInterval / (C ? 5 : 1)) * (q - e)) / ((C ? u / this.tickPositions.length : u) || 1)
					)),
					(c = G(c, null, I(c))),
					(w = this.getLinearTickPositions(c, e, q).map(this.log2lin)),
			...
			c.PlotLineOrBand.prototype = {
				render: function () {
					...
					r.chart.styledMode ||
						(l
							? ((g.stroke = t || '#999999'),
							  (g['stroke-width'] = u(A.width, 1)),
							  A.dashStyle && (g.dashstyle = A.dashStyle))
							: k &&
							  ((g.fill = t || '#e6ebf5'),
							  A.borderWidth && ((g.stroke = A.borderColor), (g['stroke-width'] = A.borderWidth))));
					E.zIndex = x;
					z += '-' + x;
					(t = r.plotLinesAndBandsGroups[z]) ||
						(r.plotLinesAndBandsGroups[z] = t =
							n
								.g('plot-' + z)
								.attr(E)
								.add());
					...
					(p || !y.d) && g && g.length
						...
						: y &&
						  (g ? (y.show(!0), y.animate({ d: g })) : y.d && (y.hide(), b && (e.label = b = b.destroy())));
					f && (H(f.text) || H(f.formatter)) && g && g.length && 0 < r.width && 0 < r.height && !g.isFlat
						? ((f = w(
								{
									align: q && k && 'center',
									x: q ? !k && 4 : 10,
				...
				renderLabel: function (c, e, q, A) {
					...
					f ||
						...
						(f.zIndex = A),
						(A = this.getLabelText(c)),
						(this.label = f = b.text(A, 0, 0, c.useHTML).attr(f).add()),
						this.axis.chart.styledMode || f.css(c.style));
	...
	M(J, 'parts/Tooltip.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		c.Tooltip.prototype = {
			...
			getLabel: function () {
				...
				if (!this.label) {
					this.outside &&
						((this.container = h = c.doc.createElement('div')),
						...
						c.doc.body.appendChild(h),
						(this.renderer = f = new c.Renderer(h, 0, 0, {}, void 0, void 0, f.styledMode)));
					this.split
						? (this.label = f.g(d))
						: ((this.label = f
								.label('', 0, 0, a.shape || 'callout', null, null, a.useHTML, null, d)
			...
			getAnchor: function (c, f) {
				...
				this.followPointer && f
					? ('undefined' === typeof f.chartX && (f = a.normalize(f)),
					  (c = [f.chartX - b.plotLeft, f.chartY - h]))
					: c[0].tooltipPos
					? (c = c[0].tooltipPos)
					: (c.forEach(function (a) {
					  ...
					  (c = [
							d ? b.plotWidth - e : l,
							this.shared && !d && 1 < c.length && f ? f.chartY - h : d ? b.plotHeight - l : e
					  ]));
			...
			getPosition: function (c, f, b) {
				var a = this.chart,
					...
					g = e
						? Math.max(
								w.body.scrollHeight,
								w.documentElement.scrollHeight,
								w.body.offsetHeight,
								w.documentElement.offsetHeight,
					...
					n = function (h) {
						var n = 'x' === h;
						return [h, n ? p : g, n ? c : f].concat(
							e
								? [
										n ? L(c) : E(f),
										n ? t.left - d + L(b.plotX + a.plotLeft) : t.top - d + E(b.plotY + a.plotTop),
										0,
										n ? p : g
								  ]
								: [
										n ? c : f,
										n ? b.plotX + a.plotLeft : b.plotY + a.plotTop,
										n ? a.plotLeft : a.plotTop,
										n ? a.plotLeft + a.plotWidth : a.plotTop + a.plotHeight
								  ]
						);
					},
					z = n('y'),
			...
			refresh: function (e, f) {
				...
				if (a.enabled) {
					...
					f = p[0];
					var g = p[1];
					!h || (d.series && d.series.noSharedTooltip)
						? (h = d.getLabelConfig())
						: (b.pointer.applyInactiveState(d),
						  d.forEach(function (a) {
								a.setState('hover');
					...
					!1 === b
						...
						: (this.split
								...
								: ((e = this.getLabel()),
								  (a.style.width && !y) || e.css({ width: this.chart.spacingBox.width }),
								  e.attr({ text: b && b.join ? b.join('') : b }),
								  e
										.removeClass(/highcharts-color-[\d]+/g)
										.addClass('highcharts-color-' + C(d.colorIndex, l.colorIndex)),
								  y || e.attr({ stroke: a.borderColor || d.color || l.color || '#666666' }),
								  this.updatePosition({
										plotX: f,
										plotY: g,
										negative: d.negative,
			...
			renderSplit: function (e, f) {
				function b(a, b, d, g, c) {
					void 0 === c && (c = !0);
					d
						? ((b = D ? 0 : I), (a = F(a - g / 2, K.left, K.right - g)))
						: ((b -= B), (a = c ? a - g - v : a + v), (a = F(a, c ? a : K.left, K.right)));
					return { x: a, y: b };
				}
				var a = this,
					d = a.chart,
				...
				e = e.slice(0, f.length + 1).reduce(function (d, c, h) {
					if (!1 !== c && '' !== c) {
						...
						l ||
							((l = { padding: w.padding, r: w.borderRadius }),
							u || ((l.fill = w.backgroundColor), (l['stroke-width'] = w.borderWidth)),
							(l = L.label(
								null,
								null,
								null,
								...
								.addClass(x ? 'highcharts-tooltip-header ' : 'highcharts-tooltip-box ' + k)
								.attr(l)
								.add(R)));
						l.isActive = !0;
						l.attr({ text: c });
						u ||
							l
								.css(w.style)
								.shadow(w.shadow)
								.attr({ stroke: w.borderColor || h.color || e.color || '#333333' });
						c = n.tt = l;
						x = c.getBBox();
						...
						h.isHeader
							...
							: ((l = E.xAxis),
							  (E = E.yAxis),
							  (e = l.pos + F(e, -v, l.len + v) - m),
							  (k = E.pos + F(k, 0, E.len) - r));
			...
			tooltipFooterHeaderFormatter: function (e, f) {
				...
				c.fireEvent(this, 'headerFormatter', f, function (b) {
					...
					l &&
						h &&
						((e.point && e.point.tooltipDateKeys) || ['key']).forEach(function (a) {
			...
			bodyFormatter: function (c) {
				return c.map(function (c) {
					...
					return (b[(c.point.formatPrefix || 'point') + 'Formatter'] || c.point.tooltipFormatter).call(
						c.point,
	...
	M(J, 'parts/Pointer.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		c.Pointer.prototype = {
			...
			findNearestKDPoint: function (a, b, c) {
				...
				a.forEach(function (a) {
					...
					if ((f = v(a, !0)) && !(f = !v(d, !0))) {
						...
						f =
							0 <
							(0 !== f && b ? f : 0 !== h ? h : 0 !== g ? g : d.series.index > a.series.index ? -1 : 1);
					}
					f && (d = a);
				});
				return d;
			...
			getChartCoordinatesFromPoint: function (a, b) {
				...
				if (c && d)
					return b
						? { chartX: c.len + c.pos - f, chartY: d.len + d.pos - a.plotY }
						: { chartX: f + c.pos, chartY: a.plotY + d.pos };
			...
			runPointActions: function (a, b) {
				...
				p = this.getHoverData(
					...
					p,
					d.series,
					(!a || 'touchmove' !== a.type) && (!!b || (p && p.directTouch && this.isDirectTouch)),
					e,
					a
				);
				y = p.hoverPoint;
				...
				if (y && (y !== d.hoverPoint || (f && f.isHidden))) {
					...
					b &&
						f &&
						!f.isHidden &&
						((y = f.getAnchor([{}], a)), f.updatePosition({ plotX: y[0], plotY: y[1] }));
				this.unDocMouseMove ||
					(this.unDocMouseMove = w(d.container.ownerDocument, 'mousemove', function (a) {
			...
			scaleGroups: function (a, b) {
				...
				d.series.forEach(function (f) {
					...
					f.xAxis &&
						...
						f.group &&
						(f.group.attr(c),
						f.markerGroup && (f.markerGroup.attr(c), f.markerGroup.clip(b ? d.clipRect : null)),
						f.dataLabelsGroup && f.dataLabelsGroup.attr(c));
				});
			...
			drag: function (a) {
				...
				if (!E || !E.touch)
					if (
						(f < g ? (f = g) : f > g + x && (f = g + x),
						e < t ? (e = t) : e > t + L && (e = t + L),
						(this.hasDragged = Math.sqrt(Math.pow(n - f, 2) + Math.pow(z - e, 2))),
						10 < this.hasDragged)
					) {
						...
						b.hasCartesianSeries &&
							...
							((this.selectionMarker = E =
								b.renderer
									.rect(g, t, m ? 1 : x, p ? 1 : L, 0)
									.attr({ class: 'highcharts-selection-marker', zIndex: 7 })
									.add()),
							b.styledMode ||
								E.attr({ fill: c.selectionMarkerFill || r('#335cad').setOpacity(0.25).get() }));
			...
			drop: function (a) {
					...
					if (this.hasDragged || e)
						c.axes.forEach(function (d) {
							if (d.zoomEnabled && I(d.min) && (e || b[{ xAxis: 'zoomX', yAxis: 'zoomY' }[d.coll]])) {
								...
								l[d.coll].push({ axis: d, min: Math.min(h, c), max: Math.max(h, c) });
								L = !0;
							}
						}),
							L &&
								f(c, 'selection', l, function (a) {
									c.zoom(G(a, e ? { animation: !1 } : null));
								});
				...
				c &&
					H(c.index) &&
					(D(c.container, { cursor: c._cursor }),
			...
			onContainerClick: function (a) {
				...
				b.cancelClick ||
					(c && this.inClass(a.target, 'highcharts-tracker')
						...
						: (G(a, this.getCoordinates(a)),
						  b.isInsidePlot(a.chartX - e, a.chartY - l) && f(b, 'click', a)));
			},
			...
			destroy: function () {
				...
				c.chartCount ||
					(c.unbindDocumentMouseUp && (c.unbindDocumentMouseUp = c.unbindDocumentMouseUp()),
	...
	M(J, 'parts/TouchPointer.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		F(c.Pointer.prototype, {
			...
			pinchTranslateDirection: function (c, e, C, B, u, w, m, r) {
				...
				n ? ((x -= 0.8 * (x - m[v][0])), g || (E -= 0.8 * (E - m[v][1])), C()) : (m[v] = [x, E]);
				y || ((w[v] = k - d), (w[a] = h));
				w = y ? 1 / l : l;
				u[a] = h;
				u[v] = e;
			...
			pinch: function (c) {
				var e = this,
					...
					f =
						1 === w &&
						((e.inClass(c.target, 'highcharts-tracker') && v.runTrackerClick) || e.runChartClick),
					b = {};
				1 < w && (e.initiated = !0);
				...
				'touchstart' === c.type
					? ([].forEach.call(u, function (a, b) {
							B[b] = { chartX: a.chartX, chartY: a.chartY };
					  }),
					  (m.x = [B[0].chartX, B[1] && B[1].chartX]),
					  (m.y = [B[0].chartY, B[1] && B[1].chartY]),
					  ...
					  (e.res = !0))
					: e.followTouchMove && 1 === w
					? this.runPointActions(e.normalize(c))
					: B.length &&
					  (D || (e.selectionMarker = D = F({ destroy: H, touch: !0 }, v.plotBox)),
					  e.pinchTranslate(B, u, A, D, b, m),
					  (e.hasPinched = r),
					  e.scaleGroups(A, b),
			...
			touch: function (e, q) {
				...
				if (1 === e.touches.length)
					if (
						((e = this.normalize(e)),
						(B = v.isInsidePlot(e.chartX - v.plotLeft, e.chartY - v.plotTop)) && !v.openMenu)
					) {
						...
						if ('touchmove' === e.type) {
							...
							var u = q[0]
								? 4 <=
								  Math.sqrt(Math.pow(q[0].chartX - e.chartX, 2) + Math.pow(q[0].chartY - e.chartY, 2))
								: !1;
						}
						I(u, !0) && this.pinch(e);
					} else q && this.reset();
	...
	M(J, 'parts/MSPointer.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		if (!c.hasTouch && (w.PointerEvent || w.MSPointerEvent)) {
			var m = {},
				...
				A = function (f, b, a, d) {
					('touch' !== f.pointerType && f.pointerType !== f.MSPOINTER_TYPE_TOUCH) ||
						!H[c.hoverChartIndex] ||
						(d(f),
						(d = H[c.hoverChartIndex].pointer),
						d[b]({ type: a, target: f.currentTarget, preventDefault: C, touches: D() }));
				};
			F(B.prototype, {
				onContainerPointerDown: function (c) {
					A(c, 'onContainerTouchStart', 'touchstart', function (b) {
						m[b.pointerId] = { pageX: b.pageX, pageY: b.pageY, target: b.currentTarget };
					});
				},
				onContainerPointerMove: function (c) {
					A(c, 'onContainerTouchMove', 'touchmove', function (b) {
						m[b.pointerId] = { pageX: b.pageX, pageY: b.pageY };
			...
			e(B.prototype, 'init', function (c, b, a) {
				c.call(this, b, a);
				this.hasZoom && v(b.container, { '-ms-touch-action': 'none', 'touch-action': 'none' });
			});
	...
	M(J, 'parts/Legend.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		c.Legend.prototype = {
			...
			setOptions: function (b) {
				...
				this.options = b;
				this.chart.styledMode ||
					((this.itemStyle = b.itemStyle), (this.itemHiddenStyle = D(this.itemStyle, b.itemHiddenStyle)));
			...
			positionItem: function (b) {
				...
				c = c[1];
				var e = b.checkbox;
				if ((b = b.legendGroup) && b.element)
					b[F(b.translateY) ? 'animate' : 'attr']({
				...
				d.text &&
					(this.title ||
						((this.title = this.chart.renderer
							.label(d.text, a - 3, a - 4, null, null, null, b.useHTML, null, 'legend-title')
							.attr({ zIndex: 1 })),
			...
			renderItem: function (b) {
				...
				x ||
					...
					(b.legendItem = x = d.text('', t ? f + e : -e, this.baseline || 0, z)),
					a.styledMode || x.css(D(b.visible ? m : p)),
					x.attr({ align: t ? 'left' : 'right', zIndex: 2 }).add(b.legendGroup),
					this.baseline ||
						((this.fontMetrics = d.fontMetrics(a.styledMode ? 12 : m.fontSize, x)),
					...
					E.drawLegendSymbol(this, b),
					this.setItemEvents && this.setItemEvents(b, x, z));
				n && !b.checkbox && this.createCheckboxForItem(b);
				this.colorizeItem(b, b.visible);
				(!a.styledMode && m.width) ||
					x.css({ width: (c.itemWidth || this.widthOption || a.spacingBox.width) - g });
				this.setText(b);
				a = x.getBBox();
			...
			layoutItem: function (b) {
				...
				c &&
					this.itemX - d + a > g &&
					((this.itemX = d),
					this.lastLineHeight && (this.itemY += m + this.lastLineHeight + e),
			...
			getAllItems: function () {
				...
				this.chart.series.forEach(function (a) {
					var d = a && a.options;
					a &&
						H(d.showInLegend, F(d.linkedTo) ? !1 : void 0, !0) &&
						(b = b.concat(a.legendItems || ('point' === d.legendType ? a.data : a)));
				});
			...
			adjustMargins: function (b, a) {
				var d = this.chart,
					...
					f = this.getAlignment();
				f &&
					[/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function (e, h) {
						e.test(f) &&
							!F(b[h]) &&
							(d[r[h]] = Math.max(
								d[r[h]],
			...
			proximatePositions: function () {
				...
				this.allItems.forEach(function (f) {
					...
					if (f.yAxis && f.points) {
						...
						f.visible ? ((h = h ? h.plotY : f.yAxis.height), (h += m - 0.3 * e)) : (h = m + f.yAxis.height);
			...
			render: function () {
				...
				d ||
					((this.group = d = a.g('legend').attr({ zIndex: 7 }).add()),
					(this.contentGroup = a.g().attr({ zIndex: 1 }).add(d)),
				...
				g += m;
				f ||
					((this.box = f = a.rect().addClass('highcharts-legend-box').attr({ r: e.borderRadius }).add(d)),
					(f.isNew = !0));
				b.styledMode ||
					f
						.attr({
				...
				0 < p &&
					...
					(f[f.isNew ? 'attr' : 'animate'](
						f.crisp.call({}, { x: 0, y: 0, width: p, height: g }, f.strokeWidth())
					),
					(f.isNew = !1));
				f[c ? 'show' : 'hide']();
				...
				c &&
					...
					/(lth|ct|rth)/.test(this.getAlignment()) && 0 < b.titleOffset[0]
						? (f += b.titleOffset[0])
						: /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < b.titleOffset[2] && (f -= b.titleOffset[2]),
					f !== a.y && (a = D(a, { y: f })),
					d.align(
						D(e, { width: p, height: g, verticalAlign: this.proximate ? 'top' : e.verticalAlign }),
						!0,
						a
					));
			...
			handleOverflow: function (b) {
				...
				z.length = 0;
				b > e && !1 !== x.enabled
					? ((this.clipHeight = g = Math.max(e - 20 - this.titleHeight - m, 0)),
					  ...
					  t || ((t = a.clipRect = c.clipRect(0, m, 9999, 0)), a.contentGroup.clip(t)),
					  u(g),
					  n ||
							((this.nav = n = c.g().attr({ zIndex: 1 }).add(this.group)),
							(this.up = c.symbol('triangle', 0, 0, E, E).add(n)),
							w('upTracker').on('click', function () {
								a.scroll(-1, L);
							}),
							(this.pager = c.text('', 15, 10).addClass('highcharts-legend-navigation')),
							d.styledMode || this.pager.css(x.style),
							this.pager.add(n),
							(this.down = c.symbol('triangle-down', 0, 0, E, E).add(n)),
					  ...
					  (b = e))
					: n &&
					  (u(), (this.nav = n.destroy()), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0));
				return b;
			},
			scroll: function (b, a) {
				var d = this,
				...
				0 < m &&
					...
					f.styledMode ||
						(this.up.attr({ fill: 1 === m ? p.inactiveColor : p.activeColor }),
						this.upTracker.css({ cursor: 1 === m ? 'default' : 'pointer' }),
						this.down.attr({ fill: m === l ? p.inactiveColor : p.activeColor }),
						this.downTracker.css({ cursor: m === l ? 'default' : 'pointer' })),
					(this.scrollOffset = -e[m - 1] + this.initialItemY),
					this.scrollGroup.animate({ translateY: this.scrollOffset }),
					(this.currentPage = m),
					this.positionCheckboxes(),
					(a = c.animObject(H(a, f.renderer.globalAnimation, !0))),
					C(function () {
						w(d, 'afterScroll', { currentPage: m });
					}, a.duration || 0));
			}
		};
		c.LegendSymbolMixin = {
			drawRectangle: function (b, a) {
				...
				a.legendSymbol = this.chart.renderer
					.rect(
						c ? (b.symbolWidth - d) / 2 : 0,
						b.baseline - d + 1,
						c ? d : b.symbolWidth,
						d,
						H(b.options.symbolRadius, d / 2)
					)
			...
			drawLineMarker: function (b) {
				...
				var g = {};
				this.chart.styledMode ||
					((g = { 'stroke-width': a.lineWidth || 0 }), a.dashStyle && (g.dashstyle = a.dashStyle));
				this.legendLine = m.path(['M', 0, b, 'L', c, b]).addClass('highcharts-graph').attr(g).add(p);
				d &&
					!1 !== d.enabled &&
					c &&
					((a = Math.min(H(d.radius, e), e)),
					0 === this.symbol.indexOf('url') && ((d = D(d, { width: f, height: f })), (a = 0)),
					(this.legendSymbol = d =
						m
							.symbol(this.symbol, c / 2 - a, b - a, 2 * a, 2 * a, d)
							.addClass('highcharts-point')
							.add(p)),
					(d.isMarker = !0));
			}
		};
		(/Trident\/7\.0/.test(f.navigator && f.navigator.userAgent) || m) &&
			e(c.Legend.prototype, 'positionItem', function (b, a) {
				var d = this,
					c = function () {
	...
	M(J, 'parts/Chart.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		q(Q.prototype, {
			...
			redraw: function (a) {
				...
				if (z) for (a = g.length; a--; ) (k = g[a]), k.options.stacking && (k.isDirty = !0);
				g.forEach(function (a) {
					a.isDirty &&
						('point' === a.options.legendType
							? (a.updateTotals && a.updateTotals(), (h = !0))
							: e && (e.labelFormatter || e.labelFormat) && (h = !0));
			...
			applyDescription: function (a, b) {
				...
				g &&
					...
					((c = this.renderer
						...
						.attr({ align: g.align, class: 'highcharts-' + a, zIndex: g.zIndex || 4 })
						.add()),
					(c.update = function (b) {
			...
			layOutTitles: function (a) {
				...
				!this.isDirtyBox &&
					...
					this.hasRendered && D(a, !0) && this.isDirtyBox && this.redraw());
			},
			getChartSize: function () {
				...
				this.chartHeight = Math.max(
					0,
					f(a, this.chartWidth) || (1 < this.containerHeight ? this.containerHeight : 400)
				);
			},
			temporaryDisplay: function (a) {
				...
				if (a)
					for (; b && b.style; )
						b.hcOrigStyle && (c.css(b, b.hcOrigStyle), delete b.hcOrigStyle),
					...
					for (; b && b.style; ) {
						...
						if ('none' === c.getStyle(b, 'display', !1) || b.hcOricDetached)
							(b.hcOrigStyle = {
			...
			getContainer: function () {
				...
				this.renderer = new (c[b.renderer] || c.Renderer)(
					d,
					h,
					n,
					null,
				...
				if (this.styledMode) for (e in a.defs) this.renderer.definition(a.defs[e]);
			...
			reflow: function (a) {
				...
				if (!e && !b.isPrinting && h && g && (f === P || f === l)) {
					if (h !== b.containerWidth || g !== b.containerHeight)
						c.clearTimeout(b.reflowTimeout),
							(b.reflowTimeout = d(
								function () {
			...
			drawChartBox: function () {
				...
				h ||
					...
					l &&
						(t
							? (l !== t.attr('href') && t.attr('href', l), t.animate(r))
							: (this.plotBGImage = b.image(l, k, m, z, L).add())));
				q ? q.animate({ width: y.width, height: y.height }) : (this.clipRect = b.clipRect(y));
				N = 'animate';
				e ||
					((N = 'attr'),
					(this.plotBorder = e = b.rect().addClass('highcharts-plot-border').attr({ zIndex: 1 }).add()));
			...
			linkSeries: function () {
				...
				b.forEach(function (b) {
					...
					w(d) &&
						...
						(b.visible = D(b.options.visible, d.options.visible, b.visible)));
				});
			...
			updateContainerScaling: function () {
				...
				if (a.offsetWidth && a.offsetHeight && a.getBoundingClientRect) {
					...
					1 !== d || 1 !== a
						? (this.containerScaling = { scaleX: d, scaleY: a })
	...
	M(J, 'parts/ScrollablePlotArea.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		I(e, 'afterSetChartSize', function (e) {
			...
			if (!this.renderer.forExport) {
				if (v) {
					...
					G &&
						(this.scrollablePixelsY = v = Math.max(0, G - this.chartHeight)) &&
						((this.plotHeight += v),
						this.inverted
							? ((this.clipBox.width += v), (this.plotBox.width += v))
							: ((this.clipBox.height += v), (this.plotBox.height += v)),
						(q = { 2: { name: 'bottom', value: v } }));
				q &&
					!e.skipAxes &&
		...
		e.prototype.setUpScrolling = function () {
			...
			this.innerContainer = c.createElement(
				'div',
		...
		e.prototype.moveFixedElements = function () {
			...
			this.scrollablePixelsX && !this.inverted
				...
				? (q = '.highcharts-xaxis')
				: this.scrollablePixelsY && this.inverted && (q = '.highcharts-yaxis');
			v.push(q, q + '-labels');
		...
		e.prototype.applyFixed = function () {
			...
			H
				? ((this.fixedDiv = c.createElement(
				  ...
				  (this.fixedRenderer = e = new c.Renderer(this.fixedDiv, this.chartWidth, this.chartHeight)),
				  (this.scrollableMask = e
						.path()
						.attr({
							fill: this.options.chart.backgroundColor || '#fff',
							'fill-opacity': F(v.opacity, 0.85),
							zIndex: -1
						})
			...
			H &&
				(v.scrollPositionX && (this.scrollingContainer.scrollLeft = this.scrollablePixelsX * v.scrollPositionX),
				v.scrollPositionY && (this.scrollingContainer.scrollTop = this.scrollablePixelsY * v.scrollPositionY));
			q = this.axisOffset;
		...
		c.Point.prototype = {
			...
			resolveColor: function () {
				...
				c.options.colorByPoint
					? (a ||
							((b = c.options.colors || c.chart.options.colors),
							(this.color = this.color || b[c.colorCounter]),
							(b = b.length)),
					  (a = c.colorCounter),
					  c.colorCounter++,
					  c.colorCounter === b && (c.colorCounter = 0))
					: (a = c.colorIndex);
			...
			applyOptions: function (c, b) {
				...
				d && (this.y = this[d]);
				this.formatPrefix = (this.isNull = u(this.isValid && !this.isValid(), null === this.x || !q(this.y)))
					? 'null'
					: 'point';
			...
			optionsToObject: function (f) {
				...
				if (q(f) || null === f) b[e[0]] = f;
					...
					for (
						!d &&
						f.length > k &&
						((a = typeof f[0]), 'string' === a ? (b.name = f[0]) : 'number' === a && (b.x = f[0]), l++);
						m < k;

					)
						(d && 'undefined' === typeof f[l]) ||
							(0 < e[m].indexOf('.')
								? c.Point.prototype.setNestedProperty(b, f[l], e[m])
								: (b[e[m]] = f[l])),
							l++,
							m++;
				else
					'object' === typeof f &&
						((b = f), f.dataLabels && (a._hasPointLabels = !0), f.marker && (a._hasPointMarkers = !0));
				return b;
			},
			...
			animateBeforeDestroy: function () {
				...
				d.plural.forEach(function (a) {
					c[a].forEach(function (a) {
						a.element &&
							a.animate(H({ x: c.startXPos }, a.startYPos ? { x: a.startXPos, y: a.startYPos } : {}));
					});
				});
			},
			...
			},
			{
				...
				init: function (a, d) {
					...
					r(t, function (a, d) {
						c.isFunction(a) &&
							g.eventOptions[d] !== a &&
							(c.isFunction(g.eventOptions[d]) && l(g, d, g.eventOptions[d]),
							(g.eventOptions[d] = a),
							b(g, d, a));
					});
					if ((t && t.click) || (d.point && d.point.events && d.point.events.click) || d.allowPointSelect)
						a.runTrackerClick = !0;
					g.getColor();
					g.getSymbol();
					...
					d.dataSorting && d.dataSorting.enabled
						? g.setDataSortingOptions()
						: g.points || g.data || g.setData(d.data, !1);
					h(this, 'afterInit');
				},
				insert: function (a) {
					...
					h(this, 'bindAxes', null, function () {
						(a.axisTypes || []).forEach(function (g) {
							d[g].forEach(function (d) {
								...
								if (
									b[g] === f.index ||
									('undefined' !== typeof b[g] && b[g] === f.id) ||
									('undefined' === typeof b[g] && 0 === f.index)
								)
									a.insert(d.series), (a[g] = d), (d.isDirty = !0);
							});
				...
				autoIncrement: function () {
					...
					c &&
						...
						'day' === c
							...
							: 'month' === c
							? f.set('Month', a, f.get('Month', a) + d)
							: 'year' === c && f.set('FullYear', a, f.get('FullYear', a) + d),
						(d = a.getTime() - b));
					this.xIncrement = b + d;
					return b;
				},
				...
				setOptions: function (b) {
					...
					(!f.negativeColor && !f.negativeFillColor) ||
						...
						d || ((g.color = f.negativeColor), (g.fillColor = f.negativeFillColor)),
						c.push(g));
					c.length &&
						q(c[c.length - 1].value) &&
				...
				getColor: function () {
					this.chart.styledMode
						...
						: this.getCyclic('color', this.options.color || d[this.type].color, this.chart.options.colors);
				},
				getSymbol: function () {
				...
				findPointIndex: function (a, b) {
					...
					-1 !== p &&
						'undefined' !== typeof p &&
						this.cropped &&
						(p = p >= this.cropStart ? p - this.cropStart : p);
				...
				updateData: function (a, b) {
					...
					a.forEach(function (a, b) {
						...
						if (h.id || w(n)) {
							if (
								((n = this.findPointIndex(h, t)),
								-1 === n || 'undefined' === typeof n
									? f.push(a)
									: g[n] && a !== d.data[n]
									? (g[n].update(a, !1, null, !1), (g[n].touched = !0), l && (t = n + 1))
									: g[n] && (g[n].touched = !0),
								!p || b !== n || (c && c.enabled) || this.hasDerivedData)
							)
								e = !0;
						} else f.push(a);
					}, this);
					if (e) for (a = g.length; a--; ) (h = g[a]) && !h.touched && h.remove && h.remove(!1, b);
					else
						!p || (c && c.enabled)
							? (m = !1)
							: (a.forEach(function (a, b) {
					...
					if (!C) {
						...
						if (k && t > k)
							if (((k = g.getFirstValidPoint(a)), w(k)))
								...
								if (y) for (d = 0; d < t; d++) (f = a[d]), (L[d] = f[0]), (q[d] = f.slice(1, y + 1));
								else
									for (
										v &&
											((A = v.indexOf('x')),
				...
				sortData: function (a) {
					var b = this,
						...
						c = function (a, b) {
							return (q(b) && a.pointClass.prototype.optionsToObject.call({ series: a }, b)) || {};
						};
				...
				generatePoints: function () {
					...
					for (q = 0; q < p; q++) {
						...
						if (k) {
							...
							u.dataGroup.options &&
								((u.options = u.dataGroup.options), B(u, u.dataGroup.options), delete u.dataLabels);
				...
				getExtremes: function (a) {
					...
					for (k = 0; k < d; k++) {
						...
						r =
							...
							((c[k + p] || r) >= e && (c[k - p] || r) <= l);
						if (y && r)
							if ((y = q.length)) for (; y--; ) w(q[y]) && (g[f++] = q[y]);
							else g[f++] = q;
					}
					this.dataMin = G(g);
					this.dataMax = I(g);
				...
				translate: function () {
					...
					for (m = 0; m < p; m++) {
						...
						u(ba) &&
							((M = ba[0]),
							(W = ba[1]),
							M === B && S.key === Z[J].base && (M = D(w(A) && A, e.min)),
							e.positiveValuesOnly && 0 >= M && (M = null),
							(F.total = F.stackTotal = Y.total),
							(F.percentage = Y.total && (F.y / Y.total) * 100),
							(F.stackY = W),
							this.irregularWidths || Y.setOffset(this.pointXOffset || 0, this.barW || 0));
						F.yBottom = q(M) ? H(e.translate(M, 0, 1, 0, 1), -1e5, 1e5) : null;
						k && (W = this.modifyValue(W, F));
						F.plotY = W =
							'number' === typeof W && Infinity !== W ? H(e.translate(W, 0, 1, 0, 1), -1e5, 1e5) : void 0;
				...
				getClipBox: function (a, b) {
					...
					a && !1 === d.clip && e
						? (a = g
								...
								: { y: -e.pos, height: c.chartHeight, width: c.chartWidth, x: -f.pos })
				...
				setClip: function (a) {
					var b = this.chart,
						...
						h =
							this.sharedClipKey ||
							['_sharedClip', a && a.duration, a && a.easing, e.height, d.xAxis, d.yAxis].join(),
						l = b[h],
						p = b[h + 'm'];
					l ||
						(a &&
							((e.width = 0),
							g && (e.x = b.plotSizeX + (!1 !== d.clip ? 0 : b.plotTop)),
							(b[h + 'm'] = p =
								c.clipRect(
									g ? b.plotSizeX + 99 : -99,
					...
					if (!1 !== d.clip || a)
						this.group.clip(a || f ? l : b.clipRect), this.markerGroup.clip(p), (this.sharedClipKey = h);
					a ||
						(l.count[this.index] && (delete l.count[this.index], --l.count.length),
						0 === l.count.length &&
							h &&
							b[h] &&
							(f || (b[h] = b[h].destroy()), b[h + 'm'] && (b[h + 'm'] = b[h + 'm'].destroy())));
				},
				animate: function (a) {
					var b = this.chart,
				...
				drawPoints: function () {
					...
					if (!1 !== f.enabled || this._hasPointMarkers)
						for (d = 0; d < a.length; d++) {
							...
							var r = !!p.marker;
							if (
								((l && 'undefined' === typeof k.enabled) || k.enabled) &&
								!p.isNull &&
								!1 !== p.visible
							) {
								...
								var u = !1 !== p.isInside;
								c
									? c[u ? 'show' : 'hide'](u).animate(y)
									: u &&
									  (0 < y.width || p.hasImage) &&
									  ((p.graphic = c =
											b.renderer.symbol(q, y.x, y.y, y.width, y.height, r ? k : f).add(e)),
									  this.enabledDataSorting &&
											b.hasRendered &&
											(c.attr({ x: p.startXPos }), (m = 'animate')));
				...
				markerAttribs: function (a, b) {
					...
					b &&
						...
						(f = D(b && b.radius, d && d.radius, f + ((d && d.radiusPlus) || 0))));
							...
							: (0 === n || p
									...
									? ((n =
											1 === g
												? ['L', k.plotX, m]
												: 2 === g
												? ['L', (k.plotX + t) / 2, k.plotY, 'L', (k.plotX + t) / 2, m]
												: ['L', t, k.plotY]),
									  n.push('L', t, m))
									: (n = ['L', t, m]),
							  l.push(e.x),
							  g && (l.push(e.x), 2 === g && l.push(e.x)),
							  h.push.apply(h, n),
							  (p = !1));
					});
					h.xMap = l;
				...
				drawGraph: function () {
					...
					f.forEach(function (f, g) {
						...
						h
							...
							: d.length &&
							  (a[e] = h = a.chart.renderer.path(d).addClass(f[1]).attr({ zIndex: 1 }).add(a.group));
						h &&
							!c &&
							((e = {
								stroke: f[2],
							...
							f[3]
								? (e.dashstyle = f[3])
								: 'square' !== b.linecap && (e['stroke-linecap'] = e['stroke-linejoin'] = 'round'),
							h[l](e).shadow(2 > g && b.shadow));
				...
				getZonesGraphs: function (a) {
					this.zones.forEach(function (b, d) {
						d = [
							'zone-graph-' + d,
							'highcharts-graph highcharts-zone-graph-' + d + ' ' + (b.className || '')
						];
				...
				applyZones: function () {
					...
					if (c.length && (p || k) && r && 'undefined' !== typeof r.min) {
						...
						c.forEach(function (c, g) {
							...
							w = Math.max(f, e);
							r.isXAxis
								? ((l = { x: q ? w : u, y: 0, width: y, height: m }), C || (l.x = b.plotHeight - l.x))
								: ((l = { x: 0, y: q ? w : u, width: m, height: y }), C && (l.y = b.plotWidth - l.y));
							q &&
								d.isVML &&
								(l = r.isXAxis
									? { x: 0, y: A ? u : w, height: l.width, width: b.chartWidth }
									: {
				...
				invertGroups: function (a) {
					function d() {
						['group', 'markerGroup'].forEach(function (b) {
							c[b] &&
								(f.renderer.isVML && c[b].attr({ width: c.yAxis.len, height: c.xAxis.len }),
				...
				plotGroup: function (a, b, d, c, f) {
					...
					g.addClass(
						'highcharts-' +
							...
							this.type +
							'-series ' +
							(q(this.colorIndex) ? 'highcharts-color-' + this.colorIndex + ' ' : '') +
				...
				redraw: function () {
					...
					d &&
						...
						d.animate({ translateX: D(c && c.left, a.plotLeft), translateY: D(f && f.top, a.plotTop) }));
					this.translate();
					this.render();
	...
	M(J, 'parts/Stacking.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		c.StackItem.prototype = {
			...
			setOffset: function (c, e, m, r, q) {
				...
				if (e && u) {
					...
					q &&
						((r.x -= b),
						B.prototype.justifyDataLabel.call(this.axis, e, this.alignOptions, r, m, u),
						(r.x += b));
					r.x = e.alignAttr.x;
					e.attr({ x: r.x, y: r.y });
					v(!q && this.options.crop, !0) &&
						((f =
							f.isInsidePlot(e.x + (f.inverted ? 0 : -m.width / 2), e.y) &&
							f.isInsidePlot(
								e.x + (f.inverted ? (c ? -m.width : m.width) : m.width / 2),
								e.y + m.height
							)) ||
							e.hide());
				}
		...
		q.prototype.getStacks = function () {
			...
			c.series.forEach(function (m) {
				...
				!m.options.stacking ||
					...
					(m.stackKey = [m.type, v(m.options.stack, ''), e ? r.top : r.left, e ? r.height : r.width].join());
			});
		};
		...
		e.prototype.resetStacks = function () {
			...
			c.isXAxis ||
				H(e, function (e) {
					H(e, function (m, q) {
						m.touched < c.stacksTouched
							? (m.destroy(), delete e[q])
							: ((m.total = null), (m.cumulative = null));
					});
				});
		};
		...
		B.prototype.setStackedPoints = function () {
			if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
				...
				for (g = 0; g < r; g++) {
					...
					l[n][t] ||
						(y[n] && y[n][t]
							? ((l[n][t] = y[n][t]), (l[n][t].total = null))
							: (l[n][t] = new c.StackItem(k, k.options.stackLabels, p, t, b)));
					n = l[n][t];
					null !== x
						? ((n.points[E] = n.points[this.index] = [v(n.cumulative, f)]),
						  I(n.cumulative) || (n.base = E),
						  (n.touched = k.stacksTouched),
						  0 < L.index &&
								!1 === this.singleStacks &&
								(n.points[E][0] = n.points[this.index + ',' + t + ',0'][0]))
						: (n.points[E] = n.points[this.index] = null);
					'percent' === D
						? ((p = p ? a : d),
						  h && l[p] && l[p][t]
								? ((p = l[p][t]), (n.total = p.total = Math.max(p.total, n.total) + Math.abs(x) || 0))
								: (n.total = F(n.total + (Math.abs(x) || 0))))
						: (n.total = F(n.total + (x || 0)));
			...
			c[v + 'Stacker'] &&
				[e, '-' + e].forEach(function (f) {
					for (var b = r.length, a, d; b--; )
						if (
							((a = r[b]),
							(q = c.getStackIndicator(q, a, c.index, f)),
							(d = (a = m[f] && m[f][a]) && a.points[q.key]))
						)
							c[v + 'Stacker'](d, a, b);
				});
		};
	...
	M(J, 'parts/Dynamics.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		c.cleanRecursively = function (a, b) {
			var d = {};
			B(a, function (f, g) {
				if (q(a[g], !0) && !a.nodeType && b[g])
					(f = c.cleanRecursively(a[g], b[g])), Object.keys(f).length && (d[g] = f);
		...
		G(e.prototype, {
			addSeries: function (a, b, c) {
				...
				a &&
					((b = u(b, !0)),
					d(g, 'addSeries', { options: a }, function () {
						f = g.initSeries(a);
						g.isDirtyLegend = !0;
						g.linkSeries();
			...
			showLoading: function (d) {
				...
				e ||
					((c.loadingDiv = e =
						b('div', { className: 'highcharts-loading highcharts-loading-hidden' }, null, c.container)),
					(c.loadingSpan = b('span', { className: 'highcharts-loading-inner' }, null, e)),
					D(c, 'redraw', l));
				e.className = 'highcharts-loading';
				c.loadingSpan.innerHTML = u(d, f.lang.loading, '');
				c.styledMode ||
					(a(e, G(h.style, { zIndex: 10 })),
					a(c.loadingSpan, h.labelStyle),
					c.loadingShown ||
						(a(e, { opacity: 0, display: '' }),
						A(e, { opacity: h.style.opacity || 0.5 }, { duration: h.showDuration || 0 })));
				c.loadingShown = !0;
				l();
			},
			...
			update: function (a, b, f, e) {
				...
				this.collectionsWithUpdate.forEach(function (b) {
					if (a[b]) {
						...
						r(a[b]).forEach(function (a, c) {
							(c = (F(a.id) && g.get(a.id)) || g[b][d ? d[c] : c]) &&
								c.coll === b &&
								(c.update(a, !1), f && (c.touched = !0));
							!c &&
								f &&
								g.collectionsWithInit[b] &&
								(g.collectionsWithInit[b][0].apply(
									g,
									[a].concat(g.collectionsWithInit[b][1] || []).concat([!1])
								).touched = !0);
						});
						f &&
				...
				m || (v(x) && x !== g.chartWidth) || (v(p) && p !== g.chartHeight)
					? g.setSize(x, p, e)
					: u(b, !0) && g.redraw(e);
		...
		G(l.prototype, {
			addPoint: function (a, b, c, f, e) {
				...
				var q = r.x;
				var x = m.length;
				if (this.requireSorting && q < m[x - 1]) for (t = !0; x && m[x - 1] > q; ) x--;
				...
				c &&
					(h[0] && h[0].remove
						? h[0].remove(!1)
						: (h.shift(), this.updateParallelArrays(r, 'shift'), k.shift()));
				!1 !== e && d(this, 'addPoint', { point: r });
				...
				if (k && this.points) {
					...
					!1 === D.visible
						...
						: f._hasPointLabels ||
						  ((p = D.marker),
						  (m = D.dataLabels),
						  p && (!1 === p.enabled || 'symbol' in p) && (A.graphic = 1),
						  m && !1 === m.enabled && (A.dataLabel = 1));
					this.points.forEach(function (a) {
						a &&
							a.series &&
							(a.resolveColor(),
							Object.keys(A).length && a.destroyElements(A),
							!1 === D.showInLegend && a.legendItem && g.legend.destroyItem(a));
					}, this);
				}
				a.zIndex !== e.zIndex &&
			...
			{ softThreshold: !1, threshold: 0 },
			{
				...
				getGraphPath: function (c) {
					...
					var a = function (a, d, e) {
						...
						'undefined' !== typeof p &&
							(r.push({ plotX: h, plotY: null === p ? b : u.getThreshold(p), isNull: g, isCliff: !0 }),
							m.push({ plotX: h, plotY: null === k ? b : u.getThreshold(k), doCurve: !1 }));
					};
					c = c || this.points;
					...
					for (w = 0; w < c.length; w++) {
						...
						if (!d || v)
							v || a(w, w - 1, 'left'),
								(d && !B && v) || (r.push(c[w]), m.push({ x: w, plotX: h, plotY: k })),
								v || a(w, w + 1, 'right');
					}
					w = e.call(this, r, !0, !0);
					m.reversed = !0;
				...
				drawGraph: function () {
					...
					this.zones.forEach(function (e, q) {
						B.push([
							'zone-area-' + q,
							'highcharts-area highcharts-zone-area-' + q + ' ' + e.className,
							e.color || c.color,
							e.fillColor || C.fillColor
						]);
					});
					B.forEach(function (q) {
						var v = q[0],
							...
							u = {};
						m
							? ((m.endX = c.preventGraphAnimation ? null : e.xMap), m.animate({ d: e }))
							: ((u.zIndex = 0),
							  (m = c[v] = c.chart.renderer.path(e).addClass(q[1]).add(c.group)),
							  (m.isArea = !0));
						c.chart.styledMode || (u.fill = I(q[3], G(q[2]).setOpacity(I(C.fillOpacity, 0.75)).get()));
						m[r](u);
						m.startX = e.xMap;
			...
			{},
			{
				getPointSpline: function (c, e, H) {
					...
					if (
						...
						r += u;
						m > c && m > q
							? ((m = Math.max(c, q)), (r = 2 * q - m))
							: m < c && m < q && ((m = Math.min(c, q)), (r = 2 * q - m));
						r > H && r > q
							? ((r = Math.max(H, q)), (m = 2 * q - r))
							: r < H && r < q && ((r = Math.min(H, q)), (m = 2 * q - r));
						e.rightContX = B;
						e.rightContY = r;
					}
		...
		e(
			...
			},
			{
				...
				getColumnMetrics: function () {
					...
					var h = Math.min(
							Math.abs(v.transA) *
								(v.ordinalSlope || e.pointRange || v.closestPointRange || v.tickInterval || 1),
							v.len
						),
						k = h * e.groupPadding,
						l = (h - 2 * k) / (d || 1);
				...
				translate: function () {
					...
					c.points.forEach(function (h) {
						...
						G(h.options.pointWidth) &&
							((r = z = Math.ceil(h.options.pointWidth)), (n -= Math.round((r - k) / 2)));
						h.barX = n;
						h.pointWidth = r;
						h.tooltipPos = e.inverted
							? [f.len + f.pos - e.plotLeft - t, c.xAxis.len - n - z / 2, u]
							: [n + z / 2, t + f.pos - e.plotTop, u];
				...
				pointAttribs: function (c, e) {
					...
					e &&
						c &&
						((c = B(m.states[e], (c.options.states && c.options.states[e]) || {})),
						(e = c.brightness),
						(a = c.color || ('undefined' !== typeof e && C(a).brighten(c.brightness).get()) || a),
						(d = c[f] || d),
						(h = c[b] || h),
						(r = c.dashStyle || r),
						(k = q(c.opacity, k)));
					...
					c.points.forEach(function (a) {
						...
						if (v(a.plotY) && null !== a.y) {
							...
							c.enabledDataSorting &&
								(a.startXPos = c.xAxis.reversed ? -(b ? b.width : 0) : c.xAxis.width);
							d ||
								((a.graphic = d = u[a.shapeType](b).add(a.group || c.group)) &&
									c.enabledDataSorting &&
									e.hasRendered &&
									e.pointCount < f &&
									(d.attr({ x: a.startXPos }), (h = !0), (k = 'animate')));
							if (d && h) d[k](B(b));
							if (q.borderRadius) d[k]({ r: q.borderRadius });
							e.styledMode ||
								d[k](c.pointAttribs(a, a.selected && 'select')).shadow(
									!1 !== a.allowShadow && q.shadow,
									null,
				...
				animate: function (c) {
					...
					if (w)
						if (c)
							(b.scaleY = 0.001),
								(c = I(m.toPixels(q.threshold), m.pos, m.pos + m.len)),
								f ? (b.translateX = c - m.len) : (b.translateY = c),
								e.clipBox && e.setClip(),
								e.group.attr(b);
						else {
		...
		F(
			...
			},
			{
				...
				applyJitter: function () {
					...
					e &&
						this.points.forEach(function (v, q) {
		...
		D(
			...
			},
			{
				...
				animate: function (c) {
					...
					c ||
						(a.forEach(function (a) {
							...
							c &&
								f &&
								(c.attr({ r: H(a.startR, b.center && b.center[3] / 2), start: d, end: d }),
				...
				getX: function (c, b, a) {
					...
					return (
						d[0] +
						(b ? -1 : 1) * Math.cos(c) * (f + a.labelDistance) +
						(0 < a.labelDistance ? (b ? -1 : 1) * this.options.dataLabels.padding : 0)
					);
				},
				translate: function (c) {
					...
					for (g = 0; g < t; g++) {
						...
						q.tooltipPos = [c[0] + 0.7 * n, c[1] + 0.7 * z];
						...
						q.labelPosition = {
							...
							connectorPosition: {
								breakAt: { x: c[0] + n + Math.cos(u) * r, y: c[1] + z + Math.sin(u) * r },
								touchingSliceAt: { x: c[0] + n, y: c[1] + z }
							}
						};
					}
				...
				redrawPoints: function () {
					...
					!m ||
						c.shadowGroup ||
						b.styledMode ||
						(c.shadowGroup = a.g('shadow').attr({ zIndex: -1 }).add(c.group));
					c.points.forEach(function (f) {
						...
						if (!f.isNull && e) {
							...
							f.delayedRendering
								? (e.setRadialReference(c.center).attr(l).attr(d),
								  b.styledMode || e.attr(k).attr({ 'stroke-linejoin': 'round' }).shadow(m, h),
								  (f.delayedRendering = !1))
								: (e.setRadialReference(c.center),
								  b.styledMode || u(!0, g, k),
								  u(!0, g, l, d),
								  e.animate(g));
			...
			},
			{
				...
				setVisible: function (c, b) {
					...
					b = H(b, e);
					c !== a.visible &&
						((a.visible = a.options.visible = c = 'undefined' === typeof c ? !a.visible : c),
						...
						a.legendItem && f.legend.colorizeItem(a, c),
						c || 'hover' !== a.state || a.setState(''),
						e && (d.isDirty = !0),
						b && f.redraw());
				},
				...
				haloPath: function (c) {
					...
					return this.sliced || !this.visible
						? []
						: this.series.chart.renderer.symbols.arc(b.x, b.y, b.r + c, b.r + c, {
								innerR: b.r - 1,
								start: b.start,
								end: b.end
						  });
	...
	M(J, 'parts/DataLabels.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		c.distribute = function (b, a, d) {
			...
			for (
				b = b.map(function (a) {
					return { size: a.size, targets: [a.target], align: B(a.align, 0.5) };
				});
				l;
				...
				for (k = b.length; k--; )
					(l = b[k]),
						(g = (Math.min.apply(0, l.targets) + Math.max.apply(0, l.targets)) / 2),
						(l.pos = G(g - l.size * l.align, 0, a - l.size));
				k = b.length;
				for (l = !1; k--; )
					0 < k &&
						...
						(b[k - 1].align = 0.5),
						b[k - 1].pos + b[k - 1].size > a && (b[k - 1].pos = a - b[k - 1].size),
						b.splice(k, 1),
						(l = !0));
			}
			m.push.apply(m, p);
			...
			b.some(function (b) {
				...
				if (
					b.targets.some(function () {
						m[k].pos = b.pos + e;
						if (Math.abs(m[k].pos - m[k].target) > d)
							return (
								m.slice(0, k + 1).forEach(function (a) {
									delete a.pos;
								}),
								(m.reducedLen = (m.reducedLen || a) - 0.1 * a),
								m.reducedLen > 0.1 * a && c.distribute(m, a, d),
								!0
							);
						e += m[k].size;
						k++;
		...
		D.prototype.drawDataLabels = function () {
			...
			function a(a, b) {
				...
				else if (q(a) || q(b)) for (c = Math.max(a.length, b.length); c--; ) d[c] = r(a[c], b[c]);
				else d = r(a, b);
				return d;
			}
			var d = this,
			...
			l = a(
				a(
					...
					e.options.plotOptions && e.options.plotOptions[d.type] && e.options.plotOptions[d.type].dataLabels
				),
				l
			);
				...
				u &&
					...
					g ||
						setTimeout(function () {
							...
							a &&
								(d.visible && n.show(!0),
								a[f.animation ? 'animate' : 'attr']({ opacity: 1 }, { duration: x }));
						}, t - x));
				y.forEach(function (c) {
					...
					p.forEach(function (a, g) {
						...
						if (h) {
							...
							var y = a.rotation;
							e.styledMode ||
								((r.color = B(a.color, r.color, d.color, '#000000')),
								'contrast' === r.color
									? ((c.contrastColor = v.getContrast(c.color || d.color)),
									  (r.color =
											(!H(k) && a.inside) || 0 > k || f.stacking ? c.contrastColor : '#000000'))
									: delete c.contrastColor,
								f.cursor && (r.cursor = f.cursor));
							var x = { r: a.borderRadius || 0, rotation: y, padding: a.padding, zIndex: 1 };
							e.styledMode ||
								((x.fill = a.backgroundColor),
								(x.stroke = a.borderColor),
								(x['stroke-width'] = a.borderWidth));
							C(x, function (a, b) {
							...
							? h &&
							  ...
							  (l
									...
									: ((c.dataLabels = c.dataLabels || []),
									  (l = c.dataLabels[g] =
											y
												? v.text(q, 0, -9999).addClass('highcharts-data-label')
												: v.label(
														q,
														0,
														-9999,
							  ...
							  (l.options = a),
							  l.attr(x),
							  e.styledMode || l.css(r).shadow(a.shadow),
							  l.added || l.add(n),
							  a.textPath &&
									!a.useHTML &&
									(l.setTextPath(
										(c.getDataLabelPath && c.getDataLabelPath(l)) || c.graphic,
										a.textPath
									),
									c.dataLabelPath &&
										!a.textPath.enabled &&
										(c.dataLabelPath = c.dataLabelPath.destroy())),
							  d.alignDataLabel(c, l, a, null, t))
							: ((c.dataLabel = c.dataLabel && c.dataLabel.destroy()),
							  c.dataLabels &&
									(1 === c.dataLabels.length ? delete c.dataLabels : delete c.dataLabels[g]),
							  g || delete c.dataLabel,
							  p &&
									((c.connector = c.connector.destroy()),
									c.connectors &&
										(1 === c.connectors.length ? delete c.connectors : delete c.connectors[g])));
					});
				});
			}
		...
		D.prototype.alignDataLabel = function (b, a, c, e, f) {
			var d = this,
				...
				A =
					...
					(b.series.forceDL ||
						(g && !w) ||
						u ||
						(e && h.isInsidePlot(k, p ? e.x + 1 : e.y + e.height - 1, p)));
			var C = function (c) {
			...
			if (A) {
				...
				e = v(
					{ x: p ? this.yAxis.len - m : k, y: Math.round(p ? this.xAxis.len - k : m), width: 0, height: 0 },
					e
				);
				v(c, { width: q.width, height: q.height });
				r
					? ((w = !1),
					  (k = h.renderer.rotCorr(D, r)),
					  (k = {
							x: e.x + c.x + e.width / 2 + k.x,
							y: e.y + c.y + { top: 0, middle: 0.5, bottom: 1 }[c.verticalAlign] * e.height
					  }),
					  C(k),
					  a[f ? 'attr' : 'animate'](k).attr({ align: n }),
					  (C = (r + 720) % 360),
					  (C = 180 < C && 360 > C),
					  'left' === n
							? (k.y -= C ? q.height : 0)
							: 'center' === n
							? ((k.x -= q.width / 2), (k.y -= q.height / 2))
							: 'right' === n && ((k.x -= q.width), (k.y -= C ? 0 : q.height)),
					  (a.placed = !0),
					  (a.alignAttr = k))
					: (C(e), a.align(c, null, e), (k = a.alignAttr));
				w && 0 <= e.height
					? this.justifyDataLabel(a, c, k, q, e, f)
					: B(c.crop, !0) && (A = h.isInsidePlot(k.x, k.y) && h.isInsidePlot(k.x + q.width, k.y + q.height));
				if (c.shape && !r)
					a[f ? 'attr' : 'animate']({
		...
		D.prototype.setDataLabelStartPos = function (b, a, c, e, f) {
			...
			a.startYPos = f;
			e
				? 'hidden' === a.visibility && (a.show(), a.attr({ opacity: 0 }).animate({ opacity: 1 }))
		...
		D.prototype.justifyDataLabel = function (b, a, c, e, f, l) {
			...
			m = c.x + e.width - k;
			m > d.plotWidth &&
				('left' === h ? ((a.align = 'right'), (a.inside = !0)) : (a.x = d.plotWidth - m), (q = !0));
			m = c.y + k;
			0 > m && ('bottom' === g ? ((a.verticalAlign = 'top'), (a.inside = !0)) : (a.y = -m), (q = !0));
			m = c.y + e.height - k;
			m > d.plotHeight &&
				('top' === g ? ((a.verticalAlign = 'bottom'), (a.inside = !0)) : (a.y = d.plotHeight - m), (q = !0));
			q && ((b.placed = !l), b.align(a, null, f));
			return q;
		};
		A.pie &&
			((A.pie.prototype.dataLabelPositioners = {
			...
			(A.pie.prototype.drawDataLabels = function () {
				...
				b.visible &&
					...
					D.prototype.drawDataLabels.apply(b),
					a.forEach(function (a) {
						a.dataLabel &&
							(a.visible
								? (G[a.half].push(a),
						...
						if (k) {
							...
							if (0 < b.maxLabelDistance) {
								...
								a.forEach(function (a) {
									0 < a.labelDistance &&
										a.dataLabel &&
										((a.top = Math.max(0, z - n - a.labelDistance)),
										(a.bottom = Math.min(z + n + a.labelDistance, e.plotHeight)),
							...
							for (S = 0; S < k; S++) {
								...
								B(f.crop, !0) &&
									...
									J - A < l && 1 === h
										...
										: J + A > p - l &&
										  0 === h &&
										  ((t = Math.round(J + A - p + l)), (U[1] = Math.max(t, U[1]))),
									0 > K - F / 2
										? (U[0] = Math.max(Math.round(-K + F / 2), U[0]))
										: K + F / 2 > g && (U[2] = Math.max(Math.round(K + F / 2 - g), U[2])),
									(w.sideOverflow = t));
							}
						}
					}),
			...
			(A.pie.prototype.placeDataLabels = function () {
				this.points.forEach(function (b) {
					...
					a &&
						...
						((c = a._pos)
							? (a.sideOverflow &&
									((a._attr.width = Math.max(a.getBBox().width - a.sideOverflow, 0)),
									a.css({
									...
									(a.shortened = !0)),
							  a.attr(a._attr),
							  a[a.moved ? 'animate' : 'attr'](c),
							  (a.moved = !0))
							: a && a.attr({ y: -9999 }));
					delete b.distributeBox;
				}, this);
			}),
			(A.pie.prototype.alignDataLabel = e),
			(A.pie.prototype.verifyDataLabelOverflow = function (b) {
				var a = this.center,
					c = this.options,
					e = c.center,
					f = c.minSize || 80,
				...
				if (!l) {
					...
					null !== e[1]
						...
						: ((m = G(m, f, a[2] - b[0] - b[2])), (a[1] += (b[0] - b[2]) / 2));
					m < a[2]
						? ((a[2] = m),
						  (a[3] = Math.min(u(c.innerSize || 0, m), m)),
						  this.translate(a),
		...
		A.column &&
			(A.column.prototype.alignDataLabel = function (b, a, c, e, f) {
				...
				e &&
					((0 >= e.height && e.y === this.chart.plotHeight) || (0 >= e.width && 0 === e.x)) &&
					(a.hide(!0), (a.placed = !1));
			...
			var A = function (a) {
				...
				if (a && (!a.alignAttr || a.placed)) {
					...
					a.width ||
						...
						(a.width = c.width),
						(a.height = c.height),
						(c = u.fontMetrics(null, a.element).h));
					return {
			...
			for (m = 0; m < q; m++) {
				...
				for (w = m + 1; w < q; ++w) {
					...
					!f ||
						...
						b.y > f.y + f.height ||
						b.y + b.height < f.y ||
						((A.labelrank < r.labelrank ? A : r).newOpacity = 0);
				}
			}
			c.forEach(function (a) {
				var b;
		...
		var k = (c.TrackerMixin = {
				...
				a._hasTracking ||
					(a.trackerGroups.forEach(function (e) {
						if (a[e]) {
							...
							!b.styledMode && a.options.cursor && a[e].css(u).css({ cursor: a.options.cursor });
						}
					}),
					(a._hasTracking = !0));
			...
			drawTrackerGraph: function () {
				var a = this,
					...
					w = 'rgba(192,192,192,' + (h ? 0.0001 : 0.002) + ')';
				if (e && !c)
					for (u = e + 1; u--; )
						'M' === d[u] && d.splice(u + 1, 0, d[u + 1] - n, d[u + 2], 'L'),
							((u && 'M' === d[u]) || u === e) && d.splice(u, 0, 'L', d[u - 2] + n, d[u - 1]);
				q
					? q.attr({ d: d })
					: a.graph &&
					  ((a.tracker = m
				...
				r(this, 'pan', { originalEvent: a }, function () {
					...
					b.forEach(function (b) {
						...
						if (!e.ordinal) {
							...
							if (
								(d.series.length && l !== m.min && n !== m.max && b) ||
								(d.panningState && l >= d.panningState.startMin && n <= d.panningState.startMax)
							)
								d.setExtremes(l, n, !1, !1, { trigger: 'pan' }), (f = !0);
							c[g] = h;
						}
					});
					f && c.redraw(!1);
					...
					b ||
						e.getSelectedPoints().forEach(function (a) {
							...
							a.selected &&
								...
								a.setState(e.hoverPoints && b.options.inactiveOtherPoints ? 'inactive' : ''),
			...
			setState: function (a, b) {
				...
				if (
					!(
						...
						!1 === e.enabled ||
						(a && (k || (h && !1 === l.enabled))) ||
						(a && v.states && v.states[a] && !1 === v.states[a].enabled)
					)
				) {
					this.state = a;
					...
					if (this.graphic) {
						...
						if (!y.styledMode) {
							...
							c.options.inactiveOtherPoints &&
								((this.dataLabels || []).forEach(function (a) {
									a && a.animate({ opacity: C.opacity }, D);
								}),
								this.connector && this.connector.animate({ opacity: C.opacity }, D));
						...
						if (a && l) {
							...
							if (A)
								if (u) u[b ? 'animate' : 'attr']({ x: A.x, y: A.y });
								else
									d &&
										((c.stateMarkerGraphic = u =
											y.renderer.symbol(d, A.x, A.y, A.width, A.height).add(c.markerGroup)),
										(u.currentSymbol = d));
					...
					a && a.size && u && 'hidden' !== e && !this.isCluster
						? (w || (c.halo = w = y.renderer.path().add(u.parentGroup)),
						  w.show()[b ? 'animate' : 'attr']({ d: this.haloPath(a.size) }),
						  w.attr({
								class:
									'highcharts-halo highcharts-color-' +
									q(this.colorIndex, c.colorIndex) +
						  ...
						  (w.point = this),
						  y.styledMode ||
								w.attr(I({ fill: this.color || c.color, 'fill-opacity': a.opacity }, a.attributes)))
		...
		I(a.prototype, {
			...
			setVisible: function (a, b) {
				var c = this,
					...
					h = c.visible;
				var k = (c.visible = a = c.options.visible = c.userOptions.visible = 'undefined' === typeof a ? !h : a)
					? 'show'
					: 'hide';
	...
	M(J, 'parts/Responsive.js', [J['parts/Globals.js'], J['parts/Utilities.js']], function (c, e) {
		...
		e.prototype.setResponsive = function (e, v) {
			...
			u = u.toString() || void 0;
			u !== (w && w.ruleIds) &&
				(w && this.update(w.undoOptions, e, !0),
				u
					? ((w = this.currentOptions(v)),
					  (w.isResponsiveOptions = !0),
					  (this.currentResponsive = { ruleIds: u, mergedOptions: v, undoOptions: w }),
					  this.update(v, e, !0))
		...
		e.prototype.matchResponsiveRule = function (c, e) {
			...
			(
				...
				function () {
					return (
						this.chartWidth <= H(q.maxWidth, Number.MAX_VALUE) &&
						this.chartHeight <= H(q.maxHeight, Number.MAX_VALUE) &&
						this.chartWidth >= H(q.minWidth, 0) &&
						this.chartHeight >= H(q.minHeight, 0)
					);
				}
			...
			function e(c, m, r, u) {
				...
				G(c, function (c, b) {
					if (!u && -1 < q.collectionsWithUpdate.indexOf(b))
						for (c = v(c), r[b] = [], w = 0; w < c.length; w++)
							m[b][w] && ((r[b][w] = {}), e(c[w], m[b][w], r[b][w], u + 1));
					else
						I(c)
							? ((r[b] = F(c) ? [] : {}), e(c, m[b] || {}, r[b], u + 1))
							: (r[b] = 'undefined' === typeof m[b] ? null : m[b]);
				});
			}
			var q = this,
				u = {};
