	...
	['cc1e'],
	{
		QJ7E: function (t, e, n) {
			...
			var S = 1e-6,
				...
				R = Math.tan;
			function k(t) {
				return t > 1 ? 0 : t < -1 ? M : Math.acos(t);
			}
			function B(t) {
			...
			var q = {
					...
					FeatureCollection: function (t, e) {
						for (var n = t.features, i = -1, r = n.length; ++i < r; ) Z(n[i].geometry, e);
					}
				},
				X = {
					Sphere: function (t, e) {
					...
					MultiLineString: function (t, e) {
						for (var n = t.coordinates, i = -1, r = n.length; ++i < r; ) Y(n[i], e, 0);
					},
					Polygon: function (t, e) {
						U(t.coordinates, e);
					},
					MultiPolygon: function (t, e) {
						for (var n = t.coordinates, i = -1, r = n.length; ++i < r; ) U(n[i], e);
					},
					GeometryCollection: function (t, e) {
						for (var n = t.geometries, i = -1, r = n.length; ++i < r; ) Z(n[i], e);
					}
				};
			function Y(t, e, n) {
				var i,
			...
			function U(t, e) {
				var n = -1,
					i = t.length;
				for (e.polygonStart(); ++n < i; ) Y(t[n], e, 1);
				e.polygonEnd();
			}
			var J,
				K,
				...
				tt,
				et = function (t, e) {
					t && q.hasOwnProperty(t.type) ? q[t.type](t, e) : Z(t, e);
				},
				nt = m(),
				it = m(),
				rt = {
					...
					polygonStart: function () {
						nt.reset(), (rt.lineStart = ot), (rt.lineEnd = at);
					},
					polygonEnd: function () {
						var t = +nt;
						it.add(t < 0 ? O + t : t), (this.lineStart = this.lineEnd = this.point = H);
					},
					sphere: function () {
						it.add(O);
					}
			...
			function ut(t, e) {
				(rt.point = st), (J = t), (K = e), (Q = t *= L), ($ = T((e = (e *= L) / 2 + j))), (tt = F(e));
			}
			function st(t, e) {
				e = (e *= L) / 2 + j;
				var n = (t *= L) - Q,
					...
					s = $ * o + u * T(r),
					c = u * i * F(r);
				nt.add(I(c, s)), (Q = t), ($ = o), (tt = a);
			}
			var ct = function (t) {
				return it.reset(), et(t, rt), 2 * it;
			};
			function lt(t) {
				return [I(t[1], t[0]), B(t[2])];
			}
			function ht(t) {
				var e = t[0],
					n = t[1],
					i = T(n);
				return [i * T(e), i * F(e), F(n)];
			}
			function pt(t, e) {
			...
			var mt,
				...
				Lt = {
					...
					lineEnd: Tt,
					polygonStart: function () {
						(Lt.point = Gt), (Lt.lineStart = Dt), (Lt.lineEnd = Nt), wt.reset(), rt.polygonStart();
					},
					polygonEnd: function () {
						rt.polygonEnd(),
							(Lt.point = Ct),
			...
			function Ct(t, e) {
				jt.push((Ot = [(mt = t), (bt = t)])), e < yt && (yt = e), e > Pt && (Pt = e);
			}
			function Et(t, e) {
				var n = ht([t * L, e * L]);
				if (xt) {
					...
					c ^ (u * St < s && s < u * t)
						? (o = r[1] * w) > Pt && (Pt = o)
						: c ^ (u * St < (s = ((s + 360) % 360) - 180) && s < u * t)
						? (o = -r[1] * w) < yt && (yt = o)
						: (e < yt && (yt = e), e > Pt && (Pt = e)),
						c
							? t < St
								? zt(mt, t) > zt(mt, bt) && (bt = t)
								: zt(t, bt) > zt(mt, bt) && (mt = t)
							: bt >= mt
							? (t < mt && (mt = t), t > bt && (bt = t))
							: t > St
							? zt(mt, t) > zt(mt, bt) && (bt = t)
							: zt(t, bt) > zt(mt, bt) && (mt = t);
				} else jt.push((Ot = [(mt = t), (bt = t)]));
				e < yt && (yt = e), e > Pt && (Pt = e), (xt = n), (St = t);
			}
			function It() {
				Lt.point = Et;
			}
			function Tt() {
				(Ot[0] = mt), (Ot[1] = bt), (Lt.point = Ct), (xt = null);
			}
			function Gt(t, e) {
				if (xt) {
					var n = t - St;
					wt.add(C(n) > 180 ? n + (n > 0 ? 360 : -360) : n);
				} else (_t = t), (Mt = e);
				rt.point(t, e), Et(t, e);
			}
			function Dt() {
			...
			function Nt() {
				Gt(_t, Mt), rt.lineEnd(), C(wt) > S && (mt = -(bt = 180)), (Ot[0] = mt), (Ot[1] = bt), (xt = null);
			}
			function zt(t, e) {
			...
			var At,
				...
				ee = function (t) {
					var e, n, i, r, o, a, u;
					if (((Pt = bt = -(mt = yt = 1 / 0)), (jt = []), et(t, Lt), (n = jt.length))) {
						for (jt.sort(Ft), e = 1, o = [(i = jt[0])]; e < n; ++e)
							Vt(i, (r = jt[e])[0]) || Vt(i, r[1])
								? (zt(i[0], r[1]) > zt(i[0], i[1]) && (i[1] = r[1]),
								  zt(r[0], i[1]) > zt(i[0], i[1]) && (i[0] = r[0]))
								: o.push((i = r));
						for (a = -1 / 0, e = 0, i = o[(n = o.length - 1)]; e <= n; i = r, ++e)
							(r = o[e]), (u = zt(i[1], r[0])) > a && ((a = u), (mt = r[0]), (bt = i[1]));
					}
					return (
						(jt = Ot = null),
						mt === 1 / 0 || yt === 1 / 0
				...
				ne = {
					...
					lineEnd: se,
					polygonStart: function () {
						(ne.lineStart = ce), (ne.lineEnd = le);
					},
					polygonEnd: function () {
						(ne.lineStart = oe), (ne.lineEnd = se);
					}
				};
			function ie(t, e) {
				t *= L;
			...
			function re(t, e, n) {
				(kt += (t - kt) / ++At), (Bt += (e - Bt) / At), (Wt += (n - Wt) / At);
			}
			function oe() {
				ne.point = ae;
			}
			function ae(t, e) {
				t *= L;
				var n = T((e *= L));
				(Qt = n * T(t)), ($t = n * F(t)), (te = F(e)), (ne.point = ue), re(Qt, $t, te);
			}
			function ue(t, e) {
				t *= L;
				var n = T((e *= L)),
					...
					o = F(e),
					a = I(
						A((a = $t * o - te * r) * a + (a = te * i - Qt * o) * a + (a = Qt * r - $t * i) * a),
						Qt * i + $t * r + te * o
					);
				(Rt += a),
					(Ht += a * (Qt + (Qt = i))),
			...
			function le() {
				pe(Jt, Kt), (ne.point = ie);
			}
			function he(t, e) {
				(Jt = t), (Kt = e), (t *= L), (e *= L), (ne.point = pe);
				var n = T(e);
				(Qt = n * T(t)), ($t = n * F(t)), (te = F(e)), re(Qt, $t, te);
			}
			function pe(t, e) {
				t *= L;
				var n = T((e *= L)),
			...
			var fe = function (t) {
					(At = Rt = kt = Bt = Wt = Ht = Zt = qt = Xt = Yt = Ut = 0), et(t, ne);
					var e = Xt,
						n = Yt,
						i = Ut,
						r = e * e + n * n + i * i;
			...
			function ve(t, e) {
				return [C(t) > M ? t + Math.round(-t / O) * O : t, e];
			}
			function me(t, e, n) {
				return (t %= O) ? (e || n ? ge(be(t), Pe(e, n)) : be(t)) : e || n ? Pe(e, n) : ve;
			}
			function ye(t) {
				return function (e, n) {
					return [(e += t) > M ? e - O : e < -M ? e + O : e, n];
				};
			}
			function be(t) {
				var e = ye(t);
				return (e.invert = ye(-t)), e;
			}
			function Pe(t, e) {
				var n = T(t),
					i = F(t),
				...
				function a(t, e) {
					var a = T(e),
						...
						c = F(e),
						l = c * n + u * i;
					return [I(s * r - l * o, u * n - c * i), B(l * r + s * o)];
				}
				return (
					(a.invert = function (t, e) {
						var a = T(e),
							...
							c = F(e),
							l = c * r - s * o;
						return [I(s * r + c * o, u * n + l * i), B(l * n - u * i)];
					}),
					a
				);
			}
			...
			var Se = function (t) {
				function e(e) {
					return ((e = t(e[0] * L, e[1] * L))[0] *= w), (e[1] *= w), e;
				}
				return (
					(t = me(t[0] * L, t[1] * L, t.length > 2 ? t[2] * L : 0)),
					(e.invert = function (e) {
						return ((e = t.invert(e[0] * L, e[1] * L))[0] *= w), (e[1] *= w), e;
					}),
					e
				);
			};
			function _e(t, e, n, i, r, o) {
				if (n) {
					...
					null == r
						? ((r = e + i * O), (o = e - s / 2))
						: ((r = Me(a, r)), (o = Me(a, o)), (i > 0 ? r < o : r > o) && (r += i * O));
					for (var c, l = r; i > 0 ? l > o : l < o; l -= s)
						(c = lt([a, -u * T(l), -u * F(l)])), t.point(c[0], c[1]);
				}
			}
			function Me(t, e) {
				((e = ht(e))[0] -= t), vt(e);
				var n = k(-e[1]);
				return ((-e[2] < 0 ? -n : n) + O - S) % O;
			}
			var xe = function () {
					var t,
						e,
					...
					return (
						(a.center = function (t) {
							return arguments.length ? ((n = 'function' == typeof t ? t : de([+t[0], +t[1]])), a) : n;
						}),
						(a.radius = function (t) {
							return arguments.length ? ((i = 'function' == typeof t ? t : de(+t)), a) : i;
						}),
						(a.precision = function (t) {
							return arguments.length ? ((r = 'function' == typeof t ? t : de(+t)), a) : r;
						}),
						a
					);
				},
			...
			var Le = function (t, e, n, i, r) {
				...
				if (
					(t.forEach(function (t) {
						if (!((e = t.length - 1) <= 0)) {
							...
							if (Oe(i, a)) {
								...
								u.push((n = new we(i, t, null, !0))),
									s.push((n.o = new we(i, null, n, !1))),
									u.push((n = new we(a, t, null, !1))),
									s.push((n.o = new we(a, null, n, !0)));
						}
					}),
					u.length)
				) {
					...
					for (var c, l, h = u[0]; ; ) {
						...
						do {
							if (((p.v = p.o.v = !0), p.e)) {
								if (f) for (o = 0, a = c.length; o < a; ++o) r.point((l = c[o])[0], l[1]);
								else i(p.x, p.n.x, 1, r);
								p = p.n;
							} else {
								if (f) for (c = p.p.z, o = c.length - 1; o >= 0; --o) r.point((l = c[o])[0], l[1]);
			...
			var Ee = m();
			function Ie(t) {
				return C(t[0]) <= M ? t[0] : V(t[0]) * (((C(t[0]) + M) % O) - M);
			}
			var Te = function (t, e) {
					var n = Ie(e),
						i = e[1],
						...
						a = 0,
						u = 0;
					Ee.reset(), 1 === r ? (i = x + S) : -1 === r && (i = -x - S);
					for (var s = 0, c = t.length; s < c; ++s)
						if ((h = (l = t[s]).length))
							for (
								var l, h, p = l[h - 1], f = Ie(p), d = p[1] / 2 + j, g = F(d), v = T(d), m = 0;
								m < h;
								++m, f = b, g = _, v = w, p = y
							) {
								var y = l[m],
								...
								if (
									...
									var z = ft(o, N);
									vt(z);
									var V = (G ^ (L >= 0) ? -1 : 1) * B(z[2]);
									(i > V || (i === V && (N[0] || N[1]))) && (u += G ^ (L >= 0) ? 1 : -1);
								}
							}
				...
				return function (r) {
					var o,
						...
						p = {
							...
							polygonEnd: function () {
								(p.point = f), (p.lineStart = g), (p.lineEnd = v), (a = Fe(a));
								var t = Te(o, i);
								a.length
									? (h || (r.polygonStart(), (h = !0)), Le(a, Re, t, n, r))
									: t &&
						...
						if ((u.pop(), o.push(u), (u = null), f))
							if (1 & s) {
								if ((e = (n = p[0]).length - 1) > 0) {
									for (h || (r.polygonStart(), (h = !0)), r.lineStart(), t = 0; t < e; ++t)
										r.point((i = n[t])[0], i[1]);
									r.lineEnd();
								}
			...
			function Re(t, e) {
				return ((t = t.x)[0] < 0 ? t[1] - x - S : x - t[1]) - ((e = e.x)[0] < 0 ? e[1] - x - S : x - e[1]);
			}
			var ke = Ve(
				function () {
					return !0;
								...
								: r !== u &&
								  ...
								  (i = (function (t, e, n, i) {
										var r,
											...
											a = F(t - n);
										return C(a) > S
											? E((F(e) * (o = T(i)) * F(n) - F(i) * (r = T(e)) * F(t)) / (r * o * a))
											: (e + i) / 2;
								  })(n, i, o, a)),
								  t.point(r, i),
								  t.lineEnd(),
					...
					function a(t, n, i) {
						...
						if (!(v < 0)) {
							...
							if (
								...
								w || O < S
									? w
										? (x + j > 0) ^ (y[1] < (C(y[0] - P) < S ? x : j))
										: x <= y[1] && y[1] <= j
									: (O > M) ^ (P <= y[0] && y[0] <= _))
							) {
								var L = gt(f, (-d + m) / g);
								return dt(L, p), [y, lt(L)];
							}
						}
					}
					function u(e, n) {
							...
							return {
								...
								point: function (h, p) {
									var f,
										d = [h, p],
										g = o(h, p),
										v = i ? (g ? 0 : u(h, p)) : g ? u(h + (h < 0 ? M : -M), p) : 0;
									if (
										(!e && (c = s = g) && t.lineStart(),
										g !== s &&
											(!(f = a(e, d)) || Oe(e, f) || Oe(d, f)) &&
											((d[0] += S), (d[1] += S), (g = o(d[0], d[1]))),
										g !== s)
									)
										(l = 0),
											g
												? (t.lineStart(), (f = a(d, e)), t.point(f[0], f[1]))
												: ((f = a(e, d)), t.point(f[0], f[1]), t.lineEnd()),
											(e = f);
									else if (r && e && i ^ g) {
										var m;
										v & n ||
									...
									!g || (e && Oe(e, d)) || t.point(d[0], d[1]), (e = d), (s = g), (n = v);
								},
								lineEnd: function () {
									s && t.lineEnd(), (e = null);
								},
						...
						if (((a = r - u), h || !(a < 0))) {
							...
							if (((a = i - s), p || !(a > 0))) {
								...
								if (((a = o - s), p || !(a < 0))) {
									...
									return (
										c > 0 && ((t[0] = u + c * h), (t[1] = s + c * p)),
										l < 1 && ((e[0] = u + l * h), (e[1] = s + l * p)),
										!0
									);
								}
							}
			...
			function qe(t, e, n, i) {
				...
				return function (a) {
							...
							polygonEnd: function () {
								var e = (function () {
										for (var e = 0, n = 0, r = c.length; n < r; ++n)
											for (
												var o, a, u = c[n], s = 1, l = u.length, h = u[0], p = h[0], f = h[1];
												s < l;
												++s
											)
												(o = p),
					...
					function M(o, a) {
						var u = r(o, a);
						if ((c && l.push([o, a]), m))
							(h = o), (p = a), (f = u), (m = !1), u && (b.lineStart(), b.point(o, a));
						else if (u && v) b.point(o, a);
						else {
							var s = [(d = Math.max(Ze, Math.min(He, d))), (g = Math.max(Ze, Math.min(He, g)))],
								P = [(o = Math.max(Ze, Math.min(He, o))), (a = Math.max(Ze, Math.min(He, a)))];
							We(s, P, t, e, n, i)
								? (v || (b.lineStart(), b.point(s[0], s[1])),
								  b.point(P[0], P[1]),
								  u || b.lineEnd(),
								  (y = !1))
								: u && (b.lineStart(), b.point(o, a), (y = !1));
						}
						(d = o), (g = a), (v = u);
					}
					return S;
			...
			var Xe,
				...
				Je = function () {
					...
					return (n = {
						stream: function (n) {
							return t && e === n ? t : (t = qe(i, r, o, a)((e = n)));
						},
						extent: function (u) {
							return arguments.length
								? ((i = +u[0][0]), (r = +u[0][1]), (o = +u[1][0]), (a = +u[1][1]), (t = e = null), n)
								: [
										[i, r],
										[o, a]
								  ];
			...
			function $e() {
				Qe.point = Qe.lineEnd = H;
			}
			function tn(t, e) {
				(Xe = t *= L), (Ye = F((e *= L))), (Ue = T(e)), (Qe.point = en);
			}
			function en(t, e) {
				t *= L;
				var n = F((e *= L)),
					...
					u = Ue * n - Ye * i * o,
					s = Ye * n + Ue * i * o;
				Ke.add(I(A(a * a + u * u), s)), (Xe = t), (Ye = n), (Ue = i);
			}
			var nn = function (t) {
					return Ke.reset(), et(t, Qe), +Ke;
				},
				rn = [null, null],
				on = { type: 'LineString', coordinates: rn },
				an = function (t, e) {
					return (rn[0] = t), (rn[1] = e), nn(on);
				},
				un = {
					Feature: function (t, e) {
						return cn(t.geometry, e);
					},
					FeatureCollection: function (t, e) {
						for (var n = t.features, i = -1, r = n.length; ++i < r; ) if (cn(n[i].geometry, e)) return !0;
						return !1;
					}
				},
				sn = {
					...
					MultiPoint: function (t, e) {
						for (var n = t.coordinates, i = -1, r = n.length; ++i < r; ) if (ln(n[i], e)) return !0;
						return !1;
					},
					LineString: function (t, e) {
						return hn(t.coordinates, e);
					},
					MultiLineString: function (t, e) {
						for (var n = t.coordinates, i = -1, r = n.length; ++i < r; ) if (hn(n[i], e)) return !0;
						return !1;
					},
					Polygon: function (t, e) {
						return pn(t.coordinates, e);
					},
					MultiPolygon: function (t, e) {
						for (var n = t.coordinates, i = -1, r = n.length; ++i < r; ) if (pn(n[i], e)) return !0;
						return !1;
					},
					GeometryCollection: function (t, e) {
						for (var n = t.geometries, i = -1, r = n.length; ++i < r; ) if (cn(n[i], e)) return !0;
						return !1;
					}
				};
			function cn(t, e) {
				return !(!t || !sn.hasOwnProperty(t.type)) && sn[t.type](t, e);
			}
			function ln(t, e) {
				return 0 === an(t, e);
			}
			function hn(t, e) {
				for (var n, i, r, o = 0, a = t.length; o < a; o++) {
					if (0 === (i = an(t[o], e))) return !0;
					if (
						o > 0 &&
						(r = an(t[o], t[o - 1])) > 0 &&
						n <= r &&
						i <= r &&
						(n + i - r) * (1 - Math.pow((n - i) / r, 2)) < _ * r
					)
						return !0;
					n = i;
				}
			...
			function pn(t, e) {
				return !!Te(t.map(fn), dn(e));
			}
			function fn(t) {
				return (t = t.map(dn)).pop(), t;
			}
			function dn(t) {
				return [t[0] * L, t[1] * L];
			}
			var gn = function (t, e) {
				return (t && un.hasOwnProperty(t.type) ? un[t.type] : cn)(t, e);
			};
			function vn(t, e, n) {
				var i = ze(t, e - S, n).concat(e);
				return function (t) {
			...
			function yn() {
				...
				function y() {
					return ze(G(i / d) * d, n, d)
						.map(l)
						.concat(ze(G(u / g) * g, a, g).map(h))
						.concat(
							ze(G(e / p) * p, t, p)
								.filter(function (t) {
									return C(t % d) > S;
			...
			var Pn,
						...
						v = d
							? function (t) {
									var e = F((t *= d)) / g,
										...
										r = n * h + e * f,
										o = n * u + e * c;
									return [I(r, i) * w, I(o, A(i * i + r * r)) * w];
							  }
							: function () {
									return [n * w, i * w];
							  };
				...
				Ln = {
					...
					lineEnd: H,
					polygonStart: function () {
						(Ln.lineStart = Cn), (Ln.lineEnd = Tn);
					},
					polygonEnd: function () {
						(Ln.lineStart = Ln.lineEnd = Ln.point = H), On.add(C(wn)), wn.reset();
					},
					result: function () {
						var t = On / 2;
						return On.reset(), t;
			...
			function En(t, e) {
				(Ln.point = In), (Pn = _n = t), (Sn = Mn = e);
			}
			function In(t, e) {
				wn.add(Mn * t - _n * e), (_n = t), (Mn = e);
			}
			function Tn() {
				In(Pn, Sn);
			}
			...
			var Vn,
				...
				Qn = {
					...
					lineEnd: ii,
					polygonStart: function () {
						(Qn.lineStart = ri), (Qn.lineEnd = oi);
					},
					polygonEnd: function () {
						(Qn.point = $n), (Qn.lineStart = ti), (Qn.lineEnd = ii);
					},
					result: function () {
						var t = Kn
							? [Un / Kn, Jn / Kn]
							...
							? [Wn / Zn, Hn / Zn]
							: [NaN, NaN];
						return (Wn = Hn = Zn = qn = Xn = Yn = Un = Jn = Kn = 0), t;
					}
				};
			function $n(t, e) {
				(Wn += t), (Hn += e), ++Zn;
			...
			function ei(t, e) {
				(Qn.point = ni), $n((Rn = t), (kn = e));
			}
			function ni(t, e) {
				var n = t - Rn,
					i = e - kn,
					r = A(n * n + i * i);
				(qn += (r * (Rn + t)) / 2), (Xn += (r * (kn + e)) / 2), (Yn += r), $n((Rn = t), (kn = e));
			}
			function ii() {
				Qn.point = $n;
			}
				...
				point: function (t, e) {
					switch (this._point) {
						...
						case 1:
							...
							break;
						default:
							this._context.moveTo(t + this._radius, e), this._context.arc(t, e, this._radius, 0, O);
					}
				},
				result: H
			};
			...
			function mi(t, e) {
				(vi.point = yi), (hi = fi = t), (pi = di = e);
			}
			function yi(t, e) {
				(fi -= t), (di -= e), gi.add(A(fi * fi + di * di)), (fi = t), (di = e);
			}
			var bi = vi;
			function Pi() {
				this._string = [];
			...
			function Si(t) {
				return (
					'm0,' + t + 'a' + t + ',' + t + ' 0 1,1 0,' + -2 * t + 'a' + t + ',' + t + ' 0 1,1 0,' + 2 * t + 'z'
				);
			}
			Pi.prototype = {
				_radius: 4.5,
				...
				point: function (t, e) {
					switch (this._point) {
						...
						case 1:
							...
							break;
						default:
							null == this._circle && (this._circle = Si(this._radius)),
			...
			var _i = function (t, e) {
					...
					function o(t) {
						return (
							t && ('function' == typeof r && i.pointRadius(+r.apply(this, arguments)), et(t, n(i))),
							i.result()
						);
					}
					return (
						(o.area = function (t) {
							return et(t, n(Gn)), Gn.result();
						}),
						(o.measure = function (t) {
							return et(t, n(bi)), bi.result();
						}),
						(o.bounds = function (t) {
							return et(t, n(Bn)), Bn.result();
						}),
						(o.centroid = function (t) {
							return et(t, n(si)), si.result();
						}),
						(o.projection = function (e) {
							return arguments.length ? ((n = null == e ? ((t = null), jn) : (t = e).stream), o) : t;
						}),
						(o.context = function (t) {
							return arguments.length
								? ((i = null == t ? ((e = null), new Pi()) : new ci((e = t))),
						...
						(o.pointRadius = function (t) {
							return arguments.length
								? ((r = 'function' == typeof t ? t : (i.pointRadius(+t), +t)), o)
								: r;
						}),
								...
								function n(i, r, o, a, u, s, c, l, h, p, f, d, g, v) {
									...
									if (b > 4 * e && g--) {
										var P = a + p,
											...
											x = A(P * P + _ * _ + M * M),
											j = B((M /= x)),
											O = C(C(M) - 1) < S || C(o - h) < S ? (o + h) / 2 : I(_, P),
											w = t(O, j),
											L = w[0],
											E = w[1],
											T = L - i,
										...
										((D * D) / b > e ||
											C((m * T + y * G) / b - 0.5) > 0.3 ||
											a * p + u * f + s * d < Ti) &&
											(n(i, r, o, a, u, s, L, E, O, (P /= x), (_ /= x), M, g, v),
											v.point(L, E),
											n(L, E, O, P, _, M, c, l, h, p, f, d, g, v));
									}
								}
								return function (e) {
									var i,
									...
									function _() {
										n(l, h, c, p, f, d, r, o, i, a, u, s, Ii, e), (g.lineEnd = b), b();
									}
									return g;
								};
						  })(t, e)
			...
			function Fi(t) {
				...
				function O(t) {
					return (t = s.invert(t[0], t[1])) && [t[0] * w, t[1] * w];
				}
				function C() {
					var t = Ni(h, 0, 0, b).apply(null, e(d, g)),
						i = (
							b
								? Ni
								: function (t, e, n) {
					...
					return (n = me(v, m, y)), (u = ge(e, i)), (s = ge(n, u)), (a = Gi(u, x)), E();
				}
				function E() {
					return (c = l = null), j;
				}
				return (
					...
					(j.preclip = function (t) {
						return arguments.length ? ((S = t), (P = void 0), E()) : S;
					}),
					(j.postclip = function (t) {
						return arguments.length ? ((M = t), (_ = i = r = o = null), E()) : M;
					}),
					(j.clipAngle = function (t) {
						return arguments.length ? ((S = +t ? Be((P = t * L)) : ((P = null), ke)), E()) : P * w;
					}),
					(j.clipExtent = function (t) {
						return arguments.length
							? ((M =
									null == t
										? ((_ = i = r = o = null), jn)
										: qe((_ = +t[0][0]), (i = +t[0][1]), (r = +t[1][0]), (o = +t[1][1]))),
							  E())
							: null == _
							? null
							: [
					...
					(j.rotate = function (t) {
						return arguments.length
							? ((v = (t[0] % 360) * L),
							  (m = (t[1] % 360) * L),
							  (y = t.length > 2 ? (t[2] % 360) * L : 0),
							  C())
							: [v * w, m * w, y * w];
					}),
					(j.angle = function (t) {
						return arguments.length ? ((b = (t % 360) * L), C()) : b * w;
					}),
					(j.precision = function (t) {
						return arguments.length ? ((a = Gi(u, (x = t * t))), E()) : A(x);
					}),
					...
					function () {
						return (e = t.apply(this, arguments)), (j.invert = e.invert && O), C();
					}
				);
			}
			function Vi(t) {
				...
				return (
					(r.parallels = function (t) {
						return arguments.length ? i((e = t[0] * L), (n = t[1] * L)) : [e * w, n * w];
					}),
					r
				);
			}
			function Ai(t, e) {
				...
				function a(t, e) {
					var n = A(r - 2 * i * F(e)) / i;
					return [n * F((t *= i)), o - n * T(t)];
				}
				return (
					(a.invert = function (t, e) {
						var n = o - e;
						return [(I(t, C(n)) / i) * V(n), B((r - (t * t + n * n) * i * i) / (2 * i))];
					}),
					a
				);
			}
			var Ri = function () {
					return Vi(Ai).scale(155.424).center([0, 33.6442]);
				},
				ki = function () {
					return Ri()
						.parallels([29.5, 45.5])
			...
			var Bi = function () {
				var t,
					...
					o,
					a = ki(),
					u = Ri().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
					s = Ri().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
					c = {
						point: function (t, e) {
							o = [t, e];
						}
				...
				return (
					(l.invert = function (t) {
						var e = a.scale(),
							...
							r = (t[1] - n[1]) / e;
						return (
							r >= 0.12 && r < 0.234 && i >= -0.425 && i < -0.214
								? u
								: r >= 0.166 && r < 0.234 && i >= -0.214 && i < -0.115
								? s
								: a
						).invert(t);
					}),
					...
					(l.scale = function (t) {
						return arguments.length
							? (a.scale(t), u.scale(0.35 * t), s.scale(t), l.translate(a.translate()))
							: a.scale();
					}),
					(l.translate = function (t) {
						...
						return (
							(n = a
								...
								.stream(c)),
							(i = u
								.translate([o - 0.307 * e, l + 0.201 * e])
								.clipExtent([
									[o - 0.425 * e + S, l + 0.12 * e + S],
									[o - 0.214 * e - S, l + 0.234 * e - S]
								])
								.stream(c)),
							(r = s
								.translate([o - 0.205 * e, l + 0.212 * e])
								.clipExtent([
									[o - 0.214 * e + S, l + 0.166 * e + S],
									[o - 0.115 * e - S, l + 0.234 * e - S]
								])
								.stream(c)),
							h()
						);
			...
			var qi = function () {
					return zi(Zi).scale(124.75).clipAngle(179.999);
				},
				Xi = Wi(function (t) {
					return (t = k(t)) && t / F(t);
				});
			...
			var Yi = function () {
				return zi(Xi).scale(79.4188).clipAngle(179.999);
			};
			function Ui(t, e) {
				return [t, N(R((x + e) / 2))];
			}
				...
				return (
					...
					(r.clipExtent = function (t) {
						return arguments.length
							? (null == t
									? (c = e = n = i = null)
									: ((c = +t[0][0]), (e = +t[0][1]), (n = +t[1][0]), (i = +t[1][1])),
							  l())
							: null == c
							? null
							: [
			...
			function $i(t, e) {
				var n = T(t),
					i = t === e ? F(t) : N(n / T(e)) / N(Qi(e) / Qi(t)),
					r = (n * z(Qi(t), i)) / i;
				if (!i) return Ui;
				function o(t, e) {
					r > 0 ? e < -x + S && (e = -x + S) : e > x - S && (e = x - S);
					var n = r / z(Qi(e), i);
					return [n * F(i * t), r - n * T(i * t)];
				}
				return (
					(o.invert = function (t, e) {
						var n = r - e,
							o = V(i) * A(t * t + n * n);
						return [(I(t, C(n)) / i) * V(n), 2 * E(z(r / o, 1 / i)) - x];
					}),
					o
				);
			}
			...
			function ir(t, e) {
				...
				function o(t, e) {
					var n = r - e,
						o = i * t;
					return [n * F(o), r - n * T(o)];
				}
				return (
					(o.invert = function (t, e) {
						var n = r - e;
						return [(I(t, C(n)) / i) * V(n), r - V(i) * A(t * t + n * n)];
					}),
					o
				);
			}
			var rr = function () {
					return Vi(ir).scale(131.154).center([0, 13.9389]);
				},
				or = 1.340264,
				ar = -0.081106,
				ur = 893e-6,
			...
			function lr(t, e) {
				var n = B(cr * F(e)),
					...
					r = i * i * i;
				return [
					(t * T(n)) / (cr * (or + 3 * ar * i + r * (7 * ur + 9 * sr * i))),
					n * (or + ar * i + r * (ur + sr * i))
				];
			}
			lr.invert = function (t, e) {
				for (
					var n, i = e, r = i * i, o = r * r * r, a = 0;
					a < 12 &&
					((o =
						(r =
							(i -= n =
								(i * (or + ar * r + o * (ur + sr * r)) - e) /
								(or + 3 * ar * r + o * (7 * ur + 9 * sr * r))) * i) *
						r *
						r),
					!(C(n) < _));
					++a
				);
				return [(cr * t * (or + 3 * ar * r + o * (7 * ur + 9 * sr * r))) / T(i), B(F(i) / cr)];
			};
			var hr = function () {
				return zi(lr).scale(177.158);
			};
			function pr(t, e) {
				var n = T(e),
					i = T(t) * n;
				return [(n * F(t)) / i, F(e) / i];
			}
			pr.invert = Hi(E);
			var fr = function () {
				return zi(pr).scale(144.049).clipAngle(60);
			};
			function dr(t, e, n, i) {
				return 1 === t && 1 === e && 0 === n && 0 === i
					? jn
					: xi({
							point: function (r, o) {
			...
			var gr = function () {
				...
				return (o = {
					...
					clipExtent: function (i) {
						return arguments.length
							? ((f =
									null == i
										? ((p = t = e = n = null), jn)
										: qe((p = +i[0][0]), (t = +i[0][1]), (e = +i[1][0]), (n = +i[1][1]))),
							  d())
							: null == p
							? null
							: [
					...
					scale: function (t) {
						return arguments.length ? ((h = dr((a = +t) * c, a * l, u, s)), d()) : a;
					},
					translate: function (t) {
						return arguments.length ? ((h = dr(a * c, a * l, (u = +t[0]), (s = +t[1]))), d()) : [u, s];
					},
					reflectX: function (t) {
						return arguments.length ? ((h = dr(a * (c = t ? -1 : 1), a * l, u, s)), d()) : c < 0;
					},
					reflectY: function (t) {
						return arguments.length ? ((h = dr(a * c, a * (l = t ? -1 : 1), u, s)), d()) : l < 0;
					},
			...
			function vr(t, e) {
				var n = e * e,
					i = n * n;
				return [
					t * (0.8707 - 0.131979 * n + i * (i * (0.003971 * n - 0.001529 * i) - 0.013791)),
					e * (1.007226 + n * (0.015085 + i * (0.028874 * n - 0.044475 - 0.005916 * i)))
				];
			}
			vr.invert = function (t, e) {
				var n,
					i = e,
					r = 25;
				do {
					var o = i * i,
						a = o * o;
					i -= n =
						(i * (1.007226 + o * (0.015085 + a * (0.028874 * o - 0.044475 - 0.005916 * a))) - e) /
						(1.007226 + o * (0.045255 + a * (0.259866 * o - 0.311325 - 0.005916 * 11 * a)));
				} while (C(n) > S && --r > 0);
				return [
					t / (0.8707 + (o = i * i) * (o * (o * o * o * (0.003971 - 0.001529 * o) - 0.013791) - 0.131979)),
					i
				];
			};
			var mr = function () {
				return zi(vr).scale(175.295);
			};
			function yr(t, e) {
				return [T(e) * F(t), F(e)];
			}
			...
			Pr.invert = Hi(function (t) {
				return 2 * E(t);
			});
			var Sr = function () {
				return zi(Pr).scale(250).clipAngle(142);
			};
			function _r(t, e) {
				return [N(R((x + e) / 2)), -t];
			}
			_r.invert = function (t, e) {
				return [-e, 2 * E(D(t)) - x];
			};
			var Mr = function () {
					var t = Ki(_r),
						...
						(e.prototype.updateExtremes = function () {
							...
							if (t) {
								var e = ee(t),
									...
									o = e[1][0],
									a = !1;
								r != this.north && ((this._north = v.round(r, 6)), (a = !0)),
									i != this.south && ((this._south = v.round(i, 6)), (a = !0)),
									o != this.east && ((this._east = v.round(o, 6)), (a = !0)),
									n != this.west && ((this._west = v.round(n, 6)), (a = !0)),
									this._east < this._west && ((this._east = 180), (this._west = -180)),
									a && this.component.invalidateDataItems();
							}
						}),
				...
				jr = (function (t) {
					function e() {
						var e = t.call(this) || this;
						return (
							(e.className = 'MapSeries'),
							(e.isMeasured = !1),
							(e.nonScalingStroke = !0),
							(e.dataFields.value = 'value'),
							(e.ignoreBounds = !1),
							e.tooltip && (e.tooltip.showInViewport = !0),
							e.applyTheme(),
							e
						);
					}
					return (
							...
							set: function (t) {
								if (t != this._geodata) {
									...
									for (var e = this.data.length - 1; e >= 0; e--)
										1 == this.data[e].madeFromGeoData && this.data.splice(e, 1);
						...
						Object.defineProperty(e.prototype, 'geodataSource', {
							get: function () {
								return (
									this._dataSources.geodata || this.getDataSource('geodata'),
						...
						(e.prototype.updateExtremes = function () {
							...
							this.dataItems.each(function (r) {
								(r.north > t || !g.isNumber(t)) && (t = r.north),
									(r.south < e || !g.isNumber(e)) && (e = r.south),
									(r.west < i || !g.isNumber(i)) && (i = r.west),
									(r.east > n || !g.isNumber(n)) && (n = r.east);
							}),
								this._mapObjects &&
									this._mapObjects.each(function (r) {
										(r.north > t || !g.isNumber(t)) && (t = r.north),
											(r.south < e || !g.isNumber(e)) && (e = r.south),
											(r.west < i || !g.isNumber(i)) && (i = r.west),
											(r.east > n || !g.isNumber(n)) && (n = r.east);
									}),
								(this.north == t && this.east == n && this.south == e && this.west == i) ||
									((this._north = t),
									(this._east = n),
									(this._west = i),
									(this._south = e),
									this.dispatch('geoBoundsChanged'),
									this.ignoreBounds || this.chart.updateExtremes());
						}),
						Object.defineProperty(e.prototype, 'north', {
							get: function () {
						...
						(e.prototype.processConfig = function (e) {
							if (g.hasValue(e.geodata) && g.isString(e.geodata)) {
								var n = e.geodata;
								if (g.hasValue(window['am4geodata_' + e.geodata]))
									e.geodata = window['am4geodata_' + e.geodata];
								else
									try {
										e.geodata = JSON.parse(e.geodata);
									} catch (t) {
										throw Error(
											'MapChart error: Geodata `' + n + '` is not loaded or is incorrect.'
										);
									}
							}
			...
			(d.c.registeredClasses.MapSeries = jr), (d.c.registeredClasses.MapSeriesDataItem = xr);
			var Or = n('C6dT'),
				wr = (function (t) {
					function e() {
						var e = t.call(this) || this;
						return (
							(e.className = 'MapObject'),
							(e.isMeasured = !1),
							(e.layout = 'none'),
							(e.clickable = !0),
							e.applyTheme(),
							...
							if (t) {
								...
								if (e) {
									var n = ee(e),
										...
										a = n[1][0],
										u = !1;
									o != this.north && ((this._north = v.round(o, 8)), (u = !0)),
										r != this.south && ((this._south = v.round(r)), (u = !0)),
										a != this.east && ((this._east = v.round(a)), (u = !0)),
										i != this.west && ((this._west = v.round(i)), (u = !0)),
										u &&
											(this.dispatch('geoBoundsChanged'),
						...
						(e.prototype.showTooltip = function (e) {
							...
							return (
								n &&
									...
									!this.series.chart.events.has('mappositionchanged', this.handleTooltipMove, this) &&
			...
			d.c.registeredClasses.MapObject = wr;
			var Lr = (function (t) {
				function e() {
					var e = t.call(this) || this;
				...
				return (
					...
					(e.prototype.validatePosition = function () {
						if (g.isNumber(this.latitude) && g.isNumber(this.longitude)) {
							...
							(this.__disabled = !n), this.moveTo({ x: e[0], y: e[1] });
						}
			...
			d.c.registeredClasses.MapImage = Lr;
			var Cr = n('R6wv'),
				Er = n('U8r1'),
				Ir = n.n(Er),
				Tr = n('hJ5i');
			function Gr(t) {
				return Tr.map(t, function (t) {
					var e = t[0],
						n = t[1],
						i = [];
					return e && i.push(Nr(e)), n && i.push(Nr(n)), i;
				});
			}
			function Dr(t) {
				return Tr.map(t, function (t) {
			...
			function Rr(t) {
				return Tr.map(t, function (t) {
					var e = t[0],
						n = t[1],
						i = [];
					return e && i.push(zr(e)), n && i.push(zr(n)), i;
				});
			}
			function kr(t, e, n) {
				return [xe().center([t, e]).radius(n)().coordinates];
			}
			function Br(t, e, n, i) {
				var r = [];
				-180 == i && (i = -179.9999),
					...
					180 == e && (e = 179.9999);
				for (
					var o = Math.min(90, (e - i) / Math.ceil((e - i) / 90)),
			...
			var Wr = (function (t) {
				function e() {
					...
					(e.className = 'MapPolygon'),
						(e.polygon = e.createChild(Cr.a)),
						(e.polygon.shouldClone = !1),
						(e.polygon.applyOnClones = !0);
					var n = new p.a();
					return (
						(e.fill = n.getFor('secondaryButton')),
						(e.stroke = n.getFor('secondaryButtonStroke')),
						(e.strokeOpacity = 1),
				...
				return (
					...
					(e.prototype.getFeature = function () {
						if (this.multiPolygon && this.multiPolygon.length > 0)
							return {
								type: 'Feature',
								geometry: { type: 'MultiPolygon', coordinates: this.multiPolygon }
							};
					}),
					Object.defineProperty(e.prototype, 'multiGeoPolygon', {
						...
						set: function (t) {
							this.setPropertyValue('multiGeoPolygon', t, !0), (this.multiPolygon = Rr(t));
						},
						enumerable: !0,
						configurable: !0
					}),
					...
					(e.prototype.validate = function () {
						if (this.series) {
							...
							e.d3Projection.precision(0.5);
							var n = e.d3Path;
							if (this.multiPolygon) {
								if (this.series) {
									var i = { type: 'MultiPolygon', coordinates: this.multiPolygon };
									...
									if (this.multiPolygon.length > 1)
										for (var a = 0; a < this.multiPolygon.length; a++) {
											var u = this.multiPolygon[a],
												s = ct({ type: 'Polygon', coordinates: u });
											s > r && ((o = u), (r = s));
										}
									var c = Ir()(o);
					...
					Object.defineProperty(e.prototype, 'visualLatitude', {
						get: function () {
							...
							return g.isNumber(t)
								? t
								: this._adapterO
								? this._adapterO.apply('visualLatitude', this._visualLatitude)
					...
					Object.defineProperty(e.prototype, 'visualLongitude', {
						get: function () {
							...
							return g.isNumber(t)
								? t
								: this._adapterO
								? this._adapterO.apply('visualLongitude', this._visualLongitude)
			...
			d.c.registeredClasses.MapPolygon = Wr;
			var Hr = n('vMqJ'),
				Zr = n('v9UT'),
				qr = n('Wglt'),
				Xr = (function (t) {
					...
					return (
						...
						Object.defineProperty(e.prototype, 'multiGeoPolygon', {
							...
							set: function (t) {
								(this._multiGeoPolygon = t), (this.multiPolygon = Rr(t));
							},
							enumerable: !0,
							configurable: !0
						}),
				...
				Yr = (function (t) {
					...
					return (
											...
											var i = function (t, e) {
													...
													if (o) {
														var a = o.type,
															u = i.id;
														if (
															(r.chart.geodataNames &&
																r.chart.geodataNames[u] &&
																(i.properties.name = r.chart.geodataNames[u]),
															'Polygon' == a || 'MultiPolygon' == a)
														) {
															if (!r.checkInclude(r.include, r.exclude, u))
																return 'continue';
															var s = o.coordinates;
															s && 'Polygon' == a && (s = [s]);
															var c = Tr.find(r.data, function (t, e) {
																return t.id == u;
															});
															c
																? c.multiPolygon || (c.multiPolygon = s)
																: ((c = {
																		multiPolygon: s,
																		id: u,
																		madeFromGeoData: !0
																  ...
																  r.data.push(c)),
																Zr.softCopyProperties(i.properties, c);
														}
													}
												},
												r = this,
						...
						Object.defineProperty(e.prototype, 'mapPolygons', {
							get: function () {
								if (!this._mapPolygons) {
									var t = new Wr(),
										e = new Hr.e(t);
									this._disposers.push(new Hr.c(e)),
						...
						(e.prototype.getPolygonById = function (t) {
							return qr.find(this.mapPolygons.iterator(), function (e) {
			...
			(d.c.registeredClasses.MapPolygonSeries = Yr), (d.c.registeredClasses.MapPolygonSeriesDataItem = Xr);
			var Ur = (function () {
				function t() {
					this.d3Projection = nr();
				}
				return (
					Object.defineProperty(t.prototype, 'd3Projection', {
						get: function () {
							return this._d3Projection;
						},
						set: function (t) {
							(this._d3Projection = t),
								t.precision(0.1),
								(this._d3Path = _i().projection(t)),
								this.chart && this.chart.invalidateProjection();
						},
						enumerable: !0,
						configurable: !0
					}),
					...
					(t.prototype.convert = function (t) {
						...
						if (e) return { x: e[0], y: e[1] };
					}),
					(t.prototype.invert = function (t) {
						var e = this.d3Projection.invert([t.x, t.y]);
						if (e) return { longitude: e[0], latitude: e[1] };
					}),
					(t.prototype.project = function (t, e) {
						return this.convert({ longitude: t * v.DEGREES, latitude: e * v.DEGREES });
					}),
					(t.prototype.unproject = function (t, e) {
						return this.invert({ x: t, y: e });
					}),
					...
					(t.prototype.intermediatePoint = function (t, e, n) {
						var i = xn([t.longitude, t.latitude], [e.longitude, e.latitude])(n);
					...
					(t.prototype.distance = function (t, e) {
						return an([t.longitude, t.latitude], [e.longitude, e.latitude]);
					}),
					(t.prototype.positionToPoint = function (t, e) {
						if (t) {
							var n = this.positionToGeoPoint(t, e),
								i = this.positionToGeoPoint(t, e - 0.01),
								r = this.positionToGeoPoint(t, e + 0.01);
							if (i && r) {
								var o = this.convert(n),
									a = this.convert(i),
									u = this.convert(r);
								return { x: o.x, y: o.y, angle: v.getAngle(a, u) };
							}
						}
					...
					(t.prototype.positionToGeoPoint = function (t, e) {
						if (t) {
							for (
								var n = this.multiDistance(t), i = 0, r = 0, o = 0, a = void 0, u = void 0, s = 0;
								s < t.length;
								s++
							) {
								var c = t[s];
			...
			d.c.registeredClasses.Projection = Ur;
			var Jr = n('FzPm'),
				Kr = n('GtDR'),
				Qr = n('8ZqG'),
				$r = (function (t) {
					function e() {
						...
						(e._chart = new h.d()),
							...
							e.margin(5, 5, 5, 5);
						var n = new p.a();
						(e.background.fillOpacity = 0.9),
							(e.background.fill = n.getFor('background')),
							e.events.on('hit', e.moveToPosition, e, !1),
							e.events.on('maxsizechanged', e.updateMapSize, e, !1),
							(e.seriesContainer = e.createChild(Or.a)),
							(e.seriesContainer.shouldClone = !1);
						var i = e.createChild(Kr.a);
						return (
							(i.shouldClone = !1),
							(i.stroke = n.getFor('alternativeBackground')),
							(i.strokeWidth = 1),
							(i.strokeOpacity = 0.5),
							(i.fill = Object(Qr.c)()),
					...
					return (
						...
						(e.prototype.handleSeriesAdded = function (t) {
							...
							if (this.chart.series.contains(e)) {
								...
								this._series.removeValue(e),
									this._series.push(n),
									(e = n),
									this.chart.dataUsers.push(n);
							}
							(e.chart = this.chart),
								(e.parent = this.seriesContainer),
								(e.interactionsEnabled = !1),
								e.events.on('inited', this.updateMapSize, this, !1),
								(e.hidden = !1);
						}),
						...
						(e.prototype.moveToPosition = function (t) {
							var e = Zr.spritePointToSprite(t.spritePoint, this, this.seriesContainer),
							...
							set: function (t) {
								this.chart != t &&
									this._chart.set(
										t,
										new h.c([
											t.events.on('mappositionchanged', this.updateRectangle, this, !1),
											t.events.on('scaleratiochanged', this.updateMapSize, this, !1)
										])
									);
							},
							enumerable: !0,
						...
						(e.prototype.updateRectangle = function () {
							...
							var i = Math.min(this.percentWidth, this.percentHeight) / 100,
								r = t.seriesContainer;
							(n.x = Math.ceil((-r.pixelX * i) / e) + this.seriesContainer.pixelX),
								(n.y = Math.ceil((-r.pixelY * i) / e) + this.seriesContainer.pixelY),
								n.validate();
						}),
						(e.prototype.updateMapSize = function () {
							if (this.chart) {
								...
								var e = { width: 0, height: 0, x: 0, y: 0 };
								try {
									e = this.seriesContainer.group.node.getBBox();
								} catch (t) {}
								e.width > 0 && (this.rectangle.visible = !0),
									(this.seriesContainer.x = this.pixelWidth / 2 - e.x * t - (e.width / 2) * t),
									(this.seriesContainer.y = this.pixelHeight / 2 - e.y * t - (e.height / 2) * t),
			...
			d.c.registeredClasses.SmallMap = $r;
			var to = n('WYhe'),
				eo = n('0FpR');
			function no(t) {
				var e = ro(t.longitude),
					n = Math.asin(Math.sin(t.latitude * v.RADIANS)) * v.DEGREES,
					i = ro(t.latitude);
				return Math.abs(i) > 90 && (e = ro(e + 180)), (t.longitude = e), (t.latitude = n), t;
			}
			function io(t) {
				return (
					Tr.each(t, function (t) {
						Tr.each(t, function (t) {
							no(t);
						});
					}),
			...
			function oo(t) {
				return { x: t.longitude, y: t.latitude };
			}
			var ao = (function (t) {
				function e() {
					var e = t.call(this) || this;
					...
					(e.prototype.validatePosition = function () {
						...
						if (e) {
							...
							if (
								((this.x = n.x),
								(this.y = n.y),
								this.adjustRotation && (this.rotation = n.angle),
							...
							if (e.shortestDistance) {
								var r = this.mapLine.series.chart.projection,
									...
									a = r.d3Path({ type: 'Point', coordinates: [o.longitude, o.latitude] });
								this.__disabled = !a;
							}
						}
						t.prototype.validatePosition.call(this);
			...
			d.c.registeredClasses.MapLineObject = ao;
			var uo = (function (t) {
					function e() {
						var e = t.call(this) || this;
					...
					return (
						...
						Object.defineProperty(e.prototype, 'point', {
							...
							set: function (t) {
								(this._point = t), (this._geoPoint = Fr(t)), this.updateExtremes();
							},
							enumerable: !0,
							configurable: !0
						}),
				...
				so = (function (t) {
					...
					return (
						...
						(e.prototype.validateData = function () {
							var e = this;
							if (
								(this.data.length > 0 && 0 == this._parseDataFrom && this.mapImages.clear(),
										...
										var r = function (t, e) {
												...
												if (r) {
													...
													if ('Point' == a || 'MultiPoint' == a) {
														...
														var s = r.coordinates;
														'Point' == a && (s = [s]);
														var c = Tr.find(o.data, function (t, e) {
															return t.id == u;
														});
														c
															? c.multiPoint || (c.multiPoint = s)
															: ((c = { multiPoint: s, id: u, madeFromGeoData: !0 }),
															  o.data.push(c)),
															Zr.softCopyProperties(n.properties, c);
													}
												}
											},
											o = this,
							...
							t.prototype.validateData.call(this),
								qr.each(this.dataItems.iterator(), function (t) {
									var n = t.mapImage;
									n.isDisposed() ||
										(e.mapImages.moveValue(n),
										g.isNumber(n.latitude) &&
											g.isNumber(n.latitude) &&
											(t.geoPoint = { latitude: n.latitude, longitude: n.longitude }));
								});
						}),
						...
						(e.prototype.validate = function () {
							t.prototype.validate.call(this),
								qr.each(this.mapImages.iterator(), function (t) {
									t.validatePosition();
								});
						}),
						(e.prototype.copyFrom = function (e) {
						...
						(e.prototype.getImageById = function (t) {
							return qr.find(this.mapImages.iterator(), function (e) {
			...
			(d.c.registeredClasses.MapImageSeries = so), (d.c.registeredClasses.MapImageSeriesDataItem = uo);
			var co = n('Rnbi'),
				lo = n('jfaP'),
				ho = n('tjMS'),
				po = (function (t) {
					...
					return (
						...
						(e.prototype.positionToPoint = function (t) {
							return this.shortestDistance
								? this.series.chart.projection.positionToPoint(this.multiGeoLine, t)
								: this.line
								? this.line.positionToPoint(t)
								: { x: 0, y: 0, angle: 0 };
						}),
						Object.defineProperty(e.prototype, 'multiGeoLine', {
							get: function () {
								...
								return (
									!t &&
										this.dataItem &&
										this.dataItem.multiGeoLine &&
										(t = this.dataItem.multiGeoLine),
									t
								);
							},
							set: function (t) {
								if (t && t.length > 0) {
									this.setPropertyValue('multiGeoLine', io(t), !0);
									var e = Ar(t);
						...
						Object.defineProperty(e.prototype, 'multiLine', {
							get: function () {
								...
								return (
									!t && this.dataItem && this.dataItem.multiLine && (t = this.dataItem.multiLine), t
								);
							},
							set: function (t) {
								this.setPropertyValue('multiLine', t), (this.multiGeoLine = Dr(t));
							},
							enumerable: !0,
							configurable: !0
						}),
						Object.defineProperty(e.prototype, 'imagesToConnect', {
							...
							set: function (t) {
								var e = this;
								if (
									(this.setPropertyValue('imagesToConnect', t, !0),
									...
									n &&
										n.series.each(function (t) {
											t instanceof so &&
												(t.isReady() ||
													e._disposers.push(
														t.events.on('ready', e.handleImagesToConnect, e, !1)
													));
										});
								}
							},
							...
							if (this.imagesToConnect) {
								var i = [],
									...
									o = function (t) {
										...
										if (
											t instanceof Lr &&
											(i.push({ longitude: t.longitude, latitude: t.latitude }),
											!a._imageListeners[t.uid])
										) {
											var r = t.events.on(
												'propertychanged',
												function (t) {
													('longitude' != t.property && 'latitude' != t.property) ||
														(n.handleImagesToConnect(), n.invalidate());
												},
												a,
												!1
											);
								...
								try {
									for (
										var u = Object(c.g)(this.imagesToConnect), s = u.next();
										!s.done;
										s = u.next()
									) {
										o(s.value);
						...
						(e.prototype.validate = function () {
							...
							if (this.multiLine) {
								if (this.shortestDistance)
									e.projection.d3Projection.precision(0.1),
										(this.line.path = e.projection.d3Path(this.getFeature()));
								else {
								...
								this._arrow && this._arrow.validatePosition(),
									qr.each(this.lineObjects.iterator(), function (t) {
										t.validatePosition();
									}),
						...
						(e.prototype.getFeature = function () {
							if (
								this.multiLine &&
								this.multiLine.length > 0 &&
								this.multiLine[0] &&
								this.multiLine[0].length > 0
							)
								return {
									type: 'Feature',
									geometry: { type: 'MultiLineString', coordinates: this.multiLine }
								};
						}),
						(e.prototype.measureElement = function () {}),
						...
						Object.defineProperty(e.prototype, 'lineObjects', {
							get: function () {
								return (
									this._lineObjects ||
										((this._lineObjects = new Hr.e(new ao())),
										this._lineObjects.events.on('inserted', this.handleLineObjectAdded, this, !1),
										this._disposers.push(new Hr.c(this._lineObjects)),
						...
						Object.defineProperty(e.prototype, 'arrow', {
							get: function () {
								if (!this._arrow) {
									var t = this.createChild(ao);
									(t.shouldClone = !1),
										(t.width = 8),
										(t.height = 10),
										(t.mapLine = this),
										(t.position = 0.5);
									var e = t.createChild(co.a);
									(e.fillOpacity = 1),
										(e.width = Object(ho.c)(100)),
										(e.height = Object(ho.c)(100)),
										(e.rotation = 90),
						...
						(e.prototype.getTooltipX = function () {
							...
							return (
								t instanceof ho.a || (t = Object(ho.c)(50)),
								t instanceof ho.a ? this.positionToPoint(t.value).x : 0
							);
						}),
						(e.prototype.getTooltipY = function () {
							...
							return (
								t instanceof ho.a || (t = Object(ho.c)(50)),
								t instanceof ho.a ? this.positionToPoint(t.value).y : 0
							);
						}),
						e
					);
				})(wr);
			d.c.registeredClasses.MapLine = po;
			var fo = (function (t) {
					function e() {
						var e = t.call(this) || this;
					...
					return (
						...
						Object.defineProperty(e.prototype, 'multiLine', {
							...
							set: function (t) {
								(this._multiLine = t), (this._multiGeoLine = Dr(t)), this.updateExtremes();
							},
							enumerable: !0,
							configurable: !0
						}),
						Object.defineProperty(e.prototype, 'geoLine', {
							...
							set: function (t) {
								(this._geoLine = t), (this.multiLine = Ar([t]));
							},
							enumerable: !0,
							configurable: !0
						}),
						Object.defineProperty(e.prototype, 'multiGeoLine', {
							...
							set: function (t) {
								(this._multiGeoLine = t), (this.multiLine = Ar(t));
							},
							enumerable: !0,
							configurable: !0
						}),
				...
				go = (function (t) {
					...
					return (
													...
													if (o) {
														...
														if ('LineString' == a || 'MultiLineString' == a) {
															if (!r.checkInclude(r.include, r.exclude, u))
																return 'continue';
															var s = o.coordinates,
																c = Tr.find(r.data, function (t, e) {
																	return t.id == u;
																});
															'LineString' == a && (s = [s]),
																c
																	? c.multiLine || (c.multiLine = s)
																	: ((c = {
																			multiLine: s,
																			id: u,
																			madeFromGeoData: !0
						...
						(e.prototype.getLineById = function (t) {
							return qr.find(this.mapLines.iterator(), function (e) {
								return e.dataItem.dataContext.id == t;
							});
						}),
						e
			...
			(d.c.registeredClasses.MapLineSeries = go), (d.c.registeredClasses.MapLineSeriesDataItem = fo);
			var vo = (function (t) {
				function e() {
					var e = t.call(this) || this;
			...
			d.c.registeredClasses.Graticule = vo;
			var mo = (function (t) {
					function e() {
						var e = t.call(this) || this;
				...
				yo = (function (t) {
					function e() {
						...
						return (
							...
							(e.fitExtent = !0),
							(e.singleSprite = !0),
							e.events.disableType('geoBoundsChanged'),
							(e.mapLines.template.line.strokeOpacity = 0.08),
							(e.ignoreBounds = !1),
							(e.hiddenInLegend = !0),
							e.applyTheme(),
							e
			...
			(d.c.registeredClasses.GraticuleSeries = yo), (d.c.registeredClasses.GraticuleSeriesDataItem = mo);
			var bo = n('zhwk'),
				Po = (function (t) {
					function e() {
						var e = t.call(this) || this;
				...
				So = (function (t) {
					function e() {
						...
						(e.scaleRatio = 1),
							(e.zoomDuration = 1e3),
							(e.zoomEasing = eo.cubicOut),
							(e.minZoomLevel = 1),
							(e.maxZoomLevel = 32),
							(e._prevZoomGeoPoint = { latitude: 0, longitude: 0 }),
							...
							(e.zoomStep = 2),
							(e.layout = 'absolute'),
							(e.centerMapOnZoomOut = !0),
							e.padding(0, 0, 0, 0),
							Zr.used(e.backgroundSeries),
							(e.minWidth = 10),
							(e.minHeight = 10),
						...
						(n.visible = !1),
							(n.inert = !0),
							(n.resizable = !0),
							n.events.on('transformed', e.handleMapTransform, e, !1),
							n.events.on('doublehit', e.handleDoubleHit, e, !1),
							n.events.on('dragged', e.handleDrag, e, !1),
							(n.zIndex = 0),
							(n.dragWhileResize = !0),
							e.events.on(
								'maxsizechanged',
								function (t) {
									(0 != t.previousWidth && 0 != t.previousHeight) ||
										(e.updateExtremes(), e.updateCenterGeoPoint());
								},
								void 0,
								!1
							);
						...
						(r.fillOpacity = 0),
							...
							r.events.on('doublehit', e.handleDoubleHit, e),
							(r.focusable = !0),
							i.events.on('down', e.handleMapDown, e, !1),
							(e.background.fillOpacity = 0),
							(e.background.readerTitle = e.language.translate(
								'Use plus and minus keys on your keyboard to zoom in and out'
							)),
							e._disposers.push(
								Object(bo.b)().body.events.on(
									'keyup',
									function (t) {
										if (
											e.topParent.hasFocused &&
											(!e._zoomControl || !e._zoomControl.thumb.isFocused)
										)
											switch (to.b.getEventKey(t.event)) {
												case 'up':
													e.pan({ x: 0, y: 0.1 });
													break;
												case 'down':
						...
						var o = Object(bo.b)();
						e._disposers.push(o.body.events.on('down', e.handlePanDown, e)),
							e._disposers.push(o.body.events.on('up', e.handlePanUp, e));
						var a = e.seriesContainer.createChild(Jr.a);
						return (
							(a.radius = 10),
							(a.inert = !0),
							(a.isMeasured = !1),
							a.events.on('transformed', e.handlePanMove, e, !1),
					...
					return (
						Object(c.c)(e, t),
						(e.prototype.handlePanDown = function (t) {
							var e = Zr.documentPointToSvg(t.pointer.point, this.htmlContainer);
							e.x > 0 &&
								e.y > 0 &&
								e.x < this.svgContainer.width &&
								e.y < this.svgContainer.height &&
								((this._downPointOrig = Zr.documentPointToSprite(
									t.pointer.point,
									this.seriesContainer
								)),
								this.panSprite.moveTo(this._downPointOrig),
								this.panSprite.dragStart(t.pointer),
								(this._downDeltaLongitude = this.deltaLongitude),
								(this._downDeltaLatitude = this.deltaLatitude));
						}),
						(e.prototype.handlePanUp = function (t) {
							this._downPointOrig && this.panSprite.dragStop(t.pointer), (this._downPointOrig = void 0);
						}),
							...
							if (!this.seriesContainer.isResized) {
								...
								if ('move' != e && 'none' != e && this._downPointOrig && t.rotate) {
									...
									var a = this.projection.invert(this._downPointOrig),
										u = { x: this.panSprite.pixelX, y: this.panSprite.pixelY },
										s = void 0;
									u && (s = this.projection.invert(u)),
										t.rotate([i, r, o]),
										s &&
											(('rotateLat' != e && 'rotateLongLat' != e) ||
												(this.deltaLatitude =
													this._downDeltaLatitude + s.latitude - a.latitude),
											('rotateLong' != e && 'rotateLongLat' != e) ||
												(this.deltaLongitude =
													this._downDeltaLongitude + s.longitude - a.longitude));
								}
							}
						}),
						(e.prototype.handleAllInited = function () {
							...
							if (
								...
								this.updateCenterGeoPoint(), this.updateScaleRatio(), this.goHome(0);
							else {
								var n = d.c.events.once(
									'exitframe',
									function () {
						...
						(e.prototype.updateCenterGeoPoint = function () {
							...
							if (this.backgroundSeries) {
								...
								this.series.each(function (r) {
									...
									(t > o.x || !g.isNumber(t)) && (t = o.x),
										(e < o.x + o.width || !g.isNumber(e)) && (e = o.x + o.width),
										(n > o.y || !g.isNumber(n)) && (n = o.y),
										(i < o.y + o.height || !g.isNumber(i)) && (i = o.y + o.height);
								});
							(this.seriesMaxLeft = t),
								(this.seriesMaxRight = e),
								(this.seriesMaxTop = n),
								(this.seriesMaxBottom = i),
								(this.seriesWidth = e - t),
								(this.seriesHeight = i - n),
								this.seriesWidth > 0 && this.seriesHeight > 0
									? ((this.chartContainer.visible = !0),
									  (this._centerGeoPoint = this.projection.invert({
											x: t + (e - t) / 2,
											y: n + (i - n) / 2
									  })),
									  (this._zoomGeoPointReal && g.isNumber(this._zoomGeoPointReal.latitude)) ||
						...
						(e.prototype.handleDrag = function () {
							...
							c > d && (c = d),
								i.moveTo({ x: s, y: c }, void 0, void 0, !0),
						...
						(e.prototype.handleDoubleHit = function (t) {
							var e = Zr.documentPointToSvg(t.point, this.htmlContainer, this.svgContainer.cssScale),
						...
						(e.prototype.handleWheel = function (t) {
							...
							e && e.done();
							var n = Zr.documentPointToSvg(t.point, this.htmlContainer, this.svgContainer.cssScale),
								i = this.svgPointToGeo(n);
							t.shift.y < 0
								? this.zoomIn(i, void 0, this.interactions.mouseOptions.sensitivity)
								: this.zoomOut(i, void 0, this.interactions.mouseOptions.sensitivity);
						}),
						...
						Object.defineProperty(e.prototype, 'projection', {
							...
							set: function (t) {
								var e = this;
								this.setPropertyValue('projection', t) &&
									(this.invalidateProjection(),
									(t.chart = this),
									this._backgroundSeries && this._backgroundSeries.invalidate(),
									this.series.each(function (t) {
						...
						(e.prototype.updateExtremes = function () {
							...
							this.series.each(function (r) {
								r.ignoreBounds ||
									(r instanceof yo && r.fitExtent) ||
									((r.north > e || !g.isNumber(e)) && (e = r.north),
									(r.south < i || !g.isNumber(i)) && (i = r.south),
									(r.west < n || !g.isNumber(n)) && (n = r.west),
									(r.east > t || !g.isNumber(t)) && (t = r.east));
							});
							var r = [],
								o = !1;
							this.series.each(function (t) {
								t instanceof yo && !t.fitExtent && ((r = t.getFeatures()), (o = !0));
							}),
								o ||
									this.series.each(function (t) {
										t.ignoreBounds ||
											(t instanceof yo && t.fitExtent) ||
											(r = r.concat(t.getFeatures()));
									});
							...
							if (
								r.length > 0 &&
								s &&
								(this.east != t || this.west != n || this.north != e || this.south != i)
							) {
								...
								if (
									(s.fitSize([a, u], f),
									s.scale() != d && this.invalidateDataUsers(),
									this.series.each(function (t) {
										t instanceof yo && t.invalidateData();
									}),
									this._backgroundSeries)
								) {
									var m = this._backgroundSeries.mapPolygons.getIndex(0);
									m && (m.multiPolygon = Br(this.north, this.east, this.south, this.west));
								}
						...
						(e.prototype.geoPointToSVG = function (t) {
							...
							if (e) {
								...
								return Zr.spritePointToSvg(n, e);
							}
						}),
							...
							set: function (t) {
								t != this._geodata &&
									...
									this.dataUsers.each(function (t) {
										for (var e = t.data.length - 1; e >= 0; e--)
											1 == t.data[e].madeFromGeoData && t.data.splice(e, 1);
						...
						(e.prototype.zoomToGeoPoint = function (t, e, n, i, r) {
							var o = this;
							if (
								(t || (t = this.zoomGeoPoint), t && g.isNumber(t.longitude) && g.isNumber(t.latitude))
							) {
								(this._zoomGeoPointReal = t),
									(e = v.fitToRange(e, this.minZoomLevel, this.maxZoomLevel));
								var a = this.projection.convert(t);
								if (a) {
									var u = this.geoPointToSVG(t),
										s = Zr.svgPointToSprite(u, this);
									n && (s = { x: this.innerWidth / 2, y: this.innerHeight / 2 }),
										g.isNumber(i) || (i = this.zoomDuration);
									var c = s.x - a.x * e * this.scaleRatio,
										l = s.y - a.y * e * this.scaleRatio;
									return (
										!r &&
											e < this.zoomLevel &&
											this.centerMapOnZoomOut &&
											e < 1.5 &&
											((c =
												this.innerWidth / 2 -
												(this.seriesMaxLeft + (this.seriesMaxRight - this.seriesMaxLeft) / 2) *
													e *
													this.scaleRatio),
											(l =
												this.innerHeight / 2 -
												(this.seriesMaxTop + (this.seriesMaxBottom - this.seriesMaxTop) / 2) *
													e *
													this.scaleRatio)),
										(this._mapAnimation = this.seriesContainer.animate(
											[
												{ property: 'scale', to: e },
												{ property: 'x', from: this.seriesContainer.pixelX, to: c },
												{ property: 'y', from: this.seriesContainer.pixelY, to: l }
											],
											i,
											this.zoomEasing
										)),
										this._disposers.push(
											this._mapAnimation.events.on('animationended', function () {
						...
						(e.prototype.zoomToMapObject = function (t, e, n, i) {
							...
							if ((r && r.done(), t instanceof Lr))
								return (
									g.isNaN(e) && (e = 5),
									this.zoomToGeoPoint({ latitude: t.latitude, longitude: t.longitude }, e, n, i, !0)
								);
							var o = t.dataItem;
							if ((o && g.isNumber(o.zoomLevel) && (e = o.zoomLevel), t instanceof Wr)) {
								var a = t.dataItem,
									u = t.polygon.bbox;
								(0 != u.width && 0 != u.height) || (u = t.polygon.group.getBBox()),
									g.isNumber(e) ||
										(e = Math.min(this.seriesWidth / u.width, this.seriesHeight / u.height));
								var s = void 0;
								if (a && g.hasValue(a.zoomGeoPoint)) s = a.zoomGeoPoint;
								else {
									var c = { x: u.x + u.width / 2, y: u.y + u.height / 2 },
										l = Zr.spritePointToSprite(c, t.polygon, t.series);
						...
						(e.prototype.zoomToRectangle = function (t, e, n, i, r, o, a) {
							g.isNaN(r) && (r = 1);
							var u =
								r * Math.min((this.south - this.north) / (n - t), (this.west - this.east) / (i - e));
							return this.zoomToGeoPoint(
								{ latitude: t + (n - t) / 2, longitude: i + (e - i) / 2 },
								u,
								o,
								a,
								!0
						...
						(e.prototype.pan = function (t, e) {
							...
							(n.x += this.pixelWidth * t.x),
								(n.y += this.pixelHeight * t.y),
								this.zoomToGeoPoint(this.svgPointToGeo(n), this.zoomLevel, !0, e, !0);
						}),
						Object.defineProperty(e.prototype, 'zoomGeoPoint', {
							get: function () {
								var t = Zr.spritePointToSvg({ x: this.pixelWidth / 2, y: this.pixelHeight / 2 }, this);
						...
						(e.prototype.handleMapTransform = function () {
							this.zoomLevel != this._prevZoomLevel &&
								(this.dispatch('zoomlevelchanged'), (this._prevZoomLevel = this.zoomLevel)),
								!this.zoomGeoPoint ||
									(this._prevZoomGeoPoint.latitude == this.zoomGeoPoint.latitude &&
										this._prevZoomGeoPoint.longitude == this.zoomGeoPoint.longitude) ||
						...
						Object.defineProperty(e.prototype, 'zoomControl', {
							...
							set: function (t) {
								this._zoomControl && this.removeDispose(this._zoomControl),
									...
									(t.chart = this),
									(t.parent = this.chartContainer),
									(t.plusButton.exportable = !1),
									(t.minusButton.exportable = !1);
							},
							enumerable: !0,
							configurable: !0
						}),
						...
						Object.defineProperty(e.prototype, 'deltaLongitude', {
							...
							set: function (t) {
								this.setPropertyValue('deltaLongitude', ro(t)) &&
									(this.rotateMap(), this.updateZoomGeoPoint());
							},
							enumerable: !0,
							configurable: !0
						}),
						Object.defineProperty(e.prototype, 'deltaLatitude', {
							...
							set: function (t) {
								this.setPropertyValue('deltaLatitude', t) &&
									(this.rotateMap(), this.updateZoomGeoPoint());
							},
							enumerable: !0,
							configurable: !0
						...
						(e.prototype.rotateMap = function () {
							this.projection.d3Projection &&
								this.projection.d3Projection.rotate &&
								(this.projection.d3Projection.rotate([
									this.deltaLongitude,
									this.deltaLatitude,
									this.deltaGamma
						...
						(e.prototype.processConfig = function (e) {
							...
							g.hasValue(e.projection) &&
								g.isString(e.projection) &&
								(e.projection = this.createClassInstance(e.projection)),
								g.hasValue(e.smallMap) &&
									!g.hasValue(e.smallMap.type) &&
									(e.smallMap.type = 'SmallMap'),
								g.hasValue(e.zoomControl) &&
									!g.hasValue(e.zoomControl.type) &&
									(e.zoomControl.type = 'ZoomControl'),
								t.prototype.processConfig.call(this, e);
						}),
						...
						(e.prototype.configOrder = function (e, n) {
							return e == n
								...
								: 'series' == n
								? -1
								: t.prototype.configOrder.call(this, e, n);
						}),
						(e.prototype.asIs = function (e) {
						...
						(e.prototype.setPaper = function (e) {
							return (
								this.svgContainer && (this.svgContainer.hideOverflow = !0),
							...
							get: function () {
								...
								if (!this._backgroundSeries) {
									...
									(i.stroke = n),
										...
										(i.fillOpacity = 0),
										(i.strokeOpacity = 0),
										e.mapPolygons.create(),
										(this._backgroundSeries = e);
								}
						...
						(e.prototype.setTapToActivate = function (e) {
							t.prototype.setTapToActivate.call(this, e),
								(this.seriesContainer.interactions.isTouchProtected = !0),
								(this.panSprite.interactions.isTouchProtected = !0);
						}),
						(e.prototype.handleTapToActivate = function () {
							t.prototype.handleTapToActivate.call(this),
								(this.seriesContainer.interactions.isTouchProtected = !1),
								(this.panSprite.interactions.isTouchProtected = !1);
						}),
			...
			d.c.registeredClasses.MapChart = So;
			var _o = n('xgTw'),
				Mo = (function (t) {
					function e() {
						var e = t.call(this) || this;
					...
					return (
						Object(c.c)(e, t),
						(e.prototype.createLine = function () {
							(this.line = new _o.a()), (this.line.tensionX = 0.8), (this.line.tensionY = 0.8);
						}),
						Object.defineProperty(e.prototype, 'shortestDistance', {
							get: function () {
								return !1;
			...
			d.c.registeredClasses.MapSpline = Mo;
			var xo = n('MXvJ'),
				jo = (function (t) {
					function e() {
						var e = t.call(this) || this;
			...
			d.c.registeredClasses.MapArc = jo;
			var Oo = (function (t) {
					function e() {
						var e = t.call(this) || this;
			...
			(d.c.registeredClasses.MapSplineSeries = wo), (d.c.registeredClasses.MapSplineSeriesDataItem = Oo);
			var Lo = (function (t) {
					function e() {
						var e = t.call(this) || this;
			...
			(d.c.registeredClasses.MapArcSeries = Co), (d.c.registeredClasses.MapArcSeriesDataItem = Lo);
			var Eo = n('aGXA'),
				Io = n('CnhP'),
				To = (function (t) {
					function e() {
						...
						(e._chart = new h.d()),
							...
							e.padding(5, 5, 5, 5);
						var n = new p.a(),
							i = e.createChild(Eo.a);
						(i.shouldClone = !1), (i.label.text = '+'), (e.plusButton = i);
						var r = e.createChild(Or.a);
						(r.shouldClone = !1),
							(r.background.fill = n.getFor('alternativeBackground')),
							(r.background.fillOpacity = 0.05),
							r.background.events.on('hit', e.handleBackgroundClick, e, !1),
							r.events.on('sizechanged', e.updateThumbSize, e, !1),
							(e.slider = r);
						var o = r.createChild(Eo.a);
						(o.shouldClone = !1),
							o.padding(0, 0, 0, 0),
							(o.draggable = !0),
							o.events.on('drag', e.handleThumbDrag, e, !1),
							(e.thumb = o);
						var a = e.createChild(Eo.a);
						return (
							(a.shouldClone = !1),
							(a.label.text = '-'),
							(e.minusButton = a),
					...
					return (
						...
						(e.prototype.fixLayout = function () {
							...
							(t.x = void 0),
								...
								t.padding(6, 10, 6, 10),
								e.padding(6, 10, 6, 10),
								(e.label.align = 'center'),
								(e.label.valign = 'middle'),
								(t.label.align = 'center'),
								(t.label.valign = 'middle'),
								'vertical' == this.layout
									? ((this.width = 40),
									  (this.height = void 0),
									  (e.width = Object(ho.c)(100)),
									  (e.height = void 0),
									  (n.width = Object(ho.c)(100)),
									  (n.height = void 0),
									  (t.width = Object(ho.c)(100)),
									  (t.height = void 0),
									  (i.width = Object(ho.c)(100)),
									  (e.marginTop = 1),
									  (t.marginBottom = 2),
									  (i.height = 0),
									  e.toFront(),
									...
									: 'horizontal' == this.layout &&
									  ...
									  (e.height = Object(ho.c)(100)),
									  (e.width = void 0),
									  (t.height = Object(ho.c)(100)),
									  (t.width = void 0),
									  (n.height = Object(ho.c)(100)),
									  (n.width = void 0),
									  (n.minX = 0),
									  (n.minY = 0),
									  (n.maxY = 0),
									  (i.height = Object(ho.c)(100)),
									  (i.width = 0),
									  e.toBack(),
									  t.toFront());
						}),
						...
						Object.defineProperty(e.prototype, 'chart', {
							...
							set: function (t) {
								...
								this._chart.set(
									t,
									new h.c([
										t.events.on('maxsizechanged', this.updateThumbSize, this, !1),
										t.events.on('zoomlevelchanged', this.updateThumb, this, !1),
										this.minusButton.events.on(
											'hit',
											function () {
										...
										Object(bo.b)().body.events.on(
											...
											function (n) {
												e.topParent.hasFocused &&
													(to.b.isKey(n.event, 'enter')
														? e.minusButton.isFocused
															? t.zoomOut()
															: e.plusButton.isFocused && t.zoomIn()
														: to.b.isKey(n.event, 'plus')
														? t.zoomIn()
														: to.b.isKey(n.event, 'minus') && t.zoomOut());
											},
											t
										),
										this.plusButton.events.on(
											'hit',
											function () {
						...
						(e.prototype.updateThumbSize = function () {
							if (this.chart) {
								var t = this.slider,
									e = this.thumb;
								'vertical' == this.layout
									? ((e.minHeight = Math.min(this.slider.pixelHeight, 20)),
									  (e.height = t.pixelHeight / this.stepCount),
									  (e.maxY = t.pixelHeight - e.pixelHeight),
									  e.pixelHeight <= 1 ? (e.visible = !1) : (e.visible = !0))
									: ((e.minWidth = Math.min(this.slider.pixelWidth, 20)),
						...
						(e.prototype.updateThumb = function () {
							...
							if (!n.isDown) {
								...
								'vertical' == this.layout
									? (n.y =
											t.pixelHeight -
											((t.pixelHeight - n.pixelHeight) * i) / this.stepCount -
											n.pixelHeight)
									: (n.x = (t.pixelWidth * i) / this.stepCount);
							}
						}),
						(e.prototype.handleThumbDrag = function () {
							var t,
								...
								i = this.thumb;
							t =
								Math.log(this.chart.minZoomLevel) / Math.LN2 +
								(t =
									'vertical' == this.layout
										? (this.stepCount * (e.pixelHeight - i.pixelY - i.pixelHeight)) /
										  (e.pixelHeight - i.pixelHeight)
										: (this.stepCount * i.pixelX) / e.pixelWidth);
							var r = Math.pow(2, t);
						...
						Object.defineProperty(e.prototype, 'stepCount', {
							get: function () {
								return (
									Math.log(this.chart.maxZoomLevel) / Math.LN2 -
									Math.log(this.chart.minZoomLevel) / Math.LN2
								);
							},
							enumerable: !0,
			...
			d.c.registeredClasses.ZoomControl = To;
			var Go = (function (t) {
				function e() {
					var e = t.call(this) || this;
			...
			d.c.registeredClasses.Mercator = Go;
			var Do = Math.abs,
				No = Math.atan,
				zo = Math.atan2,
			...
			function ca(t, e) {
				...
				return [2 * n * Zo(t) * i, Zo(e) * i];
			}
			ca.invert = function (t, e) {
				if (!(t * t + 4 * e * e > Uo * Uo + Xo)) {
					var n = t,
						i = e,
						r = 25;
					do {
						var o,
							...
							d = u * u,
							g = 1 - f * s * s,
							v = g ? oa(l * s) * aa((o = 1 / g)) : (o = 0),
							m = 2 * v * l * u - t,
							y = v * c - e,
							b = o * (f * d + v * l * s * p),
							P = o * (0.5 * a * h - 2 * v * c * u),
							S = 0.25 * o * (h * u - v * c * f * a),
							_ = o * (p * s + v * d * l),
							M = P * S - _ * b;
						if (!M) break;
						var x = (y * P - m * _) / M,
			...
			la.invert = function (t, e) {
				if (((e *= 3 / 8), !(t *= 3 / 8) && Do(e) > 1)) return null;
				var n = 1 + t * t + e * e,
					i = aa((n - aa(n * n - 4 * e * e)) / 2),
					r = ra(i) / 3,
					o = i
						? (function (t) {
								return Ro(t + aa(t * t - 1));
						  })(Do(e / i)) / 3
						: (function (t) {
								return Ro(t + aa(t * t + 1));
						  })(Do(t)) / 3,
					...
					u = sa(o),
					s = u * u - a * a;
				return [2 * Ho(t) * zo(ua(o) * a, 0.25 - s), 2 * Ho(e) * zo(u * Zo(r), 0.25 + s)];
			};
			var ha = aa(8),
				pa = Ro(1 + $o);
			function fa(t, e) {
				...
				return n < Ko
					? [t, Ro(qo(Ko + e / 2))]
					: [t * Fo(n) * (2 * $o - 1 / Zo(n)), Ho(e) * (2 * $o * (n - Ko) - Ro(qo(n / 2)))];
			}
			fa.invert = function (t, e) {
				if ((i = Do(e)) < pa) return [t, 2 * No(Vo(e)) - Jo];
				var n,
					i,
					r = Ko,
					o = 25;
				do {
					var a = Fo(r / 2),
						u = qo(r / 2);
					r -= n = (ha * (r - Ko) - Ro(u) - i) / (ha - (a * a) / (2 * u));
				} while (Do(n) > Yo && --o > 0);
				return [t / (Fo(r) * (ha - 1 / Zo(r))), Ho(e) * r];
			};
			function da(t, e) {
				return [(t * Fo(e)) / Fo((e /= 2)), 2 * Zo(e)];
			}
			...
			function ga(t, e, n) {
				...
				(n = void 0 === n ? 0 : +n), (e = +e);
				do {
					(r = t(n)) === (o = t(n + Xo)) && (o = r + Xo), (n -= i = (-1 * Xo * (r - e)) / (r - o));
				} while (a-- > 0 && Do(i) > Xo);
				return a < 0 ? NaN : n;
			}
			function va(t, e) {
			...
			function ma(t, e, n) {
				function i(i, r) {
					return [t * i * Fo((r = va(n, r))), e * Zo(r)];
				}
				return (
					(i.invert = function (i, r) {
						return (r = ra(r / e)), [i / (t * Fo(r)), ra((2 * r + Zo(2 * r)) / n)];
					}),
					i
				);
			}
			...
			function Sa(t, e) {
				var n = va(Uo, e);
				return [(ba * t) / (1 / Fo(e) + Pa / Fo(n)), (e + $o * Zo(n)) / ba];
			}
			Sa.invert = function (t, e) {
				...
				do {
					(i = r - $o * Zo(o)),
						(o -= n = (Zo(2 * o) + 2 * o - Uo * Zo(i)) / (2 * Fo(2 * o) + 2 + Uo * Fo(i) * $o * Fo(o)));
				} while (Do(n) > Xo && --a > 0);
				return (i = r - $o * Zo(o)), [(t * (1 / Fo(i) + Pa / Fo(o))) / ba, i];
			};
			function _a(t, e) {
				return [t * Fo(e), e];
			}
			...
			function Ma(t, e) {
				var n = aa(1 - Zo(e));
				return [(2 / ta) * t * n, ta * (1 - n)];
			}
			Ma.invert = function (t, e) {
				var n = (n = e / ta - 1) * n;
				return [n > 0 ? (t * aa(Uo / n)) / 2 : 0, ra(1 - n)];
			};
			var xa = aa(3);
			function ja(t, e) {
				return [(xa * t * (2 * Fo((2 * e) / 3) - 1)) / ta, xa * ta * Zo(e / 3)];
			}
			ja.invert = function (t, e) {
				var n = 3 * ra(e / (xa * ta));
				return [(ta * t) / (xa * (2 * Fo((2 * n) / 3) - 1)), n];
			};
			function Oa(t) {
				var e = Fo(t);
				function n(t, n) {
			...
			function wa(t, e) {
				var n = aa(8 / (3 * Uo));
				return [n * t * (1 - Do(e) / Uo), n * e];
			}
			wa.invert = function (t, e) {
				var n = aa(8 / (3 * Uo)),
					i = e / n;
				return [t / (n * (1 - Do(i) / Uo)), i];
			};
			function La(t, e) {
				var n = aa(4 - 3 * Zo(Do(e)));
				return [(2 / aa(6 * Uo)) * t * n, Ho(e) * aa((2 * Uo) / 3) * (2 - n)];
			}
			La.invert = function (t, e) {
				var n = 2 - Do(e) / aa((2 * Uo) / 3);
				return [(t * aa(6 * Uo)) / (2 * n), Ho(e) * ra((4 - n * n) / 3)];
			};
			function Ca(t, e) {
				var n = aa(Uo * (4 + Uo));
				return [(2 / n) * t * (1 + aa(1 - (4 * e * e) / (Uo * Uo))), (4 / n) * e];
			}
			Ca.invert = function (t, e) {
				var n = aa(Uo * (4 + Uo)) / 2;
				return [(t * n) / (1 + aa(1 - (e * e * (4 + Uo)) / (4 * Uo))), (e * n) / 2];
			};
			function Ea(t, e) {
				var n = (2 + Jo) * Zo(e);
				e /= 2;
				for (var i = 0, r = 1 / 0; i < 10 && Do(r) > Xo; i++) {
					var o = Fo(e);
					e -= r = (e + Zo(e) * (o + 2) - n) / (2 * o * (1 + o));
				}
				return [(2 / aa(Uo * (4 + Uo))) * t * (1 + Fo(e)), 2 * aa(Uo / (4 + Uo)) * Zo(e)];
			}
			Ea.invert = function (t, e) {
				var n = (e * aa((4 + Uo) / Uo)) / 2,
					i = ra(n),
					r = Fo(i);
				return [t / ((2 / aa(Uo * (4 + Uo))) * (1 + r)), ra((i + n * (r + 2)) / (2 + Jo))];
			};
			function Ia(t, e) {
				return [(t * (1 + Fo(e))) / aa(2 + Uo), (2 * e) / aa(2 + Uo)];
			}
			...
			function Ta(t, e) {
				for (var n = (1 + Jo) * Zo(e), i = 0, r = 1 / 0; i < 10 && Do(r) > Xo; i++)
					e -= r = (e + Zo(e) - n) / (1 + Fo(e));
				return (n = aa(2 + Uo)), [(t * (1 + Fo(e))) / n, (2 * e) / n];
			}
			Ta.invert = function (t, e) {
				var n = 1 + Jo,
					i = aa(n / 2);
				return [(2 * t * i) / (1 + Fo((e *= i))), ra((e + Zo(e)) / n)];
			};
			var Ga = function () {
					return zi(Ta).scale(173.044);
				},
				Da = 3 + 2 * $o;
			function Na(t, e) {
				var n = Zo((t /= 2)),
					...
					a = Zo(e) / (o + $o * i * r),
					u = aa(2 / (1 + a * a)),
					s = aa(($o * o + (i + n) * r) / ($o * o + (i - n) * r));
				return [Da * (u * (s - 1 / s) - 2 * Ro(s)), Da * (u * a * (s + 1 / s) - 2 * No(a))];
			}
			Na.invert = function (t, e) {
				if (!(n = la.invert(t / 1.2, 1.065 * e))) return null;
				var n,
					i = n[0],
					r = n[1],
					o = 20;
				...
				do {
					var a = i / 2,
						...
						I = b * O - (2 * C) / y + v * (C + C / m),
						T = b * w - (2 * E) / y + v * (E + E / m),
						G = d * P * O - (2 * M) / (1 + g) + v * P * M + v * d * (C - C / m),
						D = d * P * w - (2 * x) / (1 + g) + v * P * x + v * d * (E - E / m),
						N = T * G - D * I;
					if (!N) break;
					var z = (_ * T - S * D) / N,
						F = (S * G - _ * I) / N;
					(i -= z), (r = ko(-Jo, Bo(Jo, r - F)));
				} while ((Do(z) > Xo || Do(F) > Xo) && --o > 0);
				return Do(Do(r) - Jo) < Xo ? [0, r] : o && [i, r];
			};
			var za = Fo(35 * ia);
			function Fa(t, e) {
				var n = qo(e / 2);
				return [t * za * aa(1 - n * n), (1 + za) * n];
			}
			Fa.invert = function (t, e) {
				var n = e / (1 + za);
				return [t && t / (za * aa(1 - n * n)), 2 * No(n)];
			};
			function Va(t, e) {
				var n = e / 2,
					i = Fo(n);
				return [((2 * t) / ta) * Fo(e) * i * i, ta * qo(n)];
			}
			Va.invert = function (t, e) {
				var n = No(e / ta),
					i = Fo(n),
					r = 2 * n;
				return [(t * ta) / 2 / (Fo(r) * i * i), r];
			};
			var Aa = function (t, e, n, i, r, o, a, u) {
				function s(s, c) {
					if (!c) return [(t * s) / Uo, 0];
					var l = c * c,
						h = t + l * (e + l * (n + l * i)),
						p = c * (r - 1 + l * (o - u + l * a)),
						f = (h * h + p * p) / (2 * p),
						d = (s * ra(h / f)) / Uo;
					return [f * Zo(d), c * (1 + l * u) + f * (1 - Fo(d))];
				}
				return (
					arguments.length < 8 && (u = 0),
					(s.invert = function (s, c) {
						var l,
							h,
							p = (Uo * s) / t,
							f = c,
						...
						do {
							var g = f * f,
								...
								j = (2 * e + g * (4 * n + 6 * g * i)) * f,
								O = r + g * (3 * o + 5 * g * a),
								w = (2 * (v * j + m * (O - 1)) * b - y * (2 * (O - 1))) / (b * b),
								L = Fo(M),
								C = Zo(M),
								E = P * L,
								I = P * C,
								T = ((p / Uo) * (1 / aa(1 - x / S)) * (j * P - v * w)) / S,
								G = I - s,
								D = f * (1 + g * u) + P - E - c,
								N = w * C + E * T,
								z = E * _,
								...
								A = N * V - F * z;
							if (!A) break;
							(p -= l = (D * N - G * F) / A), (f -= h = (G * V - D * z) / A);
						} while ((Do(l) > Xo || Do(h) > Xo) && --d > 0);
						return [p, f];
					}),
					s
				);
			};
			Aa(2.8284, -1.6988, 0.75432, -0.18071, 1.76003, -0.38914, 0.042555),
				Aa(2.583819, -0.835827, 0.170354, -0.038094, 1.543313, -0.411435, 0.082742),
				Aa((5 / 6) * Uo, -0.62636, -0.0344, 0, 1.3493, -0.05524, 0, 0.045);
			function Ra(t, e) {
				var n = t * t,
					i = e * e;
				return [t * (1 - 0.162388 * i) * (0.87 - 952426e-9 * n * n), e * (1 + i / 12)];
			}
			Ra.invert = function (t, e) {
				...
				do {
					var u = (u = i * i) * u;
					i -= n = (i * (0.87 - 952426e-9 * u) - t) / (0.87 - 0.00476213 * u);
				} while (Do(n) > Xo && --o > 0);
				return [i, r];
			};
			Aa(2.6516, -0.76534, 0.19123, -0.047094, 1.36289, -0.13965, 0.031762);
			function ka(t, e) {
				var n = Ho(t),
					i = Ho(e),
					r = Fo(e),
					...
					a = Zo(t) * r,
					u = Zo(i * e);
				(t = Do(zo(a, u))), (e = ra(o)), Do(t - Jo) > Xo && (t %= Jo);
				var s = (function (t, e) {
					if (e === Jo) return [0, 0];
					var n,
						i,
					...
					var m,
						...
						_ = -b * P,
						M = -b * (o * u * S + p * s * P),
						x = -2 * b * (c * ((0.5 * S) / f) - 2 * o * f * P),
						j = (4 * t) / Uo;
					if (t > 0.222 * Uo || (e < Uo / 4 && t > 0.175 * Uo)) {
						if (((n = (v + o * aa(d * (1 + a) - v * v)) / (1 + a)), t > Uo / 4)) return [n, n];
						var O = n,
							w = 0.5 * n;
						(n = 0.5 * (w + O)), (i = 50);
						do {
							var L = aa(d - n * n),
								C = n * (x + _ * L) + M * ra(n / g) - j;
							if (!C) break;
							C < 0 ? (w = n) : (O = n), (n = 0.5 * (w + O));
						} while (Do(O - w) > Xo && --i > 0);
					} else {
						(n = Xo), (i = 25);
						do {
					...
					return [n, -v - o * aa(d - n * n)];
				})(t > Uo / 4 ? Jo - t : t, e);
				return t > Uo / 4 && ((u = s[0]), (s[0] = -s[1]), (s[1] = -u)), (s[0] *= n), (s[1] *= -i), s;
			}
			ka.invert = function (t, e) {
				Do(t) > 1 && (t = 2 * Ho(t) - t), Do(e) > 1 && (e = 2 * Ho(e) - e);
				var n = Ho(t),
					i = Ho(e),
					r = -n * t,
					o = -i * e,
					...
					u = (function (t, e) {
						...
						for (;;) {
							var a = r * r,
								...
								g = aa(d),
								v = e + f + r * g;
							if (Do(i - n) < Yo || 0 == --o || 0 === v) break;
							v > 0 ? (n = r) : (i = r), (r = 0.5 * (n + i));
						}
						if (!o) return null;
						var m = ra(u),
							y = Fo(m),
						...
						return [
							(Uo / 4) *
								(t * (-2 * b * (((0.5 * S) / h) * (1 - a) - 2 * r * h * P) + -b * P * g) +
									-b * (r * (1 + a) * S + l * (1 + 3 * a) * P) * ra(t / aa(p))),
							m
						];
					})(a ? o : r, a ? r : o),
					s = u[0],
					c = u[1],
					l = Fo(c);
				return a && (s = -Jo - s), [n * (zo(Zo(s) * l, -Zo(c)) + Uo), i * ra(Fo(s) * l)];
			};
			function Ba(t, e) {
				var n, i, r, o, a;
				if (e < Xo)
					return [
						(o = Zo(t)) - (n = (e * (t - o * (i = Fo(t)))) / 4) * i,
						i + n * o,
						1 - (e * o * o) / 2,
						t - n
					];
				if (e >= 1 - Xo)
					return (
						...
						[
							(o = (function (t) {
								return ((t = Vo(2 * t)) - 1) / (t + 1);
							})(t)) +
								(n * ((a = i * ua(t)) - t)) / (i * i),
							r - n * o * r * (a - t),
							r + n * o * r * (a + t),
							2 * No(Vo(t)) - Jo + (n * (a - t)) / i
						]
					);
				var u = [1, 0, 0, 0, 0, 0, 0, 0, 0],
					s = [aa(e), 0, 0, 0, 0, 0, 0, 0, 0],
					c = 0;
				for (i = aa(1 - e), a = 1; Do(s[c] / u[c]) > Xo && c < 8; )
					(n = u[c++]), (s[c] = (n - i) / 2), (u[c] = (n + i) / 2), (i = aa(n * i)), (a *= 2);
				r = a * u[c] * t;
				do {
					r = (ra((o = (s[c] * Zo((i = r))) / u[c])) + r) / 2;
				} while (--c);
				return [Zo(r), (o = Fo(r)), o / Fo(r - i), r];
			}
			function Wa(t, e) {
				if (!e) return t;
				if (1 === e) return Ro(qo(t / 2 + Ko));
				for (var n = 1, i = aa(1 - e), r = aa(e), o = 0; Do(r) > Xo; o++) {
					if (t % Uo) {
						var a = No((i * qo(t)) / n);
						a < 0 && (a += Uo), (t += a + ~~(t / Uo) * Uo);
					} else t += t;
					(r = (n + i) / 2), (i = aa(n * i)), (r = ((n = r) - i) / 2);
				}
				return t / (Wo(2, o) * n);
			}
			function Ha(t, e) {
				var n = ($o - 1) / ($o + 1),
					...
					u = (function (t, e) {
						var n = t * t,
							...
							r = 1 - n - e * e;
						return [
							0.5 * ((t >= 0 ? Jo : -Jo) - zo(r, 2 * t)),
							-0.25 * Ro(r * r + 4 * n) + 0.5 * Ro(i * i + n)
						];
					})(a * Fo(-1 * t), a * Zo(-1 * t)),
					s = (function (t, e, n) {
						var i = Do(t),
						...
						if (i) {
							var o = 1 / Zo(i),
								a = 1 / (qo(i) * qo(i)),
								u = -(a + n * (r * r * o * o) - 1 + n),
								s = (-u + aa(u * u - (n - 1) * a * 4)) / 2;
							return [Wa(No(1 / aa(s)), n) * Ho(t), Wa(No(aa((s / a - 1) / n)), 1 - n) * Ho(e)];
						}
						return [0, Wa(No(r), 1 - n) * Ho(e)];
					})(u[0], u[1], i * i);
				return [-s[1], (e >= 0 ? 1 : -1) * (0.5 * r - s[0])];
			}
				...
				var n = ($o - 1) / ($o + 1),
					...
					r = (function (t, e, n) {
						...
						return t
							? ((i = Ba(t, n)),
							  e
									? ((o = (r = Ba(e, 1 - n))[1] * r[1] + n * i[0] * i[0] * r[0] * r[0]),
									  [
					...
					})(0.5 * Wa(Jo, i * i) - e, -t, i * i),
					o = (function (t, e) {
						var n = e[0] * e[0] + e[1] * e[1];
						return [(t[0] * e[0] + t[1] * e[1]) / n, (t[1] * e[0] - t[0] * e[1]) / n];
					})(r[0], r[1]);
				return [zo(o[1], o[0]) / -1, 2 * No(Vo(-0.5 * Ro(n * o[0] * o[0] + n * o[1] * o[1]))) - Jo];
			};
			ra(1 - 1 / 3), Oa(0);
			var Za = 0.7109889596207567,
				qa = 0.0528035274542;
			function Xa(t, e) {
				return e > -Za ? (((t = ya(t, e))[1] += qa), t) : _a(t, e);
			}
			Xa.invert = function (t, e) {
				return e > -Za ? ya.invert(t, e - qa) : _a.invert(t, e);
			};
			function Ya(t, e) {
				return Do(e) > Za ? (((t = ya(t, e))[1] -= e > 0 ? qa : -qa), t) : _a(t, e);
			}
			Ya.invert = function (t, e) {
				return Do(e) > Za ? ya.invert(t, e + (e > 0 ? qa : -qa)) : _a.invert(t, e);
			};
			function Ua(t, e) {
				return [(3 / ea) * t * aa((Uo * Uo) / 3 - e * e), e];
			}
			Ua.invert = function (t, e) {
				return [((ea / 3) * t) / aa((Uo * Uo) / 3 - e * e), e];
			};
			var Ja = Uo / $o;
			function Ka(t, e) {
				return [(t * (1 + aa(Fo(e)))) / 2, e / (Fo(e / 2) * Fo(t / 6))];
			}
			Ka.invert = function (t, e) {
				var n = Do(t),
					i = Do(e),
				...
				for (var a = 0; a < 25; a++) {
					var u = Zo(o),
						...
						P = (f * y - d * v) / b,
						S = (d * g - f * m) / b;
					if (((o -= P), (r -= S), Do(P) < Xo && Do(S) < Xo)) break;
				}
			...
			function Qa(t, e) {
				var n = t * t,
					i = e * e;
				return [
					t * (0.975534 + i * (-0.0143059 * n - 0.119161 + -0.0547009 * i)),
					e * (1.00384 + n * (0.0802894 + -0.02855 * i + 199025e-9 * n) + i * (0.0998909 + -0.0491032 * i))
				];
			}
			Qa.invert = function (t, e) {
				...
				do {
					var o = n * n,
						a = i * i,
						u = n * i,
						s = n * (0.975534 + a * (-0.0143059 * o - 0.119161 + -0.0547009 * a)) - t,
						c =
							i *
								(1.00384 +
									o * (0.0802894 + -0.02855 * a + 199025e-9 * o) +
									a * (0.0998909 + -0.0491032 * a)) -
							e,
						l = 0.975534 - a * (0.119161 + 3 * o * 0.0143059 + 0.0547009 * a),
						h = -u * (0.238322 + 0.2188036 * a + 0.0286118 * o),
						p = u * (0.1605788 + 7961e-7 * o + -0.0571 * a),
						f =
							1.00384 +
							o * (0.0802894 + 199025e-9 * o) +
							a * (3 * (0.0998909 - 0.02855 * o) - 0.245516 * a),
						d = h * p - f * l,
						g = (c * h - s * f) / d,
						v = (s * p - c * l) / d;
					(n -= g), (i -= v);
				} while ((Do(g) > Xo || Do(v) > Xo) && --r > 0);
				return r && [n, i];
			};
			function $a(t, e) {
				return [Zo(t) / Fo(e), qo(e) * Fo(t)];
			}
			$a.invert = function (t, e) {
				var n = t * t,
					i = e * e + 1,
					r = n + i,
					o = t ? Qo * aa((r - aa(r * r - 4 * n)) / n) : 1 / aa(i);
				return [ra(t * o), Ho(e) * oa(o)];
			};
			function tu(t, e) {
				return [t, 1.25 * Ro(qo(Ko + 0.4 * e))];
			}
			tu.invert = function (t, e) {
				return [t, 2.5 * No(Vo(0.8 * e)) - 0.625 * Uo];
			};
			var eu = function () {
				return zi(tu).scale(108.318);
			};
			var nu = aa(6),
				iu = aa(7);
			function ru(t, e) {
				var n = ra((7 * Zo(e)) / (3 * nu));
				return [(nu * t * (2 * Fo((2 * n) / 3) - 1)) / iu, (9 * Zo(n / 3)) / iu];
			}
			ru.invert = function (t, e) {
				var n = 3 * ra((e * iu) / 9);
				return [(t * iu) / (nu * (2 * Fo((2 * n) / 3) - 1)), ra((3 * Zo(n) * nu) / 7)];
			};
			function ou(t, e) {
				for (
					var n, i = (1 + Qo) * Zo(e), r = e, o = 0;
					o < 25 && ((r -= n = (Zo(r / 2) + Zo(r) - i) / (0.5 * Fo(r / 2) + Fo(r))), !(Do(n) < Xo));
					o++
				);
				return [(t * (1 + (2 * Fo(r)) / Fo(r / 2))) / (3 * $o), (2 * aa(3) * Zo(r / 2)) / aa(2 + $o)];
			}
			ou.invert = function (t, e) {
				var n = (e * aa(2 + $o)) / (2 * aa(3)),
					i = 2 * ra(n);
				return [(3 * $o * t) / (1 + (2 * Fo(i)) / Fo(i / 2)), ra((n + Zo(i)) / (1 + Qo))];
			};
			function au(t, e) {
				for (
					var n, i = aa(6 / (4 + Uo)), r = (1 + Uo / 4) * Zo(e), o = e / 2, a = 0;
					a < 25 && ((o -= n = (o / 2 + Zo(o) - r) / (0.5 + Fo(o))), !(Do(n) < Xo));
					a++
				);
				return [(i * (0.5 + Fo(o)) * t) / 1.5, i * o];
			}
			au.invert = function (t, e) {
				var n = aa(6 / (4 + Uo)),
					i = e / n;
				return (
					Do(Do(i) - Jo) < Xo && (i = i < 0 ? -Jo : Jo),
					[(1.5 * t) / (n * (0.5 + Fo(i))), ra((i / 2 + Zo(i)) / (1 + Uo / 4))]
				);
			};
			function uu(t, e) {
				var n = e * e,
					...
					r = n * i;
				return [
					t * (0.84719 - 0.13063 * n + r * r * (0.05494 * n - 0.04515 - 0.02326 * i + 0.00331 * r)),
					e * (1.01183 + i * i * (0.01926 * n - 0.02625 - 0.00396 * i))
				];
			}
			uu.invert = function (t, e) {
				...
				do {
					a -= n =
						(a * (1.01183 + (r = (i = a * a) * i) * r * (0.01926 * i - 0.02625 - 0.00396 * r)) - e) /
						(1.01183 + r * r * (0.21186 * i - 0.23625 + -0.05148 * r));
				} while (Do(n) > Yo && --u > 0);
				return [
					t /
						(0.84719 -
							0.13063 * (i = a * a) +
							(o = i * (r = i * i)) * o * (0.05494 * i - 0.04515 - 0.02326 * r + 0.00331 * o)),
					a
				];
			};
			function su(t, e) {
				return [(t * (1 + Fo(e))) / 2, 2 * (e - qo(e / 2))];
			}
			su.invert = function (t, e) {
				for (var n = e / 2, i = 0, r = 1 / 0; i < 10 && Do(r) > Xo; ++i) {
					var o = Fo(e / 2);
					e -= r = (e - qo(e / 2) - n) / (1 - 0.5 / (o * o));
				}
				return [(2 * t) / (1 + Fo(e)), e];
			};
			function cu(t, e) {
				var n = Zo(e),
					i = Fo(e),
					r = Ho(t);
				if (0 === t || Do(e) === Jo) return [0, e];
				if (0 === e) return [t, 0];
				if (Do(t) === Jo) return [t * i, Jo * n];
				var o = Uo / (2 * t) - (2 * t) / Uo,
					a = (2 * e) / Uo,
					u = (1 - a * a) / (n - a),
					s = o * o,
				...
				return [Jo * (p + aa(p * p + (i * i) / l) * r), Jo * (f + aa(d < 0 ? 0 : d) * Ho(-e * o) * r)];
			}
			cu.invert = function (t, e) {
				var n = (t /= Jo) * t,
					...
					r = Uo * Uo;
				return [
					t ? ((i - 1 + aa((1 - i) * (1 - i) + 4 * n)) / (2 * t)) * Jo : 0,
					ga(function (t) {
						return i * (Uo * Zo(t) - 2 * t) * Uo + 4 * t * t * (e - Zo(t)) + 2 * Uo * t - r * e;
					}, 0)
				];
			};
			var lu = 1.0148,
			...
			function yu(t, e) {
				var n = e * e;
				return [t, e * (lu + n * n * (hu + n * (pu + fu * n)))];
			}
			yu.invert = function (t, e) {
				...
				do {
					var r = i * i;
					i -= n =
						(i * (lu + r * r * (hu + r * (pu + fu * r))) - e) / (du + r * r * (gu + r * (vu + mu * r)));
				} while (Do(n) > Xo);
				return [t, i];
			};
			function bu(t, e) {
				if (Do(e) < Xo) return [t, 0];
				var n = qo(e),
					i = t * Zo(e);
				return [Zo(i) / n, e + (1 - Fo(i)) / n];
			}
			bu.invert = function (t, e) {
				...
				return (a = qo(r)), [(Do(e) < Do(r + 1 / a) ? ra(t * a) : Ho(t) * (oa(Do(t * a)) + Jo)) / Zo(r), r];
			};
			var Pu = [
					[0, 90],
					[-90, 0],
			...
			function xu(t, e) {
				var n,
					...
					h = n[1];
				return [
					t * (s + (o * (l - a)) / 2 + (o * o * (l - 2 * s + a)) / 2),
					(e > 0 ? Jo : -Jo) * (c + (o * (h - u)) / 2 + (o * o * (h - 2 * c + u)) / 2)
				];
			}
			Mu.forEach(function (t) {
				...
				(xu.invert = function (t, e) {
					...
					var v = Mu[o][0],
						m = Mu[o + 1][0],
						y = Mu[Bo(19, o + 2)][0];
					return [t / (m + (f * (y - v)) / 2 + (f * f * (y - 2 * m + v)) / 2), i * ia];
				});
			function ju(t, e) {
				var n = qo(e / 2),
					i = Zo(Ko * n);
				return [t * (0.74482 - 0.34588 * i * i), 1.70711 * n];
			}
			ju.invert = function (t, e) {
				var n = e / 1.70711,
					i = Zo(Ko * n);
				return [t / (0.74482 - 0.34588 * i * i), 2 * No(n)];
			};
			function Ou(t, e) {
				if (Do(e) < Xo) return [t, 0];
				var n = Do(e / Jo),
					i = ra(n);
				if (Do(t) < Xo || Do(Do(e) - Jo) < Xo) return [0, Ho(e) * Uo * qo(i / 2)];
				var r = Fo(i),
					o = Do(Uo / t - t / Uo) / 2,
					a = o * o,
					u = r / (n + r - 1),
					...
					p = a + u;
				return [
					(Ho(t) * Uo * (o * h + aa(a * h * h - l * (u * u - c)))) / l,
					(Ho(e) * Uo * (s * p - o * aa((a + 1) * l - p * p))) / l
				];
			}
			Ou.invert = function (t, e) {
				if (Do(e) < Xo) return [t, 0];
				if (Do(t) < Xo) return [0, Jo * Zo(2 * No(e / Uo))];
				var n = (t /= Uo) * t,
					i = (e /= Uo) * e,
					r = n + i,
					o = r * r,
					...
					p = oa((3 * c) / (l * h)) / 3;
				return [
					(Uo * (r - 1 + aa(1 + 2 * (n - i) + o))) / (2 * t),
					Ho(e) * Uo * (-h * Fo(p + Uo / 3) - u / (3 * s))
				];
			};
			function wu(t, e) {
				if (Do(e) < Xo) return [t, 0];
				...
				var r = Fo(i),
					o = Do(Uo / t - t / Uo) / 2,
					a = o * o,
					u = (r * (aa(1 + a) - o * r)) / (1 + a * n * n);
				return [Ho(t) * Uo * u, Ho(e) * Uo * aa(1 - u * (2 * o + u))];
			}
			wu.invert = function (t, e) {
				if (!t) return [0, Jo * Zo(2 * No(e / Uo))];
				var n = Do(t / Uo),
					i = (1 - n * n - (e /= Uo) * e) / (2 * n),
					r = aa(i * i + 1);
				return [
					Ho(t) * Uo * (r - i),
					Ho(e) * Jo * Zo(2 * zo(aa((1 - 2 * i * n) * (i + r) - n), aa(r + i + n)))
				];
			};
			function Lu(t, e) {
				if (Do(e) < Xo) return [t, 0];
				var n = e / Jo,
					i = ra(n);
				if (Do(t) < Xo || Do(Do(e) - Jo) < Xo) return [0, Uo * qo(i / 2)];
				var r = (Uo / t - t / Uo) / 2,
					o = n / (1 + Fo(i));
				return [Uo * (Ho(t) * aa(r * r + 1 - o * o) - r), Uo * o];
			}
			Lu.invert = function (t, e) {
				if (!e) return [t, 0];
				var n = e / Uo,
					i = (Uo * Uo * (1 - n * n) - t * t) / (2 * Uo * t);
				return [t ? Uo * (Ho(t) * aa(i * i + 1) - i) : 0, Jo * Zo(2 * No(n))];
			};
			function Cu(t, e) {
				if (!e) return [t, 0];
				var n = Do(e);
				if (!t || n === Jo) return [0, e];
				var i = n / Jo,
					r = i * i,
					...
					l = t / Jo,
					h = l + 1 / l,
					p = Ho(Do(t) - Jo) * aa(h * h - 4),
					f = p * p,
					d =
						(p * (s + a - 1) +
							2 * aa(s * (r + a * f - 1) + (1 - r) * (r * (c * c + 4 * a) + 12 * u * a + 4 * a * a))) /
						(4 * s + f);
				return [Ho(t) * Jo * d, Ho(e) * Jo * aa(1 + p * Do(d) - d * d)];
			}
			Cu.invert = function (t, e) {
				var n;
				if (!t || !e) return [t, e];
				...
				do {
					var s = a * a,
						...
						v =
							...
							(4 * p * h +
								(1 - 4 * s + 3 * s * s) * (1 + l) +
								h * (14 * s - 6 - o + (8 * s - 8 - 2 * o) * l) +
								p * (12 * s - 8 + (10 * s - 10 - o) * l)),
						m = aa(d * (s + h * o - 1) + (1 - s) * (s * (g * g + 4 * h) + h * (12 * p + 4 * h)));
					a -= n =
						(r * (d + h - 1) + 2 * m - i * (4 * d + o)) /
						(r * (2 * c * l + 2 * f * (1 + l)) +
							v / m -
							(8 * f * (r * (-1 + h + d) + 2 * m) * (1 + l)) / (o + 4 * d));
				} while (n > Xo && --u > 0);
				return [(Ho(t) * (aa(r * r + 4) + r) * Uo) / 4, Jo * a];
			};
			var Eu = 4 * Uo + 3 * aa(3),
				Iu = 2 * aa((2 * Uo * aa(3)) / Eu);
			ma((Iu * aa(3)) / Uo, Iu, Eu / 6);
			function Tu(t, e) {
				return [t * aa(1 - (3 * e * e) / (Uo * Uo)), e];
			}
			Tu.invert = function (t, e) {
				return [t / aa(1 - (3 * e * e) / (Uo * Uo)), e];
			};
			function Gu(t, e) {
				var n = Fo(e),
					i = Fo(t) * n,
					r = 1 - i,
					o = Fo((t = zo(Zo(t) * n, -Zo(e)))),
					a = Zo(t);
				return [a * (n = aa(1 - i * i)) - o * r, -o * n - a * r];
			}
			Gu.invert = function (t, e) {
				var n = (t * t + e * e) / -2,
					...
					o = t * n - e * i,
					a = aa(o * o + r * r);
				return [zo(i * r, a * (1 + n)), a ? -ra((i * o) / a) : 0];
			};
			function Du(t, e) {
				var n = ca(t, e);
				return [(n[0] + t / Jo) / 2, (n[1] + e) / 2];
			}
			Du.invert = function (t, e) {
				...
				do {
					var o,
						...
						d = f * f,
						g = 1 - l * p * p,
						v = g ? oa(a * p) * aa((o = 1 / g)) : (o = 0),
						m = 0.5 * (2 * v * a * f + n / Jo) - t,
						y = 0.5 * (v * u + i) - e,
						b = 0.5 * o * (l * d + v * a * p * c) + 0.5 / Jo,
						P = o * ((h * s) / 4 - v * u * f),
						S = 0.125 * o * (s * f - v * u * l * h),
						_ = 0.5 * o * (c * p + v * d * a) + 0.5,
						M = P * S - _ * b,
						x = (y * P - m * _) / M,
						j = (m * S - y * b) / M;
					(n -= x), (i -= j);
			...
			var Nu = (function (t) {
				function e() {
					var e = t.call(this) || this;
					return (e.d3Projection = eu()), e;
				}
				return Object(c.c)(e, t), e;
			})(Ur);
			d.c.registeredClasses.Miller = Nu;
			var zu = (function (t) {
				function e() {
					var e = t.call(this) || this;
					return (e.d3Projection = Ga()), e;
				}
				return Object(c.c)(e, t), e;
			})(Ur);
			d.c.registeredClasses.Eckert6 = zu;
			var Fu = (function (t) {
				function e() {
					var e = t.call(this) || this;
			...
			d.c.registeredClasses.Stereographic = Vu;
			var Au = (function (t) {
				function e() {
					var e = t.call(this) || this;
					return (e.d3Projection = ki()), e;
				}
				return Object(c.c)(e, t), e;
			})(Ur);
			d.c.registeredClasses.Albers = Au;
			var Ru = (function (t) {
				function e() {
					var e = t.call(this) || this;
					return (e.d3Projection = Bi()), e;
				}
				return Object(c.c)(e, t), e;
			})(Ur);
			d.c.registeredClasses.AlbersUsa = Ru;
			var ku = (function (t) {
				function e() {
					var e = t.call(this) || this;
			...
			d.c.registeredClasses.NaturalEarth1 = ku;
			var Bu = (function (t) {
				function e() {
					var e = t.call(this) || this;
			...
			d.c.registeredClasses.AzimuthalEqualArea = Bu;
			var Wu = (function (t) {
				function e() {
					var e = t.call(this) || this;
					return (e.d3Projection = hr()), e;
				}
				return Object(c.c)(e, t), e;
			})(Ur);
			(d.c.registeredClasses.EqualEarth = Wu), (window.am4maps = a);
		},
		QaCB: function (t, e, n) {
			'use strict';
			function i(t, e) {
		...
		U8r1: function (t, e, n) {
			...
			function r(t, e, n) {
				...
				var p = s - r,
					...
					v = new i(null, o);
				if (0 === d) return [r, u];
				for (var m = r; m < s; m += d) for (var y = u; y < c; y += d) v.push(new a(m + g, y + g, g, t));
				var b = (function (t) {
				...
				for (var S = v.length; v.length; ) {
					var _ = v.pop();
					_.d > b.d &&
						((b = _), n && console.log('found best %d after %d probes', Math.round(1e4 * _.d) / 1e4, S)),
						_.max - b.d <= e ||
							((g = _.h / 2),
							v.push(new a(_.x - g, _.y - g, g, t)),
							v.push(new a(_.x + g, _.y - g, g, t)),
							v.push(new a(_.x - g, _.y + g, g, t)),
							v.push(new a(_.x + g, _.y + g, g, t)),
							(S += 4));
