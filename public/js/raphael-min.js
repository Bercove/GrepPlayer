	...
	(function (a, b) {
			...
			if (i) {
				if (j) (j.initstatus = f), (j.start = new Date() - j.ms * f);
					...
					if (
						...
						ic.push(u),
						f && !j && !k && ((u.stop = !0), (u.start = new Date() - p * f), 1 == ic.length))
					)
						return kc();
		...
		var ub = function (a) {
				if (c.vml) {
					...
					(i.title = 'Raphaël Colour Picker'),
						...
						(ub = f(function (a) {
							return (
								(i.style.color = a), A.doc.defaultView.getComputedStyle(i, G).getPropertyValue('color')
							);
						}));
				}
				return ub(a);
		...
		(c.color = function (a) {
			...
			(c.getColor = function (a) {
				...
				return (
					(b.h += 0.075),
					b.h > 1 && ((b.h = 0), (b.s -= 0.2), b.s <= 0 && (this.getColor.start = { h: 0, s: 1, b: b.b })),
					c.hex
				);
			}),
					...
					e.length ||
						I(a).replace(hb, function (a, b, c) {
							...
							if (
								...
								'm' == g &&
									f.length > 2 &&
									(e.push([b][E](f.splice(0, 2))), (g = 'l'), (b = 'm' == b ? 'l' : 'L')),
								'r' == g)
							)
								e.push([b][E](f));
		...
		var Bb = (c.pathBBox = function (a) {
			...
			Mb =
				...
				(c._toback = function (a, b) {
					b.bottom !== a &&
						(Lb(a, b), (a.next = b.bottom), (a.prev = null), (b.bottom.prev = a), (b.bottom = a));
				}),
						...
						for (var l = 0, m = d.length; m > l; l++) {
							...
							't' == v && 3 == u
								...
								? 2 == u
									...
									: 4 == u &&
									  (w
											? ((q = x.x(t[2], t[3])), (r = x.y(t[2], t[3])), k.rotate(t[1], q, r))
					...
					return A.doc.addEventListener
						? function (a, b, c, d) {
								...
								if ((a.addEventListener(b, e, !1), F && L[b])) {
									var f = function (b) {
										for (
											var e = Vb(b), f = b, g = 0, h = b.targetTouches && b.targetTouches.length;
											h > g;
											g++
										)
		...
		($b.drag = function (a, d, e, f, g, h) {
			...
			($b.undrag = function () {
				for (var a = ac.length; a--; )
					ac[a].el == this &&
						(this.unmousedown(ac[a].start), ac.splice(a, 1), b.unbind('raphael.drag.*.' + this.id));
			...
			($b.getBBox = function (a) {
				...
				return a
					...
					: ((b.dirty || b.dirtyT || !b.bbox) &&
							((b.dirty || !this.realPath) && ((b.bboxwt = 0), (this.realPath = qb[this.type](this))),
							...
							if ('path' == d.type) {
								...
								if (
									...
									f
										...
										: ((g = E * u), (h = c.getTotalLength(t.path) - (d._.arrows.enddx * u || 0))),
										(k = {}),
										(k['marker-' + r] = 'url(#' + B + ')'),
									...
									f
										...
										: ((g = 0), (h = c.getTotalLength(t.path) - (d._.arrows.enddx * u || 0))),
										d._.arrows[r + 'Path'] && q(s, { d: c.getSubpath(t.path, g, h) }),
							...
							for (var o in f)
								if (f[a](o)) {
									...
									switch (((k[o] = p), o)) {
										...
										case 'path':
											'path' == d.type &&
												(q(i, { d: p ? (k.path = c._pathToAbsolute(p)) : 'M0,0' }),
												(d._.dirty = 1),
												d._.arrows &&
										...
										case 'stroke':
											...
											break;
										case 'gradient':
											('circle' == d.type || 'ellipse' == d.type || 'r' != b(p).charAt()) &&
												r(d, p);
											break;
										case 'opacity':
											k.gradient &&
					...
					(z.prototype = A),
						...
						(A.blur = function (a) {
							...
							if (0 !== +a) {
								...
								b._blur &&
									(b._blur.parentNode.removeChild(b._blur), delete b._blur, delete b.attrs.blur),
						...
						B = function (e, i) {
							...
							if (
								...
								((i.path && 'path' == e.type) || q) &&
									((l.path = x(
										~b(m.path).toLowerCase().indexOf('r') ? c._pathToAbsolute(m.path) : m.path
									)),
									'image' == e.type &&
										((e._.fillpos = [m.x, m.y]),
					...
					(D.prototype = E),
						...
						(E.rotate = function (a, c, e) {
							...
							if (null != a) {
								...
								return (
									(this._.dirtyT = 1), this.transform(this._.transform.concat([['r', a, c, e]])), this
								);
							}
						}),
