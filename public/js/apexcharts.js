				...
				a(
					...
					[
						...
						},
						{
							...
							value: function (t) {
								for (
									var e = '', i = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz', a = 0;
									a < t;
									a++
								)
						...
						},
						{
							...
							value: function (t) {
								...
								y &&
									...
									M.attr({ pathTo: n, pathFrom: s });
								var X = { el: M, j: i, pathFrom: s, pathTo: n, strokeWidth: l };
								return (
	...
	var x = {
								...
								var g = 'top' === t.label.position ? -3 : a.globals.gridHeight,
									...
									x = this.graphics.drawText({
										...
										y:
											g +
											t.label.offsetY -
											('top' === t.label.position ? f.width / 2 - 12 : -f.width / 2),
										text: o,
				...
				a(t, [
					...
					},
					{
						...
						value: function (t, e) {
							...
							e = (e = (e = (e = e.replace(/(^|[^\\])HH+/g, '$1' + h(f))).replace(
								/(^|[^\\])H/g,
								'$1' + f
							)).replace(/(^|[^\\])hh+/g, '$1' + h(p))).replace(/(^|[^\\])h/g, '$1' + p);
							...
							return (e = (e = (e = (e = (e = e.replace(new RegExp(o[0], 'g'), o[S])).replace(
								new RegExp(l[0], 'g'),
								l[S]
							)).replace(new RegExp(n[0], 'g'), n[u])).replace(new RegExp(r[0], 'g'), r[u])).replace(
								/\\(.)/g,
								'$1'
							));
						}
									...
									tooltip: {
										...
										custom: function (t) {
											...
											s &&
												...
												((o = s),
												(l = n),
												r.config.series[i].data[a].x && (h = r.config.series[i].data[a].x));
											var c = '',
												d = '',
												u = r.globals.colors[i];
											if (void 0 === r.config.tooltip.x.formatter)
												if ('datetime' === r.config.xaxis.type) {
													var g = new v(e);
													(c = g.formatDate(new Date(o), r.config.tooltip.x.format, !0, !0)),
														(d = g.formatDate(
															new Date(l),
												...
												(c = r.config.tooltip.x.formatter(o)),
													(d = r.config.tooltip.x.formatter(l));
											return (
												'<div class="apexcharts-tooltip-rangebar"><div> <span class="series-name" style="color: ' +
												u +
												'">' +
												(r.config.series[i].name ? r.config.series[i].name : '') +
					...
					[
						{
							...
							value: function (t) {
								(t.xaxis.type = 'numeric'),
									...
									(t.chart = t.chart || {}),
									(t.chart.zoom =
										t.chart.zoom || (window.Apex.chart && window.Apex.chart.zoom) || {});
						...
						value: function () {
							...
							(this.chartType = e.chart.type),
								'histogram' === this.chartType &&
									((e.chart.type = 'bar'),
									(e = u.extend({ plotOptions: { bar: { columnWidth: '99.99%' } } }, e))),
					...
					},
					{
						...
						value: function (t, e) {
							...
							return {
								...
								class: t,
								pointStrokeOpacity:
									r.strokeOpacity instanceof Array ? r.strokeOpacity[e] : r.strokeOpacity,
							...
							if (
								...
								for (var c = 0; c < r.x.length; c++) {
									...
									var b = r.x[c],
										m = r.y[c];
									if (
										((g = g || 0), (null !== m && void 0 !== a.globals.series[n][d]) || (u = !1), u)
									) {
							...
							if (o.globals.dataChanged)
								if (this.dynamicAnim) {
									...
									for (var T = 0; T < o.globals.collapsedSeries.length; T++)
										o.globals.collapsedSeries[T].index === s && ((z = 1), (a = 0));
									0 === t && 0 === e && (a = 0),
										h.animateCircle(
											v,
											{ cx: k, cy: A, r: S },
						...
						value: function (t, e, i) {
							...
							for (var d = 0; d < t.x.length; d++)
								if (
									...
									'bottom' === a &&
										(l = l + 2 * s.globals.markers.size[e] + 1.4 * parseInt(r.style.fontSize)),
									!isNaN(o))
								) {
						...
						value: function (t) {
							...
							if (
								...
								u && (f = this.dataLabelsCorrection(a, s, o, n, r, d, parseInt(c.style.fontSize))),
									...
									f.textRects &&
										(a + f.textRects.width < 10 || a > e.globals.gridWidth + 10) &&
										(o = '');
								var x = e.globals.dataLabels.style.colors[n];
								if (
									(('bar' !== e.config.chart.type && 'rangeBar' !== e.config.chart.type) ||
										!e.config.plotOptions.bar.distributed ||
										(x = e.globals.dataLabels.style.colors[r]),
									f.drawnextLabel)
								) {
									var b = i.drawText({
										width: 100,
									...
									if (
										(b.attr({ class: 'apexcharts-datalabel', cx: a, cy: s }), c.dropShadow.enabled)
									) {
										var m = c.dropShadow;
										new g(this.ctx).dropShadow(b, m);
									}
									h.add(b),
		...
		T = (function () {
			function t(i, a) {
				...
				(this.barOptions = s.config.plotOptions.bar),
					...
					(this.isNullValue = !1),
					(this.isTimelineBar =
						'datetime' === s.config.xaxis.type && s.globals.seriesRangeBarTimeline.length),
					(this.xyRatios = a),
					null !== this.xyRatios &&
				...
				a(t, [
						...
						value: function (t, e) {
							...
							for (var r = 0, o = 0; r < t.length; r++, o++) {
								...
								this.yRatio.length > 1 && (this.yaxisIndex = y),
									(this.isReversed =
										i.config.yaxis[this.yaxisIndex] && i.config.yaxis[this.yaxisIndex].reversed);
								...
								for (
									...
									this.isHorizontal
										...
										z > 0 && v.push(x + C / 2),
										m.push(b);
									var M = this.getPathFillColor(t, r, z, y);
									this.renderSeries({
										realIndex: y,
										pathFill: M,
										j: z,
					...
					},
					{
						...
						value: function (t) {
							...
							a ||
								...
								A.config.series[n].data[s] &&
									A.config.series[n].data[s].strokeColor &&
									(a = A.config.series[n].data[s].strokeColor),
							...
							L.attr('clip-path', 'url(#gridRectMask'.concat(A.globals.cuid, ')')),
								void 0 !== u &&
									void 0 !== f &&
									(L.attr('data-range-y1', u), L.attr('data-range-y2', f)),
								new g(this.ctx).setSelectionFilter(L, e, s),
								h.add(L);
							var P = this.calculateDataLabelsPos({
								x: c,
								y: d,
								y1: u,
								y2: f,
					...
					},
					{
						...
						value: function (t) {
							...
							for (var i = 0; i < t.length; i++)
								if (
									(t[i].length > 0 &&
										((this.seriesLen = this.seriesLen + 1), (this.totalItems += t[i].length)),
					...
					},
					{
						...
						value: function () {
							...
							return (
								this.isTimelineBar && (h = l.globals.labels.length),
								this.isHorizontal
									? ((s = (i = l.globals.gridHeight / h) / this.seriesLen),
									  l.globals.isXNumeric &&
											(s = (i = l.globals.gridHeight / this.totalItems) / this.seriesLen),
									...
									: ((n =
									  ...
									  l.globals.isXNumeric &&
											...
											(n = ((a / this.seriesLen) * parseInt(this.barOptions.columnWidth)) / 100) <
												1 && (n = 1)),
									  (r =
					...
					},
					{
						...
						value: function (t) {
							...
							d.globals.isXNumeric &&
								(l = (d.globals.seriesX[g][f] - d.globals.minX) / this.invertedXRatio - i);
					...
					},
					{
						...
						value: function (t) {
							var e = t.x,
								...
								f = this.w,
								x = new p(this.ctx),
								b = Array.isArray(this.strokeWidth) ? this.strokeWidth[o] : this.strokeWidth,
								m = e + parseFloat(c * u),
								v = i + parseFloat(h * u);
							f.globals.isXNumeric &&
								!f.globals.isBarHorizontal &&
								((m = e + parseFloat(c * (u + 1))), (v = i + parseFloat(h * (u + 1)) - b));
							var y = e,
								w = i,
								k = {},
								A = f.config.dataLabels,
								S = this.barOptions.dataLabels;
							void 0 !== d && this.isTimelineBar && ((v = d), (w = d));
							var C = A.offsetX,
								L = A.offsetY,
								P = { width: 0, height: 0 };
							return (
								f.config.dataLabels.enabled &&
									(P = x.getTextRects(
										f.globals.yLabelFormatters[0](f.globals.maxY),
								...
								g.attr({ cy: k.bcy, cx: k.bcx, j: r, val: l[n][r], barHeight: h, barWidth: c }),
								this.drawCalculatedDataLabels({
									x: k.dataLabelsX,
									y: k.dataLabelsY,
									val: this.isTimelineBar ? [a, s] : l[n][r],
									i: o,
									j: r,
									barWidth: c,
									barHeight: h,
						...
						value: function (t) {
							...
							return (
								i.config.chart.stacked ||
									(c < 0
										? (c = 0 + u)
										: c + h.height / 3 > i.globals.gridHeight && (c = i.globals.gridHeight - u)),
					...
					},
					{
						...
						value: function (t) {
							var e = this.w,
								...
								p = n - (this.isTimelineBar ? 0 : f) + r / 2 + l.height / 2 + g - 3,
								x = this.series[a][s] <= 0;
							...
							return (
								...
								{ bcx: i, bcy: n, dataLabelsX: h, dataLabelsY: p }
							);
						}
					},
					{
						...
						value: function (t) {
							...
							if (c.enabled && !m) {
								...
								if (
									...
									this.isTimelineBar && this.barOptions.dataLabels.hideOverflowingLabels)
								)
								...
								d.config.chart.stacked &&
									...
									(this.isHorizontal
										? (((h = this.series[s][n] / this.yRatio[this.yaxisIndex]) > 0 &&
												o.width / 1.6 > h) ||
												(h < 0 && o.width / 1.6 < h)) &&
										  (v = '')
								...
								if (void 0 !== i[a][s] || null !== i[a][s]) {
									...
									switch (
										...
										t.config.chart.stacked ||
											('rounded' === this.barOptions.endingShape && (o = e.x - h / 2)),
						...
						value: function (t, e) {
							...
							for (
								...
								for (var E = 0; E < i.globals.dataPoints; E++) {
									...
									this.isHorizontal
										? ((M = this.drawBarPaths({
												indexes: { i: l, j: E, realIndex: y, bc: h },
												barHeight: L,
												strokeWidth: S,
												pathTo: c,
												pathFrom: d,
										  ...
										  (P = this.series[l][E] / this.invertedYRatio))
										...
										m.push(r),
										v.push(o);
									var I = this.bar.getPathFillColor(t, l, E, y);
									k = this.renderSeries({
										realIndex: y,
										pathFill: I,
										j: E,
							...
							for (
								...
								for (
									...
									(d = M.pathTo),
										...
										z > 0 && m.push(f + A / 2),
										b.push(x);
									var I = s.fillPath({ seriesNumber: v, color: E, value: t[o][z] }),
					...
					},
					{
						...
						value: function (t) {
							...
							h.globals.isXNumeric &&
								(i = (h.globals.seriesX[m][u] - h.globals.minX) / this.xRatio - r / 2);
			...
			function t(i) {
				...
				(this.lineColorArr = void 0 !== a.globals.stroke.colors ? a.globals.stroke.colors : a.globals.colors),
					...
					(a.globals.radialSize =
						this.defaultSize / 2.05 - a.config.stroke.width - a.config.chart.dropShadow.blur),
							...
							for (var d = 0; d < t.length; d++) {
								...
								if (
									...
									if (0 !== x && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
										...
										void 0 !== P &&
											(L = P(i.globals.seriesPercent[d][0], { seriesIndex: d, w: i }));
							...
							if (
								(n
									...
									: 1 === i.globals.series.length &&
									  ((d = c(i.globals.series[0], i)), (u = i.globals.seriesNames[0])),
								t.name.show)
							) {
								var g = a.drawText({
									x: l,
										...
										if (n.globals.selectedDataPoints[0].length > 0) {
											var h = n.globals.selectedDataPoints[0],
												c = n.globals.dom.baseEl.querySelector(
													'.apexcharts-'
														.concat(n.config.chart.type.toLowerCase(), '-slice-')
														.concat(h)
												);
		...
		F = (function () {
			function t(i) {
				...
				(this.graphics = new p(this.ctx)),
					(this.lineColorArr =
						void 0 !== a.globals.stroke.colors ? a.globals.stroke.colors : a.globals.colors),
					(this.defaultSize =
						a.globals.svgHeight < a.globals.svgWidth ? a.globals.svgHeight - 35 : a.globals.gridWidth),
				...
				(this.size =
					this.defaultSize / 2.1 - a.config.stroke.width - a.config.chart.dropShadow.blur - n.width / 1.75),
		...
		R = (function (t) {
			function i(t) {
				...
				return (
					...
					(a.fullAngle =
						360 - s.config.plotOptions.radialBar.endAngle - s.config.plotOptions.radialBar.startAngle),
				...
				a(i, [
					{
						...
						value: function (t) {
							...
							e.config.plotOptions.radialBar.startAngle < 0 &&
								(d = Math.abs(
									e.config.plotOptions.radialBar.endAngle - e.config.plotOptions.radialBar.startAngle
								));
							var u = (360 - d) / 360;
					...
					},
					{
						...
						value: function (t) {
							...
							for (var m = b ? t.series.length - 1 : 0; b ? m >= 0 : m < t.series.length; b ? m-- : m++) {
								...
								if (
									(p.setAttrs(E.node, { 'data:angle': z, 'data:value': t.series[m] }),
									e.config.chart.dropShadow.enabled)
								) {
									var M = e.config.chart.dropShadow;
									s.dropShadow(E, M, m);
								}
								this.addListeners(E, this.radialDataLabels), v.add(E), E.attr({ index: 0, j: m });
								var I = 0;
								!this.initialAnim ||
									e.globals.resized ||
									e.globals.dataChanged ||
					...
					},
					{
						...
						value: function (t) {
							var e = this.w;
							return (
								(t.size * (100 - parseInt(e.config.plotOptions.radialBar.hollow.size))) /
									100 /
									(t.series.length + 1) -
								this.margin
							);
				...
				a(i, [
					{
						...
						value: function (t, e) {
							...
							(this.rangeBarOptions = this.w.config.plotOptions.rangeBar),
								...
								this.initVariables(t);
							for (
								var n = a.group({ class: 'apexcharts-rangebar-series apexcharts-plot-series' }),
									r = 0,
									o = 0;
								r < t.length;
								r++, o++
									...
									(this.isNullValue = !1),
										...
										i.config.stroke.show &&
											(y = this.isNullValue
												...
												: this.strokeWidth);
									var z = 1,
										T = this.seriesRangeStart[r][L],
										E = this.seriesRangeEnd[r][L],
										M =
											i.globals.seriesRangeBarTimeline.length &&
											i.globals.seriesRangeBarTimeline[r][L];
									M && ((z = M.y.length), (b = 0));
									for (var I = 0; I < z; I++) {
										var X = null,
											Y = null;
										if (this.isHorizontal) {
											if (((Y = b + w * this.visibleI), M)) {
												var F = (h - w * this.seriesLen) / 2,
													R = M.y[I];
												(T = R.y1), (E = R.y2);
												var D = i.globals.labels.indexOf(M.x);
												Y = F + w * this.visibleI + h * D;
											} else if (this.isTimelineBar) break;
											k = (X = this.drawRangeBarPaths({
										...
										(g = X.pathTo), (f = X.pathFrom), (b = X.y), (x = X.x);
										var O = null;
										i.config.series[r].data[L] &&
											i.config.series[r].data[L].fillColor &&
											(O = i.config.series[r].data[L].fillColor);
										var N = s.fillPath({ seriesNumber: m, color: O }),
											H = i.globals.stroke.colors[m];
										this.renderSeries({
											realIndex: m,
											pathFill: N,
											lineFill: H,
					...
					},
					{
						...
						value: function (t) {
							...
							h.globals.isXNumeric &&
								(i = (h.globals.seriesX[d][u] - h.globals.minX) / this.xRatio - o / 2);
							var v = i + o * this.visibleI;
							void 0 === this.series[d][u] || null === this.series[d][u]
								? (b = l)
								: ((b = l - b / g), (m = l - m / g));
					...
					},
					{
						...
						value: function (t) {
							var e,
								...
								x = (a.i, a.j),
								b = a.realIndex;
							(e = u + n / this.invertedYRatio),
								(i = u + r / this.invertedYRatio),
								f.move(u, d),
								(h = f.move(u, d)),
								g.globals.previousPaths.length > 0 && (h = this.getPathFrom(b, x));
							var m = Math.abs(i - e);
							return (
								(l = f.move(e, d) + f.line(i, d) + f.line(i, d + c) + f.line(e, d + c) + f.line(e, d)),
								(h = h + f.line(e, d) + f.line(e, d + c) + f.line(e, d + c) + f.line(e, d)),
								g.globals.isXNumeric || (s += o),
								{ pathTo: l, pathFrom: h, barWidth: m, x: i, y: s }
							);
						}
					},
					{
								...
								if (void 0 !== a.labels.align) {
									...
									'left' === a.labels.align
										? (n.forEach(function (t, e) {
										  ...
										  a.opposite ||
												s.setAttribute('transform', 'translate(-'.concat(r.width, ', 0)')))
										...
										? (n.forEach(function (t, e) {
										  ...
										  s.setAttribute(
												'transform',
												'translate('.concat((r.width / 2) * (a.opposite ? 1 : -1), ', 0)')
										  ))
				...
				a(t, [
					{
						...
						value: function () {
							...
							e.axisCharts ? this.setGridCoordsForAxisCharts(i) : this.setGridCoordsForNonAxisCharts(i),
								...
								(e.gridHeight =
									e.gridHeight - t.config.grid.padding.top - t.config.grid.padding.bottom),
								(e.gridWidth =
									e.gridWidth -
					...
					},
					{
						...
						value: function (t, e) {
							...
							(this.xAxisHeight = (t.height + e.height) * i.globals.LINE_HEIGHT_RATIO + 15),
								...
								i.globals.isBarHorizontal
									? (this.yAxisWidth =
											i.globals.yLabelsCoords[0].width + i.globals.yTitleCoords[0].width + 15)
								...
								case 'bottom':
									(i.translateY = h),
										...
										(i.gridHeight =
											...
											t.height -
											l -
											(this.isSparkline ? 0 : e.globals.rotateXLabels ? 10 : 15)),
								...
								i.config.yaxis.forEach(function (s, n) {
									...
									(!s.show ||
										...
										((!i.globals.isBarHorizontal &&
											...
											(function (t) {
												e.timescaleLabels
													? e.timescaleLabels[e.timescaleLabels.length - 1].position +
															t.width >
													  i.globals.gridWidth
					...
					},
					{
						...
						value: function () {
							...
							(this.timescaleLabels = e.globals.timelineLabels.slice()),
								e.globals.invertedTimelineLabels.length &&
							...
							return (
								1.05 *
									(t = new p(this.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize)).width *
									i.length >
									e.globals.gridWidth &&
					...
					},
					{
						...
						value: function () {
							...
							if (
								...
								(a += e.offsetX),
								(s = s + parseInt(e.style.fontSize) + 2 + e.offsetY),
						...
						value: function (t, e, i) {
							...
							for (
								...
								var S = [],
									...
									E = T;
								T > a.globals.gridHeight && (E = a.globals.gridHeight), (m = k / 2);
								var M = a.globals.padHorizontal + m,
									I = 1;
								a.globals.isXNumeric &&
									a.globals.seriesX.length > 0 &&
									(M = (a.globals.seriesX[A][0] - a.globals.minX) / g),
									P.push(M);
								var X = void 0,
									Y = void 0,
									F = void 0,
								...
								N.attr({ 'data:longestSeries': B, rel: v + 1, 'data:realIndex': A }),
								...
								if (
									...
									for (var q = 0; q < t[v].length; q++)
										if (null !== t[v][q]) {
											(_ = k * q),
												(j = T - t[v][q] / c[this.yaxisIndex]),
												(X = s.move(_, j)),
												(Y = s.move(_, E));
											break;
										}
								} else (X = s.move(_, j)), (Y = s.move(_, E) + s.line(_, j));
								if (
									((F = s.move(-1, T) + s.line(-1, T)),
									(R = s.move(-1, T) + s.line(-1, T)),
								...
								for (
									var $ = a.globals.dataPoints > 1 ? a.globals.dataPoints - 1 : a.globals.dataPoints,
										J = 0;
									J < $;
									J++
								) {
									...
									(O = tt.areaPaths),
										...
										(Y = tt.areaPath),
										(X = tt.linePath),
										this.appendPathFrom && ((F += s.line(M, T)), (R += s.line(M, T)));
					...
					},
					{
						...
						value: function (t) {
							...
							if (
								...
								null === e[i][a + 1] &&
									((c += b.move(s, n)), (d = d + b.line(s - l, h) + b.move(s, n))),
									...
									a === e[i].length - 2 &&
										((d = d + b.line(s, h) + b.move(s, n) + 'z'), u.push(c), g.push(d));
						...
						value: function (t) {
							...
							if (0 === r) {
								...
								c.globals.isXNumeric &&
									(f = (c.globals.seriesX[i][0] - c.globals.minX) / h + c.config.markers.offsetX),
									d.push(f),
							...
							if (void 0 !== a.config.yaxis[0].title.text) {
								var b = s.group({
									...
									m = s.drawText({
										...
										cssClass:
											'apexcharts-yaxis-title-text ' + a.config.yaxis[0].title.style.cssClass
									});
								b.add(m), r.add(b);
							}
				...
				a(t, [
					{
						...
						value: function (t, e, i) {
							...
							return (
								o[o.length - 2] >= e && o.pop(), { result: o, niceMin: o[0], niceMax: o[o.length - 1] }
							);
						}
					},
					{
					...
					},
					{
						...
						value: function (t, e, i) {
							...
							var r = Math.abs(i - e);
							n.logarithmic && r <= 5 && (a.invalidLogScale = !0),
								n.logarithmic && r > 5
									...
									: i !== -Number.MAX_VALUE && u.isNumber(i)
									? ((a.allSeriesCollapsed = !1),
											  ...
											  r.forEach(function (t, e) {
													if (s[e] <= i.xaxis.max && s[e] >= i.xaxis.min) {
														...
														a.globals.series.forEach(function (i, a) {
															null !== t &&
																((n = Math.min(i[e], n)), (r = Math.max(i[e], r)));
														}),
															r > c && null !== r && (c = r),
															n < h && null !== n && (h = n);
													}
					...
					},
					{
						...
						value: function (t) {
							...
							'candlestick' === s.chart.type
								? ((h = n.seriesCandleL), (c = n.seriesCandleH))
								: n.isRangeData && ((h = n.seriesRangeStart), (c = n.seriesRangeEnd));
							for (var d = t; d < a; d++) {
								n.dataPoints = Math.max(n.dataPoints, l[d].length);
								for (var g = 0; g < n.series[d].length; g++) {
									var f = l[d][g];
									null !== f && u.isNumber(f)
										? ((r = Math.max(r, c[d][g])),
										  (e = Math.min(e, h[d][g])),
										  ...
										  'candlestick' === this.w.config.chart.type &&
												((r = Math.max(r, n.seriesCandleO[d][g])),
												(r = Math.max(r, n.seriesCandleH[d][g])),
												(r = Math.max(r, n.seriesCandleL[d][g])),
												(i = r = Math.max(r, n.seriesCandleC[d][g]))),
										  u.isFloat(f) &&
												((f = u.noExponents(f)),
				...
				a(t, [
					{
						...
						value: function (t, e) {
							...
							if (a.globals.allSeriesCollapsed)
								return (a.globals.labels = []), (a.globals.timelineLabels = []), [];
				...
				a(t, [
					{
						...
						value: function () {
							...
							(t.axisCharts =
								...
								(t.xyCharts =
									['line', 'area', 'bar', 'rangeBar', 'candlestick', 'scatter', 'bubble'].indexOf(i) >
									-1),
								(t.isBarHorizontal =
									('bar' === e.chart.type || 'rangeBar' === e.chart.type) &&
									e.plotOptions.bar.horizontal),
							...
							if (s.comboCharts) {
								...
								switch (a.chart.type) {
									...
									case 'area':
										...
										break;
									case 'bar':
										if (a.chart.stacked) b = new E(this.ctx, e).draw(s.series);
										else b = new T(this.ctx, e).draw(s.series);
										break;
									case 'candlestick':
						...
						value: function (t, e, i) {
							...
							if ('array' === t) {
								...
								for (
									var h = function (t) {
											var r = e[i].data[t].x,
												o = { y1: e[i].data[t].y[0], y2: e[i].data[t].y[1] },
												l = n.findIndex(function (t) {
													return t.x === r;
												});
											n[l].y.push(o), a.push(o.y1), s.push(o.y2);
										},
										c = 0;
									c < e[i].data.length;
									c++
							...
							for (
								...
								if (
									...
									this.isFormat2DArray()
										...
										('candlestick' !== i.chart.type && 'candlestick' !== t[n].type) ||
									...
									if ('datetime' === i.xaxis.type) {
										a.isXNumeric = !0;
										for (
											var r = i.labels.length > 0 ? i.labels.slice() : i.xaxis.categories.slice(),
												o = 0;
											o < r.length;
											o++
										)
								...
								i.forEach(function (e) {
									...
									(e.config.chart.events.selection = function (t, a) {
										i.forEach(function (t) {
											...
											i._updateOptions(
												{ xaxis: { min: a.xaxis.min, max: a.xaxis.max }, yaxis: s },
												!1,
												!1,
												!1,
												!1
		...
		lt = (function () {
			function t(i) {
				...
				(this.anim = new f(this.ctx)),
					...
					(this.isTimelineBar =
						'datetime' === a.config.xaxis.type && a.globals.seriesRangeBarTimeline.length),
					a.globals.timelineLabels.length > 0 && (this.xaxisLabels = a.globals.timelineLabels.slice()),
					a.globals.invertedTimelineLabels.length > 0 &&
						(this.xaxisLabels = a.globals.invertedTimelineLabels.slice());
			}
			return (
				a(t, [
					{
						...
						value: function () {
							...
							if (a.axisCharts) {
								if (t.config.grid.show)
									(s = this.renderGrid()), a.dom.elGraphical.add(s.el), this.drawGridArea(s.el);
								else {
					...
					},
					{
						...
						value: function () {
							...
							for (
								...
								(void 0 !== t.globals.yAxisScale[l] && (o = t.globals.yAxisScale[l].result.length - 1),
								!(o > 2));
								l++
							);
							if (!t.globals.isBarHorizontal || this.isTimelineBar) {
								if (
									...
									if (t.globals.timelineLabels.length || t.globals.invertedTimelineLabels.length)
										for (var u = 0; u < r; u++) {
											if (
												((c = this.xaxisLabels[u].position),
												(h = this.xaxisLabels[u].position),
												t.config.grid.xaxis.lines.show && c > 0 && c < t.globals.gridWidth)
											) {
												var g = e.drawLine(c, 0, h, d, t.config.grid.borderColor, i);
												g.node.classList.add('apexcharts-gridline'),
													n.add(g),
													this.animX &&
														this.animateLine(g, { x1: 0, x2: 0 }, { x1: c, x2: h });
											}
											var f = new _(this.ctx);
											(u === r - 1 && t.globals.skipLastTimelinelabel) || f.drawXaxisTicks(c, a);
										}
									else
										for (var x = r, b = 0; b < x; b++) {
											var m = x;
											if (
												(t.globals.isXNumeric && (m -= 1),
												(h = c += t.globals.gridWidth / m),
												b === m - 1)
											)
												break;
											if (t.config.grid.xaxis.lines.show) {
												var v = e.drawLine(c, 0, h, d, t.config.grid.borderColor, i);
												v.node.classList.add('apexcharts-gridline'),
													n.add(v),
													this.animX &&
														this.animateLine(v, { x1: 0, x2: 0 }, { x1: c, x2: h });
											}
								...
								if (t.config.grid.yaxis.lines.show) {
									var y = 0,
										w = 0,
										k = t.globals.gridWidth,
										A = o + 1;
									this.isTimelineBar && (A = t.globals.labels.length);
									for (var S = 0; S < A; S++) {
										var C = e.drawLine(0, y, k, w, t.config.grid.borderColor, i);
										s.add(C),
											C.node.classList.add('apexcharts-gridline'),
											this.animY &&
												this.animateLine(C, { y1: y + 20, y2: w + 20 }, { y1: y, y2: w }),
											(w = y += t.globals.gridHeight / (this.isTimelineBar ? A : o));
									}
								}
							} else {
								if (((r = o), t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show))
									for (
										var L, P = t.globals.padHorizontal, z = t.globals.gridHeight, T = 0;
										T < r + 1 && ((L = P = P + t.globals.gridWidth / r + 0.3), T !== r - 1);
										T++
									) {
										if (t.config.grid.xaxis.lines.show) {
											var E = e.drawLine(P, 0, L, z, t.config.grid.borderColor, i);
											E.node.classList.add('apexcharts-gridline'),
												n.add(E),
												this.animX && this.animateLine(E, { x1: 0, x2: 0 }, { x1: P, x2: L });
										}
										new _(this.ctx).drawXaxisTicks(P, a);
									}
								if (t.config.grid.yaxis.lines.show)
									for (
										var M = 0, I = 0, X = t.globals.gridWidth, Y = 0;
										Y < t.globals.dataPoints + 1;
										Y++
									) {
										var F = e.drawLine(0, M, X, I, t.config.grid.borderColor, i);
										s.add(F),
											F.node.classList.add('apexcharts-gridline'),
											this.animY &&
												this.animateLine(F, { y1: M + 20, y2: I + 20 }, { y1: M, y2: I }),
											(I = M += t.globals.gridHeight / t.globals.dataPoints);
									}
							}
							return (
								this.isTimelineBar && (o = t.globals.labels.length),
					...
					},
					{
						...
						value: function (t, e, i) {
							...
							if (void 0 !== a.config.grid.row.colors && a.config.grid.row.colors.length > 0)
								for (
									var n = 0, r = a.globals.gridHeight / i, o = a.globals.gridWidth, l = 0, h = 0;
									l < i;
									l++, h++
								) {
				...
				a(t, [
					{
						...
						value: function (t) {
							...
							void 0 !== c.config.tooltip.custom
								? Array.isArray(c.config.tooltip.custom)
									? this.handleCustomTooltip({ i: n, j: o, y1: l, y2: h, isArray: !0 })
									: this.handleCustomTooltip({ i: n, j: o, y1: l, y2: h, isArray: !1 })
								: this.toggleActiveInactiveSeries(i);
							var d = this.getValuesToPrint({ i: n, j: o });
							this.printLabels({ i: n, j: o, values: d, ttItems: a, shared: i });
						...
						value: function (t) {
							...
							(f = a[i].children),
								l.config.tooltip.fillSeriesColor &&
									((a[i].style.backgroundColor = o), (f[0].style.display = 'none')),
								h.showTooltipTitle &&
									(null === h.tooltipTitle &&
										(h.tooltipTitle =
											l.globals.dom.baseEl.querySelector('.apexcharts-tooltip-title')),
							...
							null !== g) &&
								((a[i].querySelector('.apexcharts-tooltip-text-z-label').innerHTML =
									l.config.tooltip.z.title),
								(a[i].querySelector('.apexcharts-tooltip-text-z-value').innerHTML =
									void 0 !== g ? g : ''));
							r &&
								f[0] &&
					...
					},
					{
						...
						value: function (t) {
							...
							null === i
								...
								: a.globals.isXNumeric
								? ((n = s[e][i]),
								  0 === s[e].length && (n = s[this.tooltipUtil.getFirstActiveXArray(s)][i]))
					...
					},
					{
						...
						value: function (t) {
							var e = t.i,
								...
								l = r.config.tooltip.custom;
							n && l[e] && (l = r.config.tooltip.custom[e]),
								(o.innerHTML = l({
									ctx: this.ctx,
					...
					},
					{
						...
						value: function (t, e) {
							...
							(l = d.x),
								(h = d.y),
								isNaN(l) ||
									((l += a.globals.translateX), (n.style.left = l + 'px'), (n.style.top = h + 'px'));
						}
					},
					{
						key: 'positionChecks',
						...
						value: function (t) {
							...
							if (
								...
								(l =
									null !== h
										? h
										: a.globals.dom.baseEl.querySelectorAll('.apexcharts-series-markers circle'))
							)
								for (var c = 0; c < l.length; c++) {
									...
									if (d && d.length) {
										...
										var g = parseInt(
											l[c].parentNode.parentNode.parentNode.getAttribute('data:realIndex')
										);
										null !== u
					...
					},
					{
						...
						value: function (t) {
							for (
								...
								if (
									(void 0 === n &&
										(n = e.globals.markers.size[l] + e.config.markers.hover.sizeOffset),
									a === parseInt(o))
								) {
				...
				a(t, [
					...
					},
					{
						...
						value: function (t) {
							...
							if (
								(null === r.tooltip &&
									(r.tooltip = n.globals.dom.baseEl.querySelector('.apexcharts-tooltip')),
								...
								!r.fixedTooltip &&
									(!n.config.tooltip.shared || (n.globals.isBarHorizontal && r.hasBars())))
							) {
								var p = n.globals.isMultipleYAxis
									? n.config.yaxis[x] && n.config.yaxis[x].reversed
									: n.config.yaxis[0].reversed;
								p && (h = n.globals.gridWidth - h), (o.style.left = h + n.globals.translateX + 'px');
								var x = parseInt(s.paths.parentNode.getAttribute('data:realIndex'));
								!p ||
							...
							if (
								...
								a.globals.comboCharts && (r = parseInt(u.parentNode.getAttribute('data:realIndex'))),
									n.tooltipLabels.drawSeriesTexts({
										...
										i: r,
										j: s,
										y1: y ? parseInt(y) : null,
										y2: w ? parseInt(w) : null,
				...
				a(t, [
					...
					},
					{
						...
						value: function () {
							...
							if (
								((e.xcrosshairsWidth = parseInt(t.config.xaxis.crosshairs.width)),
								t.globals.comboCharts)
							) {
								...
								if (
									...
									if (
										...
										this.hasBars && this.intersect.handleBarTooltip({ e: s, opt: n }),
											this.hasMarkers &&
												this.intersect.handleMarkerTooltip({ e: s, opt: n, x: i, y: a });
						...
						value: function (t) {
							...
							if (
								...
								null === this.yaxisTTEls &&
									(this.yaxisTTEls =
										e.globals.dom.baseEl.querySelectorAll('.apexcharts-yaxistooltip'));
				...
				a(t, [
					...
					},
					{
						...
						value: function () {
							var t = this.w;
							if (
								!('datetime' === t.config.xaxis.type && new Date(t.globals.minX).getUTCFullYear() < 1e3)
							) {
										...
										i.globals.panEnabled
											? ((i.globals.selection = null),
											  a.w.globals.mousedown &&
													a.panDragging({ context: a, zoomtype: n, xyRatios: t }))
						...
						value: function (t) {
							...
							if (
								(a.config.yaxis.forEach(function (t, e) {
									d.push(a.globals.yAxisScale[e].niceMax - n.yRatio[e] * s.startY),
										g.push(a.globals.yAxisScale[e].niceMax - n.yRatio[e] * s.endY);
								}),
	...
	(nt = 'undefined' != typeof window ? window : void 0),
			...
			(a.PathArray = function (t, e) {
					...
					extend: {
						...
						dequeue: function () {
							return (
								...
								this.situation &&
									(this.situation instanceof a.Situation ? this.start() : this.situation.call(this)),
								this
							);
						},
				...
				a.extend(a.FX, {
					...
					viewbox: function (t, e, i, s) {
						return (
							this.target() instanceof a.Container && this.add('viewbox', new a.ViewBox(t, e, i, s)), this
						);
					},
					update: function (t) {
				...
				(a.Box = a.invent({
					create: function (e, i, s, n) {
						...
						4 == arguments.length && ((this.x = e), (this.y = i), (this.width = s), (this.height = n)),
							m(this);
					},
					extend: {
						merge: function (t) {
						...
						rotate: function (t, e, i) {
							return (
								...
								this.around(
									e,
									i,
									new a.Matrix(Math.cos(t), Math.sin(t), -Math.sin(t), Math.cos(t), 0, 0)
								)
							);
						},
						flip: function (t, e) {
				...
				a.extend(a.Element, {
					transform: function (e, i) {
						var s, n;
						if ('object' !== t(e))
							return (s = new a.Matrix(this).extract()), 'string' == typeof e ? s[e] : s;
					...
					create: function (e) {
						...
						if (e instanceof a.Element) {
							for (
								...
								(c *= n.value),
									(n = new a.Number(
										l instanceof a.Doc ? l.parent().offsetWidth : l.parent().width()
									)),
									(l = l.parent());
							for (; '%' == r.unit; )
								(d *= r.value),
									(r = new a.Number(
										h instanceof a.Doc ? h.parent().offsetHeight : h.parent().height()
									)),
									(h = h.parent());
							(this.x = 0),
								(this.y = 0),
				...
				a.extend(a.Element, {
					...
					front: function () {
						var t = this.parent();
						return (
							t.node.appendChild(this.node), t instanceof a.Doc && t.node.appendChild(t.defs().node), this
						);
					},
					back: function () {
				...
				(a.Line = a.invent({
					...
					extend: {
						...
						plot: function (t, e, i, s) {
							return null == t
								? this.array()
								: ((t = void 0 !== e ? { x1: t, y1: e, x2: i, y2: s } : new a.PointArray(t).toLine()),
								  this.attr(t));
						},
						move: function (t, e) {
				...
				(a.Tspan = a.invent({
					...
					extend: {
						...
						newLine: function () {
							...
							return (
								(this.dom.newLined = !0), this.dy(t.dom.leading * t.attr('font-size')).attr('x', t.x())
							);
						}
					}
				})),
					...
					for (var i = 0, a = ['moz', 'webkit'], s = 0; s < a.length && !e.requestAnimationFrame; ++s)
						(t.requestAnimationFrame = t[a[s] + 'RequestAnimationFrame']),
							(t.cancelAnimationFrame =
								t[a[s] + 'CancelAnimationFrame'] || t[a[s] + 'CancelRequestAnimationFrame']);
		...
		(function () {
			...
			function a(t) {
					...
					case 'A':
						t = (e = (function (t, e) {
							var i,
								...
								R = new SVG.Point(X, Y),
								D = [];
							if (0 === z || 0 === T || (F.x === R.x && F.y === R.y))
								return [['C', F.x, F.y, R.x, R.y, R.x, R.y]];
							(i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform(new SVG.Matrix().rotate(E))),
								(a = (i.x * i.x) / (z * z) + (i.y * i.y) / (T * T)) > 1 &&
									((a = Math.sqrt(a)), (z *= a), (T *= a));
							(s = new SVG.Matrix()
								.rotate(E)
								.scale(1 / z, 1 / T)
								.rotate(-E)),
							...
							for (
								b[0][0] = b[0][1].clone(),
									...
									s = new SVG.Matrix().rotate(E).scale(z, T).rotate(-E),
									k = 0,
									A = b.length;
								k < A;
								k++
				...
				return (
					(t[0] = 'C'), (this.pos = [t[5], t[6]]), (this.reflection = [2 * t[5] - t[3], 2 * t[6] - t[4]]), e
				);
			}
			function s(t, e) {
				if (!1 === e) return !1;
			...
			SVG.extend(SVG.PathArray, {
				morph: function (e) {
					...
					return (
						(this.value = i), (this.destination = new SVG.PathArray()), (this.destination.value = a), this
					);
				}
			});
		})(),
			...
			(t.prototype.init = function (t, e) {
				...
				(t.prototype.start = function (t) {
					if (
						...
						var e = this;
						if (
							(this.el.fire('beforedrag', { event: t, handler: this }), !this.el.event().defaultPrevented)
						) {
							t.preventDefault(),
								t.stopPropagation(),
				...
				(t.prototype.selectPoints = function (t) {
					return (
						...
						this.pointSelection.set
							? this
							: ((this.pointSelection.set = this.parent.set()), this.drawCircles(), this)
					);
				}),
						...
						},
						{
							...
							value: function () {
								var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
									...
									i = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2];
								return (
									this.resetSeries(!1), this.revertDefaultAxisMinMax(), this._updateSeries(t, e, i)
								);
							}
						},
						{
