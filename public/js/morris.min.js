	...
	(b = window.Morris = {}),
		...
		(b.Grid = (function (c) {
			function d(b) {
				...
				var c = this;
				if (
					((this.el = 'string' == typeof b.element ? a(document.getElementById(b.element)) : a(b.element)),
			...
			return (
					...
					if (this.options.grid !== !1 || (e = this.options.axes) === !0 || 'both' === e || 'y' === e) {
						for (f = this.grid, h = [], c = 0, d = f.length; d > c; c++)
							(a = f[c]),
								(b = this.transY(a)),
								((g = this.options.axes) === !0 || 'both' === g || 'y' === g) &&
									this.drawYAxisLabel(this.left - this.options.padding / 2, b, this.yAxisFormat(a)),
								this.options.grid
									? h.push(
											this.drawGridLine(
				...
				(d.prototype.resizeHandler = function () {
					return (
						(this.timeoutId = null), this.raphael.setSize(this.el.width(), this.el.height()), this.redraw()
					);
				}),
				d
			);
				...
				: ((c = a.match(/^(\d+) Q(\d)$/)),
				  ...
				  c
						...
						? i[6]
							? ((g = 0),
							  'Z' !== i[6] &&
									((g = 60 * parseInt(i[8], 10) + parseInt(i[9], 10)), '+' === i[7] && (g = 0 - g)),
							  Date.UTC(
									parseInt(i[1], 10),
									parseInt(i[2], 10) - 1,
									parseInt(i[3], 10),
						...
						for (
							...
							(e =
								'boolean' == typeof this.options.smooth
									? this.options.smooth
									: ((h = this.options.ykeys[c]), i.call(this.options.smooth, h) >= 0)),
								(a = function () {
									var a, b, e, f;
					...
					if (null !== this.prevHilight && this.prevHilight !== a)
						for (
							...
							this.seriesPoints[b][this.prevHilight] &&
								this.seriesPoints[b][this.prevHilight].animate(this.pointShrinkSeries(b));
		...
		(b.Bar = (function (c) {
			...
			return (
				...
				(d.prototype.drawXAxis = function () {
					...
					for (
						j = this.bottom + (this.options.xAxisLabelTopPadding || this.options.padding / 2),
							g = null,
							f = null,
							m = [],
							a = k = 0,
