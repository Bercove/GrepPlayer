	...
	(b.prototype = {
		...
		find: function () {
			...
			(this.$days = a.find('[data-days]')),
				...
				this.$days.length + this.$hours.length + this.$minutes.length + this.$seconds.length > 0 &&
					(this.found = !0);
		},
		reset: function () {
			this.found
				? (this.output('days'), this.output('hours'), this.output('minutes'), this.output('seconds'))
				: this.output();
		},
		ready: function () {
			var a,
