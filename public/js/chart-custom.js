...
if (jQuery('#bar-chart-12').length) {
	var chart12 = new ApexCharts(document.querySelector('#bar-chart-12'), barOptions12);
...
if (jQuery('#apex-basic').length) {
	...
	var chart = new ApexCharts(document.querySelector('#apex-basic'), options);
...
if (jQuery('#apex-line-area').length) {
	...
	var chart = new ApexCharts(document.querySelector('#apex-line-area'), options);
...
if (jQuery('#apex-bar').length) {
	...
	var chart = new ApexCharts(document.querySelector('#apex-bar'), options);
...
if (jQuery('#apex-column').length) {
	...
	var chart = new ApexCharts(document.querySelector('#apex-column'), options);
...
if (jQuery('#apex-mixed-chart').length) {
	...
	var chart = new ApexCharts(document.querySelector('#apex-mixed-chart'), options);
...
if (jQuery('#apex-bubble-chart').length) {
	...
	var chart = new ApexCharts(document.querySelector('#apex-bubble-chart'), options);
...
if (jQuery('#apex-scatter-chart').length) {
	...
	var chart = new ApexCharts(document.querySelector('#apex-scatter-chart'), options);
...
if (jQuery('#am-stackedcolumn-chart').length) {
	am4core.ready(function () {
		...
		chart.colors.list = [am4core.color('#e64141'), am4core.color('#1ee2ac'), am4core.color('#ff4545')];
...
if (jQuery('#am-barline-chart').length) {
	am4core.ready(function () {
		...
		chart.colors.list = [am4core.color('#ff4545'), am4core.color('#1ee2ac')];
...
if (jQuery('#am-3dpie-chart').length) {
	am4core.ready(function () {
		...
		series.colors.list = [
			...
			am4core.color('#ffdd31'),
			am4core.color('#ff7750'),
			am4core.color('#00d0ff'),
			am4core.color('#a09e9e')
		];
...
if (jQuery('#menu-overtime-chart').length) {
	am4core.ready(function () {
		...
		dateAxis.tooltip.adapter.add('x', function (x, target) {
			return (
				am4core.utils.spritePointToSvg({ x: chart.plotContainer.pixelX, y: 0 }, chart.plotContainer).x +
...
if (jQuery('#menu-chart-01').length) {
	am4core.ready(function () {
		...
		pieSeries.colors.list = [
			am4core.color('#FD6C9E'),
			am4core.color('#1be1b3'),
			am4core.color('#f4b72a'),
			am4core.color('#3f79f1'),
			am4core.color('#ff4545'),
