		...
		function TimeGridView(context, viewSpec, dateProfileGenerator, parentEl) {
			...
			_this.renderHeadIntroHtml = function () {
				...
				if (_this.opt('weekNumbers')) {
					...
					return (
						'<th class="fc-axis ' + theme.getClass('widgetHeader') + '" ' + _this.axisStyleAttr() + '></th>'
					);
				}
			};
			...
			_this.renderTimeGridBgIntroHtml = function () {
				...
				return (
					'<td class="fc-axis ' + theme.getClass('widgetContent') + '" ' + _this.axisStyleAttr() + '></td>'
				);
			};
			...
			if (_this.opt('allDaySlot')) {
				...
				_this.dayGrid = new daygrid.DayGrid(_this.context, _this.el.querySelector('.fc-day-grid'), {
